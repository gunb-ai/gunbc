...
- Fixed: invariant 2 no longer names the nonexistent `src/lib/transport/`; it now points at `src/6_materialize/transport/`.
...
- Fixed: invariant 6 no longer points at the nonexistent `src/gunbc-app/`; the README now describes `src/6_materialize/` as the runtime wiring layer.
