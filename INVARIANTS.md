...
| <a id="e-10"></a>E-10 | P5: Progress Is Dissolution (generalizes E-6, DB-4) | no model/function/field without a real consumer; route the code (no-consumer → archive-by-default `src/v4/archive/`), block the claim (done → executed-green + red-when-wrong) | [v4-compiler-migration.md](docs/v4-compiler-migration.md) |
