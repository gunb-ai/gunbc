...
//
// Inner wall-clock budgets below use `18_000` ms: Stage 2d filters + cold neighbors
// have measured ~14s wall on CI (busy runners); keep headroom above observed spikes.
