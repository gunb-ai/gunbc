...
fn v4_workflow_ci_t38_dissolution_step_modeled_and_wired() {
    ...
    for needle in [
        "data ci_testclaim_corpus_run_roster_manual_corpus_node_runtime_value_rows: Symbol = ci_testclaim_corpus_run_roster_manual_corpus_node_runtime_value_rows",
        "data ci_testclaim_corpus_eval_report_run_manual_testclaim_corpus_eval: Symbol = ci_testclaim_corpus_eval_report_run_manual_testclaim_corpus_eval",
        "data ci_testclaim_corpus_verdict_tally_corpus_report_tally: Symbol = ci_testclaim_corpus_verdict_tally_corpus_report_tally",
        "data ci_testclaim_corpus_gate_witness_manual_corpus_gate_closed: Symbol = ci_testclaim_corpus_gate_witness_manual_corpus_gate_closed",
        "fn ci_testclaim_corpus_eval_command() -> CiCommand",
        "run_roster: ci_testclaim_corpus_run_roster_manual_corpus_node_runtime_value_rows",
        "eval_report: ci_testclaim_corpus_eval_report_run_manual_testclaim_corpus_eval",
        "verdict_tally: ci_testclaim_corpus_verdict_tally_corpus_report_tally",
        "gate_witness: ci_testclaim_corpus_gate_witness_manual_corpus_gate_closed",
        "roster == ci_testclaim_corpus_run_roster_manual_corpus_node_runtime_value_rows",
        "report == ci_testclaim_corpus_eval_report_run_manual_testclaim_corpus_eval",
        "tally == ci_testclaim_corpus_verdict_tally_corpus_report_tally",
        "witness == ci_testclaim_corpus_gate_witness_manual_corpus_gate_closed",
        "ci_projection_command_run_roster_edge",
        "ci_projection_command_eval_report_edge",
        "ci_projection_command_verdict_tally_edge",
        "ci_projection_command_gate_witness_edge",
    ] {
        assert!(
