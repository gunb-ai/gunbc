...
fn v4_workflow_ci_t38_dissolution_step_modeled_and_wired() {
    ...
    for needle in [
        ...
        "module_name: ci_testclaim_corpus_module_manual_roster",
        "module_name: ci_testclaim_corpus_module_runner",
        "module_name: ci_testclaim_corpus_module_eval",
        "declaration: ci_testclaim_corpus_decl_manual_corpus_node_runtime_value_rows",
        "declaration: ci_testclaim_corpus_decl_run_manual_testclaim_corpus_eval",
        "declaration: ci_testclaim_corpus_decl_corpus_report_tally",
        "declaration: ci_testclaim_corpus_decl_witness_manual_corpus_gate_closed",
