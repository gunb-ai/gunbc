...
fn bootstrap_numeric_aliases_align_to_refinements_per_gate_19() {
    // R3 gate #19 covers the fixed public numeric aliases: Int*/UInt* compose
    // abstract integer carriers with MachineWidth, while Float* aliases the
    // canonical Real* width refinements.
