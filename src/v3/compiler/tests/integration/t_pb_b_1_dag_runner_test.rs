...
//! `self_gen_census_test.rs` on `t_pb_b_1_dag_runner_test.rs` (remaining obligation cites ROADMAP
...
/// gate #84 / facet-3 closure — see `self_gen_census_test.rs` on this file's `EXPECTED_HAND_AUTHORED_TEST`
