...
fn idempotent_operation_generated_claims_parse_and_pin_emission() {
    ...
    assert!(
        IDEMPOTENT_OPERATION_GENERATED_DAG.contains("generated_label_only_skip_pins_rejection")
            ...
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("import v4.std.node { Atom, Node, Symbol, TypeNode }")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("TestClaimEvalSubject")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("TestClaimRun")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("run_test_claim")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("eval_test_claim_subject")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("run_read_idempotent_operation_via_run_test_claim")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("run_upsert_idempotent_operation_via_run_test_claim")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("run_delete_idempotent_operation_via_run_test_claim")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("idempotent_operation_eval_missing_semantics")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("fn idempotent_operation_call_primitive(node: Node")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("Rejected {")
            && !IDEMPOTENT_OPERATION_GENERATED_DAG.contains("Accepted { value: idempotent_operation_runtime_value(), diagnostics: None }")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("witness_read_idempotent_operation_run_non_pass")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("witness_upsert_idempotent_operation_run_non_pass")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("witness_delete_idempotent_operation_run_non_pass")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("generated_idempotent_operation_run_count_is_three")
