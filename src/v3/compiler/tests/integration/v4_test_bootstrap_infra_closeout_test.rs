...
fn idempotent_operation_generated_claims_parse_and_pin_emission() {
    ...
    assert!(
        IDEMPOTENT_OPERATION_GENERATED_DAG.contains("generated_label_only_skip_pins_rejection")
            ...
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("witness_read_idempotent_operation_run_passes")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("witness_upsert_idempotent_operation_run_passes")
            && IDEMPOTENT_OPERATION_GENERATED_DAG.contains("witness_delete_idempotent_operation_run_passes")
