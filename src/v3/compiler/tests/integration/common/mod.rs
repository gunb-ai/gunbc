...
pub use symbolic_cost_countdown::{
    assert_recursive_countdown_linear_semantics,
    assert_unary_tail_recursive_countdown_is_single_linear_symbolic_cost,
};
...
#[cfg(test)]
mod integration_rs_scan_tests {
    use super::integration_rs_active_line_contains;

    #[test]
    fn integration_rs_scan_skips_byte_char_literals_so_path_ratchet_still_sees_mod_list() {
        let src = concat!(
            "fn demo_bytes() {\n",
            "let _slash = b'\\\\';\n",
            "let _quote = b'\"';\n",
    ...
    #[test]
    fn integration_rs_scan_skips_char_literal_containing_double_quote() {
        let src = concat!(
            "let _c = '\"';\n",
            "#[path = \"integration/cementing/real.rs\"]\n",
            "mod real;\n",
    ...
    #[test]
    fn integration_rs_scan_accepts_path_after_lifetime() {
        let src = r#"
fn foo<'a>() {
#[path = "integration/cementing/real.rs"]
mod real;
