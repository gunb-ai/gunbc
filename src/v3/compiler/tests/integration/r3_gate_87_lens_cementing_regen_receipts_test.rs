...
//! Helper-only rows (`infer_helpers`, `lower_helpers`), the behaviorally partial `parallelism`
//! row, and v3-native `variant_payload` currently stay explicit `Compiles` placeholders with
