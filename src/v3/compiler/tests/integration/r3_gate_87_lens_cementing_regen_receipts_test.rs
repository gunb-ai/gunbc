...
//! Helper-only rows (`infer_helpers`, `lower_helpers`, `variant_payload`, `parallelism`) stay
//! explicit `Compiles` placeholders with per-file dissolution triggers in their `.dag` harness
//! comments.
//!
