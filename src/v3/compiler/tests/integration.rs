...
#[path = "integration/v4_extdeps_openapi_dag_smoke_test.rs"]
mod v4_extdeps_openapi_dag_smoke_test;
#[path = "integration/v4_test_fixture_task_manager_demo_dag_smoke_test.rs"]
mod v4_test_fixture_task_manager_demo_dag_smoke_test;
