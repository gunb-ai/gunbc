...
pub(crate) fn bootstrapped_std_fixture_dag() -> Dag {
    Dag {
        ...
        declaration_append_begin_after_bootstrap: 635,
    }
}
...
fn bootstrapped_std_fixture_dag_declarations() -> Vec<Declaration> {
    {
        let mut declarations = Vec::with_capacity(635);
        ...
        declarations.push(Declaration {
            ...
            refinement: None,
            nominal_opacity: None,
            span: SourceSpan::new("dsl/std/float.dag", 634, 651),
        });
        declarations.push(Declaration {
            ...
            refinement: None,
            nominal_opacity: None,
            span: SourceSpan::new("dsl/std/float.dag", 653, 711),
        });
        declarations.push(Declaration {
            ...
            refinement: None,
            nominal_opacity: None,
            span: SourceSpan::new("dsl/std/float.dag", 712, 770),
        });
        declarations.push(Declaration {
            ...
            refinement: None,
            nominal_opacity: None,
            span: SourceSpan::new("dsl/std/float.dag", 789, 809),
        });
        declarations.push(Declaration {
            ...
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: Some(DeclarationId(588)),
            specialization_parent: None,
            inhabits: None,
            value_body: Some(ValueBody::Map(
                FieldMap::from_entries(vec![
        ...
        declarations.push(Declaration {
            ...
            value_body: Some(ValueBody::Map(
                FieldMap::from_entries(vec![
                    ("List".to_string(), FieldValue::Literal(LiteralBits::Int("1".to_string()))),
                    ("Set".to_string(), FieldValue::Literal(LiteralBits::Int("1".to_string()))),
                    ("Map".to_string(), FieldValue::Literal(LiteralBits::Int("2".to_string()))),
                ])
                .expect("ValueBody::Map"),
            )),
            refinement: None,
        ...
        declarations.push(Declaration {
            ...
            meta_tag: None,
            specialization_parent: None,
            inhabits: Some(DeclarationId(634)),
            value_body: None,
            refinement: None,
            nominal_opacity: None,
        ...
        declarations.push(Declaration {
            ...
            refinement: None,
            nominal_opacity: None,
            span: SourceSpan::new("dsl/std/float.dag", 690, 710),
        });
        declarations.push(Declaration {
            ...
            refinement: None,
            nominal_opacity: None,
            span: SourceSpan::new("dsl/std/float.dag", 749, 769),
        });
        declarations.push(Declaration {
