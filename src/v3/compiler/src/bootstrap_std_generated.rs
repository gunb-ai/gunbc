...
pub(crate) fn bootstrapped_std_fixture_dag() -> Dag {
    Dag {
        ...
        declaration_append_begin_after_bootstrap: 667,
    }
}
...
fn bootstrapped_std_fixture_dag_declarations() -> Vec<Declaration> {
    {
        let mut declarations = Vec::with_capacity(667);
        ...
        declarations.push(Declaration {
            ...
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: Some(DeclarationId(623)),
            specialization_parent: None,
            inhabits: None,
            value_body: Some(ValueBody::Map(
                FieldMap::from_entries(vec![
        ...
        declarations.push(Declaration {
            ...
            meta_tag: None,
            specialization_parent: None,
            inhabits: Some(DeclarationId(666)),
            value_body: None,
            refinement: None,
            nominal_opacity: None,
        ...
        declarations.push(Declaration {
            ...
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: Some(DeclarationId(665)),
            specialization_parent: None,
            inhabits: None,
            value_body: Some(ValueBody::List(vec![
                FieldValue::Record(vec![
