    ...
    Dag {
        ...
        declarations: vec![
            ...
            Declaration {
                ...
                connective: TypeConnective::Instantiation {
                    template: DeclarationId(99),
                    arguments: vec![
                        TemplateArgument {
                            parameter: DeclarationId(100),
                ...
                type_params: vec![],
                phantom_params: Vec::new(),
                meta_tag: Some(DeclarationId(421)),
                specialization_parent: None,
                inhabits: None,
            ...
            Declaration {
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1274, 1303),
            },
            Declaration {
                id: DeclarationId(64),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1304, 1336),
            },
            Declaration {
                id: DeclarationId(65),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1337, 1369),
            },
            Declaration {
                id: DeclarationId(66),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1370, 1402),
            },
            Declaration {
                id: DeclarationId(67),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1403, 1437),
            },
            Declaration {
                id: DeclarationId(68),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1494, 1521),
            },
            Declaration {
                id: DeclarationId(69),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1522, 1552),
            },
            Declaration {
                id: DeclarationId(70),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1553, 1583),
            },
            Declaration {
                id: DeclarationId(71),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1584, 1614),
            },
            Declaration {
                id: DeclarationId(72),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1615, 1647),
            },
            Declaration {
                id: DeclarationId(73),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1668, 1684),
            },
            Declaration {
                id: DeclarationId(74),
                ...
                refinement: None,
                nominal_opacity: None,
                span: SourceSpan::new("dsl/std/integer.dag", 1685, 1703),
            },
            Declaration {
                id: DeclarationId(75),
            ...
            Declaration {
                ...
                type_params: vec![],
                phantom_params: Vec::new(),
                meta_tag: Some(DeclarationId(535)),
                specialization_parent: None,
                inhabits: None,
                value_body: Some(ValueBody::Map(
                    FieldMap::from_entries(vec![
            ...
            Declaration {
                ...
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(188)],
                    output: DeclarationId(90),
            ...
            Declaration {
                ...
                connective: TypeConnective::Instantiation {
                    ...
                    arguments: vec![
                        ...
                        TemplateArgument {
                            parameter: DeclarationId(101),
                            value: DeclarationId(73),
                        },
                    ],
                },
                type_params: vec![],
                phantom_params: Vec::new(),
                meta_tag: Some(DeclarationId(536)),
                specialization_parent: None,
                inhabits: None,
                value_body: Some(ValueBody::Map(
                    FieldMap::from_entries(vec![
            ...
            Declaration {
                ...
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(188), DeclarationId(73)],
            ...
            Declaration {
                ...
                meta_tag: None,
                specialization_parent: None,
                inhabits: Some(DeclarationId(590)),
                value_body: None,
                refinement: None,
                nominal_opacity: None,
            ...
            Declaration {
                ...
                type_params: vec![DeclarationId(100), DeclarationId(101)],
                phantom_params: Vec::new(),
                meta_tag: None,
                specialization_parent: None,
                inhabits: None,
            ...
            Declaration {
                ...
                inhabits: None,
                value_body: None,
                refinement: Some(DeclarationId(539)),
                nominal_opacity: None,
            ...
            Declaration {
                ...
                inhabits: None,
                value_body: None,
                refinement: Some(DeclarationId(540)),
                nominal_opacity: None,
            ...
            Declaration {
                ...
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(94), DeclarationId(189)],
                    output: DeclarationId(90),
            ...
            Declaration {
                ...
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(191)],
                    output: DeclarationId(73),
            ...
            Declaration {
                ...
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(73), DeclarationId(193)],
                    output: DeclarationId(90),
            ...
            Declaration {
                ...
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(188), DeclarationId(188), DeclarationId(73)],
                    output: DeclarationId(188),
            ...
            Declaration {
                ...
                type_params: vec![],
                phantom_params: Vec::new(),
                meta_tag: Some(DeclarationId(204)),
                specialization_parent: None,
                inhabits: None,
            ...
            Declaration {
                ...
                name: None,
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(325), DeclarationId(326)],
            ...
            Declaration {
                ...
                name: None,
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(73), DeclarationId(73)],
            ...
            Declaration {
                ...
                name: None,
                connective: TypeConnective::Arrow {
                    inputs: vec![DeclarationId(42), DeclarationId(346)],
                    output: DeclarationId(42),
                    body: ArrowBody::NoBody,
                },
                type_params: vec![],
        ...
        declaration_append_begin_after_bootstrap: 591,
    }
}
