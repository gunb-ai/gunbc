...
fn bootstrapped_std_fixture_dag_nodes() -> Vec<Behavior> {
    {
        let mut nodes = Vec::with_capacity(27);
        ...
        nodes.push(Behavior::Value(ValueNode {
            ...
            output: PortId(4),
            span: SourceSpan::new("dsl/std/types.dag", 10299, 10320),
            lane2_workflow: None,
        }));
        nodes.push(Behavior::Transform(TransformNode {
            id: NodeId(4),
        ...
        nodes.push(Behavior::Value(ValueNode {
            ...
            output: PortId(10),
            span: SourceSpan::new("dsl/std/types.dag", 10351, 10376),
            lane2_workflow: None,
        }));
        nodes.push(Behavior::Transform(TransformNode {
            id: NodeId(10),
        ...
        nodes.push(Behavior::Value(ValueNode {
            ...
            data: LiteralBits::Int(1),
            output: PortId(16),
            span: SourceSpan::new("dsl/std/types.dag", 10473, 10498),
            lane2_workflow: None,
        }));
        nodes.push(Behavior::Transform(TransformNode {
            id: NodeId(16),
        ...
        nodes.push(Behavior::Value(ValueNode {
            ...
            data: LiteralBits::Int(0),
            output: PortId(22),
            span: SourceSpan::new("dsl/std/types.dag", 12598, 12611),
            lane2_workflow: None,
        }));
        nodes.push(Behavior::Transform(TransformNode {
            id: NodeId(22),
        ...
        nodes.push(Behavior::Value(ValueNode {
            ...
            data: LiteralBits::Int(0),
            output: PortId(25),
            span: SourceSpan::new("dsl/std/types.dag", 12643, 12656),
            lane2_workflow: None,
        }));
        nodes.push(Behavior::Transform(TransformNode {
            id: NodeId(25),
...
fn bootstrapped_std_fixture_dag_declarations() -> Vec<Declaration> {
    {
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: CommitSha>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: Sha256>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: Email>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: GistId>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: Url>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: SemVer>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: Timestamp>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: ServiceAccountEmail>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: TextFilePath>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: BinaryFilePath>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
        ...
        declarations.push(Declaration {
            ...
            name: Some("<registered predicate not lowered: MimeType>".to_string()),
            connective: TypeConnective::Conj { children: vec![] },
            type_params: vec![],
            phantom_params: Vec::new(),
            meta_tag: None,
...
fn bootstrapped_std_fixture_dag_ports() -> HashMap<PortId, Port> {
    {
        ...
        ports.insert(
            ...
            Port {
                id: PortId(3),
                state: PortState::Resolved(TypeShape::new(DeclarationId(81))),
                produced_by: None,
            },
        );
        ports.insert(
