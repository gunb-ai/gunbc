...
//! `is_type_rhs_boundary_keyword`, **SG-2c-4** `bracket_role` / `BracketRole`, and
//! **SG-2c-6** `primary_prefix_dispatch` / `PrimaryPrefixDispatch` (see
//! `regen_parse_tables_emit.rs`; not in this file).
//!
