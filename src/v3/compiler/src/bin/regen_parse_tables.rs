...
//! **SG-2c-5** `soft_keyword_ident_spelling`, **SG-2c-6** `primary_prefix_dispatch` /
//! `PrimaryPrefixDispatch`, and **SG-2c-7** `primary_atom_class` / `PrimaryAtomClass`
//! (see `regen_parse_tables_emit.rs`; not in this file).
//!
