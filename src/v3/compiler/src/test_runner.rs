...
use crate::{
    ...
    compile_stage_snapshots, compile_to_dag, default_fixed_point_source, CompileError, DimensionReport,
};
...
impl<'a> TestRunner<'a> {
    ...
    fn eval_gate_87_cementing_projection(
        ...
        let computed = match lens_decl_name? {
            ...
            "gate87_parallelism_no_workflow_projection_on_literal_bind" => {
