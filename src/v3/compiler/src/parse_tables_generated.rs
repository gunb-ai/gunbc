...
pub fn primary_atom_class(kind: &TokenKind) -> Option<PrimaryAtomClass> {
    match kind {
        TokenKind::Ident(_) => Some(PrimaryAtomClass::Ident),
        TokenKind::IntLit(_) => Some(PrimaryAtomClass::IntLiteral),
        TokenKind::KwFalse => Some(PrimaryAtomClass::False),
        TokenKind::KwTrue => Some(PrimaryAtomClass::True),
        TokenKind::Pipe => Some(PrimaryAtomClass::Pipe),
        TokenKind::StringLit(_) => Some(PrimaryAtomClass::String),
        _ => None,
    }
}
