...
//
// Template: `pb0_cycle4_emit_templates/<stem>.rs.in` (relative to this crate).
// Dissolution receipt: PB-0 NON_TEST retirement — former hand module; edit templates + rebuild.
//
