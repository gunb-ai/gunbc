...
use crate::dag::{Dag, WorkflowEffect, WorkflowIdempotencyReport};

pub fn analyze_workflow(d: &Dag, workflow: &WorkflowEffect) -> WorkflowIdempotencyReport {
    crate::workflow_idempotency::analyze_workflow(d, workflow)
}
