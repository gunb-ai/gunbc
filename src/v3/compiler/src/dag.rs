...
pub use operators::{ArithmeticOp, ComparisonOp, LogicalOp, OperatorKind};
pub use ports::{
...
// ArithmeticOp / ComparisonOp / LogicalOp / OperatorKind live in
// `dag/operators.rs`. See re-exports at the top of this module.
