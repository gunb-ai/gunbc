    ...
    fn generated_tokenizer_avoids_ascii_host_predicates() {
        ...
        assert!(
            TOKENIZE_GENERATED.contains("byte_matches")
                && TOKENIZE_GENERATED.contains("ScannerCharClass::Whitespace")
                && TOKENIZE_GENERATED.contains("ScannerCharClass::Digit")
                && TOKENIZE_GENERATED.contains("ScannerCharClass::IdentStart")
                && TOKENIZE_GENERATED.contains("ScannerCharClass::IdentContinue"),
