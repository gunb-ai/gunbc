...
deterministic inputs (Peano depth 32 and a small linear idempotent workflow).
The termination Phase 1 bench retired with the hand-Rust termination lattice
mirror. Shared corpus files for stricter like-for-like
