...
//!
//! Worked **Examples 1–7** in that doc are behavioral targets. **Examples 1, 2, 5, and 6** are
...
///   design-doc Int Examples 1, 2, 5, and 6 for a single synthetic binding [`BindingId`](v3_grounding_lifetime::BindingId)`(0)`.
