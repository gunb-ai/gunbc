...
| 3a.3 `where` refinement (DB-11, M→L overrun; DB-16) | ✅ Shipped | PR #496, #515, #522, #524 | Predicate lowering, call-site flatten-and-subset discharge, arm-local narrowing, operator-operand refinement stripping, structural callable-predicate identity, and refined-generic substitution (PR #522). DB-11 out-of-fragment lowering-time rejection. PR #524 adds DB-16 pipeline-stage invariant + `FnExternalBody` doc scoping (2a/2b, DB-14) — not a second lowering gate. See **Landing: 3a.3-full**, **Landing: DB-16 refined-generic substitution**, and **DB-16 (`FnExternalBody` reconciliation)** below. |
