...
Acceptance: `src/v3/compiler/tests/m2_feature_parity_test.rs::test_3a4_*` — 9 tests lock core discharge, distinct-refinement rejection, cross-site identity, literal-arg rejection, composite conjunction, Callable-target substitution positive + negative, FieldProject-target substitution, and substrate integrity.
