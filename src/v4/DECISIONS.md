...
| `extdeps/languages/python.dag` | (Practice-4 sum carriers + cost record) | Green coproduct family / records | Same as go row; merge-base had three 🟢 sum ledgers (see **Part 6 · CP-3229-GREEN-TERMINAL**). Post-#3338 de-prose keeps the canonical-B decl-ref surface and drops surplus header/body comments rather than adding false dependencies to satisfy Practice 9 ratio pressure. |
