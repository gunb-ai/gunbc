...
| `std/cardinality.dag` | `Unit` | Green coproduct | Exactly one structural inhabitant (`MkUnit`); shared cardinality-1 carrier for singleton sentinels and unit-shaped facts (composes with per-language wrappers). |
