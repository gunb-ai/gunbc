...
During extraction, dissolve `ModuleAdmissionState` in `03_module_resolve.dag` by collapsing its accepted/rejected coproduct into the `Outcome` accumulator of the new admission stage.
