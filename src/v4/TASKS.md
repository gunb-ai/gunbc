...
- **Scope**: M-L.
- **Status**: LANDED via PR #3168 (`src/v4/extdeps/formats/spice.dag`).
  The landed model is pre-D2-reversal / pre-Practice-10-A1-ratification:
  any future fact-bundle rework is gated by the A1-invariant decision and
  is not Wave-0 fill for this already-landed probe.
