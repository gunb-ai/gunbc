//! Staleness check: ensures `src/00_foundation/ir/src/generated/mod.rs` matches
...
//!     --module std.render \
//!     --output src/00_foundation/ir/src/generated/mod.rs
...
fn generated_types_are_not_stale() {
    ...
    if fresh != on_disk {
        panic!(
            "src/00_foundation/ir/src/generated/mod.rs is stale. Regenerate with:\n  \
             cargo run -p daglang-cli -- gen-types dsl/std \
             --module std.symbols --module std.unicode --module std.width \
             --module std.render \
             --output src/00_foundation/ir/src/generated/mod.rs"
