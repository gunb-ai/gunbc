...
fn main() {
    ...
    let v2_files: &[(&str, &str)] = &[
        ...
        ("04_items", "src/v2/04_items.dag"),
        ("04_service", "src/v2/04_service.dag"),
        ("04_patterns", "src/v2/04_patterns.dag"),
        ("04_lookup", "src/v2/04_lookup.dag"),
        ("04_access", "src/v2/04_access.dag"),
