...
use crate::std_occurrence_identity::OccurrenceTransportRefusal::{
    ...
    MissingAuthoredOccurrenceIdentity, WrongOccurrenceRole,
};
pub use crate::std_occurrence_identity::{
    ...
    OccurrenceRole, OccurrenceTransport, OccurrenceTransportRefusal, ReferenceOccurrence,
};
...
pub fn w_production_frontend_refuses_wrong_occurrence_role() -> bool {
    {
        ...
        ((result.graph.clone() == None)
            && match result.diagnostics.clone().first().cloned() {
                Some(error) => match (*error.diagnostic.clone()).clone() {
                    CompilerDiagnostic::OccurrenceTransportViolation { ref refusal, .. } => {
                        let OccurrenceTransportRefusal::WrongOccurrenceRole {
                            occurrence: observed,
