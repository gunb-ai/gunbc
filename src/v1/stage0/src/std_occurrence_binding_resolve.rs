...
pub fn occurrence_binding_resolve_authority_note() -> std::string::String {
    thread_local! {
...
pub fn occurrence_binding_resolve_transport_boundary_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn occurrence_binding_resolve_duplicate_identity_law() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn occurrence_category_binding_verdict_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
