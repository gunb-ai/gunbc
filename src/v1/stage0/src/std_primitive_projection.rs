...
pub fn primitive_projection_seed_boundary_note() -> std::string::String {
    thread_local! {
...
pub fn primitive_projection_identity_key_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn primitive_projection_fidelity_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn primitive_projection_roster_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
