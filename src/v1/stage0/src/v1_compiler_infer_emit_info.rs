...
pub struct EmitGraphInfo {
    ...
    pub recursive_type_set: Rc<set<String>>,
    pub fielded_variants: Rc<set<String>>,
    pub positional_payload_variants: Rc<set<String>>,
    pub shared_types: Rc<set<String>>,
    pub ownership_index: Rc<HashMap<String, Rc<set<String>>>>,
    pub movable: Rc<set<String>>,
    pub variant_to_enum: Rc<HashMap<String, String>>,
    pub owned_bindings: Rc<set<String>>,
    pub read_only_params_index: Rc<HashMap<String, Rc<set<String>>>>,
    pub read_only_params: Rc<set<String>>,
