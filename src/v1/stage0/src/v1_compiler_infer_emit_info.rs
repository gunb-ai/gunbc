            ...
            |inner: Rc<UniqueStringAccum>, item: String| {
                    ...
                    || emit_map_has(inner.seen.clone(), item.clone()))
                {
                    ...
                    UniqueStringAccum {
                        ...
                        result: v1_rt::concat(inner.result.clone(), vec![item.clone()]),
                    }
                }
            },
        );
...
pub fn emit_info_with_fn_type_context(
    ...
    EmitGraphInfo {
        ...
        fn_return_type: Box::new(emit_info.fn_return_type.clone()),
    }
}
...
pub fn emit_info_with_fn_return(
    ...
    EmitGraphInfo {
        ...
        fn_return_type: Box::new(fn_return_type.clone()),
    }
}
        ...
        if is_product.clone() {
        ...
        } else {
            {
                ...
                Some(TypeSummary {
                    ...
                    field_import_surface_names: vec![],
