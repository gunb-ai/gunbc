...
pub fn rust_struct_derives() -> String {
    thread_local! {
        static CACHED: String = {
            rust_trait_derive_attr_from_traits(crate::std_trait_derive_shape::record_derive_traits_heap())
        };
    }
    CACHED.with(|c: &String| c.clone())
}
...
pub fn rust_struct_derives_copy() -> String {
    thread_local! {
        static CACHED: String = {
            rust_trait_derive_attr_from_traits(crate::std_trait_derive_shape::record_derive_traits_copy())
        };
    }
    CACHED.with(|c: &String| c.clone())
}
...
pub fn rust_enum_derives() -> String {
    thread_local! {
        static CACHED: String = {
            rust_trait_derive_attr_from_traits(crate::std_trait_derive_shape::payload_coproduct_derive_traits())
        };
    }
    CACHED.with(|c: &String| c.clone())
}
...
pub fn rust_enum_derives_copy() -> String {
    thread_local! {
        static CACHED: String = {
            rust_trait_derive_attr_from_traits(crate::std_trait_derive_shape::nullary_coproduct_derive_traits())
        };
    }
    CACHED.with(|c: &String| c.clone())
}
