...
pub enum OperandRealization {
    ...
    OperandIdentityUnavailable { facts: Rc<OperandShapeFacts> },
}
...
pub fn operator_realization_for(
    ...
    match (*operand.clone()).clone() {
        ...
        OperandRealization::HostRealizedOperand { reason: _, .. } => {
            Rc::new(OperatorRealization::HostOperator)
        }
        OperandRealization::OperandIdentityUnavailable { facts: f, .. } => match op.clone() {
            BinOp::Eq => Rc::new(OperatorRealization::HostOperator),
            BinOp::Ne => Rc::new(OperatorRealization::HostOperator),
