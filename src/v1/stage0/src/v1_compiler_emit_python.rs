...
pub fn emit_python(typed: Rc<ResolvedGraph>) -> Rc<EmitResult> {
    {
        ...
        let files = v1_rt::concat(
            v1_rt::concat(Rc::new(vec![requirements, init_file]), module_files),
            test_files,
        );
        Rc::new(EmitResult {
            files: files,
...
pub fn emit_py_prelude(typed_module: Rc<TypedModule>) -> String {
    {
        ...
        v1_rt::concat(
            v1_rt::concat(
                v1_rt::concat(v1_rt::concat(future_import, dc_import), enum_import),
                typing_import,
            ),
            async_import,
        )
...
) -> String {
    {
        ...
        if is_type_def_item(item.clone()) {
            ...
            if is_type_alias_item(item.clone(), env.source_indices.clone()) {
                v1_rt::concat(
                    v1_rt::concat(item_text, " = ".to_string()),
                    emit_node_type(
...
) -> String {
    {
        ...
        if ((params.clone().len() as i64) == 0) {
        ...
        } else {
            {
                ...
                v1_rt::concat(
                    v1_rt::concat(
                        v1_rt::concat("def __init__(".to_string(), params_str),
                        "):\n".to_string(),
                    ),
                    assigns_str,
                )
...
pub fn emit_py_rest_call(
...
) -> String {
    {
        ...
        let url_line = v1_rt::concat(
            v1_rt::concat(
                v1_rt::concat(
                    v1_rt::concat("url = f\"".to_string(), self_base_url),
                    "/".to_string(),
                ),
        ...
        v1_rt::concat(
            v1_rt::concat(
                v1_rt::concat(v1_rt::concat(url_line, "\n".to_string()), headers_dict),
                "\n".to_string(),
            ),
            session_lines,
        )
        ...
        let auth_entry = if transport_has_auth(transport.clone(), source_indices.clone()) {
            {
                ...
                v1_rt::concat(
                    v1_rt::concat("\"".to_string(), header_name),
...
pub fn emit_py_shell_call(
...
) -> String {
    {
        ...
        let env_str = v1_rt::concat(
            v1_rt::concat("{".to_string(), env_dict_entries.join(&", ".to_string())),
            "}".to_string(),
        );
        v1_rt::concat(
            v1_rt::concat(
        ...
        v1_rt::concat(
            v1_rt::concat(
                v1_rt::concat(
                    v1_rt::concat(
                        v1_rt::concat(
                            v1_rt::concat("path = f\"".to_string(), self_base_path),
                            "/".to_string(),
                        ),
                        emit_ident(op_name, RenderTarget::Python),
                    ),
...
pub fn emit_py_data_def(
...
) -> String {
    {
        ...
        v1_rt::concat(
            v1_rt::concat(
                v1_rt::concat(v1_rt::concat(upper_name, ": ".to_string()), ty_str),
                " = ".to_string(),
            ),
            val_str,
        )
...
pub fn emit_requirements_txt(has_services: bool) -> Rc<TextFile> {
    {
        ...
        Rc::new(TextFile {
            ...
            content: v1_rt::concat(base_deps, async_deps),
        })
    }
}
