...
"#,
    ...
    fn corpus_orphan_list_tmp() {
        ...
        let entries = [
            "src/v2/test/claim/manual/sg_rc_layering_test.dag",
            "src/v2/test/claim/manual/typescript_pr3_typed_fn_translate_test.dag",
            "src/v2/test/claim/manual/typescript_record_task_translate_test.dag",
        ]
        .into_iter()
