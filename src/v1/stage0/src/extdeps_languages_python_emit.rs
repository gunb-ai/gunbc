...
pub fn python_container_templates() -> Rc<HashMap<String, String>> {
    thread_local! {
        static CACHED: Rc<HashMap<String, String>> = {
            ...
            __m.insert("pointwise_power".to_string(), "set[{0}]".to_string());
