...
pub fn stage0_reexport_path_dependencies_outcome(
    ...
    reexport_packages.clone().iter().cloned().fold(
        Stage0ReexportPathDepsOutcome::Stage0ReexportPathDepsOk { deps: vec![] },
...
pub fn stage0_partition_row_features(
    ...
    match row.kind.clone() {
        GeneratedPartitionCrateKind::GeneratedFoundationCrate => vec![CargoFeature {
            name: "text_lookup_work_counter".to_string(),
            dependencies: vec![],
        }],
        GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate => vec![],
        GeneratedPartitionCrateKind::GeneratedEmitCoreCrate => vec![],
    }
}
...
pub fn stage0_emit_shell_module_reexports_outcome(
    ...
    modules.clone().iter().cloned().fold(
        Stage0EmitShellReexportsOutcome::Stage0EmitShellReexportsOk { lines: vec![] },
...
pub fn stage0_crate_plan_outcome() -> Rc<Stage0CratePlanOutcome> {
    generated_partition_crate_rows().iter().cloned().fold(
        Stage0CratePlanOutcome::Stage0CratePlanOk {
            plan: Stage0CratePlan { crates: vec![] },
        },
                ...
                match (*stage0_partition_row_to_spec_outcome(row.clone())).clone() {
                    ...
                    Stage0PartitionRowSpecOutcome::Stage0PartitionRowSpecOk {
                        ...
                        plan: Stage0CratePlan {
                            crates: v1_rt::concat(plan.crates.clone(), vec![spec.clone()]),
                        },
                    },
                }
            }
...
pub fn emit_stage0_crate_boundary_files_outcome(
    ...
    plan.crates.clone().iter().cloned().fold(
        Stage0CrateBoundaryEmitOutcome::Stage0CrateBoundaryEmitOk { files: vec![] },
                ...
                match (*emit_stage0_crate_lib_outcome(spec.clone())).clone() {
                    ...
                    Stage0CrateLibEmitOutcome::Stage0CrateLibEmitOk { file: lib_file, .. } => {
                        Stage0CrateBoundaryEmitOutcome::Stage0CrateBoundaryEmitOk {
                            files: v1_rt::concat(
                                files.clone(),
                                vec![emit_stage0_crate_manifest(spec.clone()), lib_file.clone()],
                            ),
                        }
                    }
                }
