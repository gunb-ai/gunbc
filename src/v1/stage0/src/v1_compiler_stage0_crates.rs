...
pub struct Stage0CrateSpec {
    pub package_name: Rc<FreeMonoid<Nat>>,
    pub crate_dir: Rc<FreeMonoid<Nat>>,
    pub kind: Stage0CrateKind,
    pub header_doc: Rc<FreeMonoid<Nat>>,
...
pub fn stage0_crate_allow_block() -> Rc<FreeMonoid<Nat>> {
    Rc::new(vec![
        "#![allow(".to_string(),
...
pub fn stage0_core_header_doc() -> Rc<FreeMonoid<Nat>> {
    Rc::new(vec![
...
pub fn stage0_emit_core_header_doc() -> Rc<FreeMonoid<Nat>> {
    Rc::new(vec![
        "//! Generated by regen_stage0 -- do not edit.".to_string(),
        "//!".to_string(),
...
pub fn render_stage0_crate_dep(dep: Rc<CargoDependency>) -> Rc<FreeMonoid<Nat>> {
...
pub fn render_stage0_crate_feature(feature: Rc<CargoFeature>) -> Rc<FreeMonoid<Nat>> {
...
pub fn render_stage0_core_lib(spec: Rc<Stage0CrateSpec>) -> Rc<FreeMonoid<Nat>> {
    {
        let includes = Rc::new({
            let mut __result = Vec::new();
...
pub fn render_stage0_emit_core_lib(spec: Rc<Stage0CrateSpec>) -> Rc<FreeMonoid<Nat>> {
    {
