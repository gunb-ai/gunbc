        ...
        crates: Rc::new(vec![
            Rc::new(Stage0CrateSpec {
                ...
                modules: Rc::new(vec![
                    ...
                    "std_content_hash".to_string(),
                    "std_decl_ref".to_string(),
                    "std_disposition".to_string(),
                    "std_effects".to_string(),
                    "std_emit_model".to_string(),
                    "std_error_primitives".to_string(),
                    "std_execution_mode".to_string(),
                    "std_graph".to_string(),
                    "std_http_path".to_string(),
                    "std_induction".to_string(),
                    "std_interface_summary".to_string(),
                    "std_iteration".to_string(),
                    "std_lens_verdict".to_string(),
                    "std_magnitude".to_string(),
                    "std_measure".to_string(),
                    "std_nat".to_string(),
                    "std_node".to_string(),
                    "std_pareto".to_string(),
