...
pub struct Stage0CrateSpec {
    ...
    pub crate_dir: std::string::String,
    pub kind: Stage0CrateKind,
    pub header_doc: std::string::String,
    pub modules: Rc<Vec<std::string::String>>,
    pub reexport_packages: Rc<Vec<std::string::String>>,
...
pub fn stage0_foundation_header_doc() -> std::string::String {
    Rc::new(vec![
        "//! Generated by `claim_executor --emit-partition-crates --write` -- do not edit."
            .to_string(),
        "//!".to_string(),
...
pub fn stage0_layered_core_header_doc() -> std::string::String {
    Rc::new(vec![
        "//! Generated by `claim_executor --emit-partition-crates --write` -- do not edit."
            .to_string(),
        "//!".to_string(),
...
pub fn stage0_emit_core_header_doc() -> std::string::String {
    Rc::new(vec![
        "//! Generated by `claim_executor --emit-partition-crates --write` -- do not edit."
            .to_string(),
        "//!".to_string(),
...
pub fn stage0_package_name_to_rust_ident(package_name: std::string::String) -> std::string::String {
    v1_rt::replace(package_name.clone(), "-".to_string(), "_".to_string())
}

pub fn stage0_crate_dir_to_sibling_dep_path(crate_dir: std::string::String) -> std::string::String {
...
pub enum Stage0ModuleOwnerRefusalCause {
    Stage0ModuleOwnerMissing {
        module_basename: std::string::String,
    },
}
impl Stage0ModuleOwnerRefusalCause {
    pub fn module_basename(&self) -> std::string::String {
        match self {
...
pub enum Stage0PackageCrateDirRefusalCause {
    Stage0PackageCrateDirMissing { package_name: std::string::String },
}
impl Stage0PackageCrateDirRefusalCause {
    pub fn package_name(&self) -> std::string::String {
        match self {
...
pub enum Stage0EmitShellReexportsOutcome {
    Stage0EmitShellReexportsOk {
        lines: Rc<Vec<std::string::String>>,
    },
...
pub enum Stage0CrateBoundaryEmitRefusalCause {
    Stage0CrateBoundaryEmitModuleOwnerMissing {
        module_basename: std::string::String,
    },
    Stage0CrateBoundaryEmitPackageCrateDirMissing {
        package_name: std::string::String,
    },
}
...
pub fn stage0_lookup_module_owner_package_name(
...
) -> Rc<Stage0ModuleOwnerLookup> {
    {
        ...
        .fold(
            "".to_string(),
            |acc: std::string::String, pkg: std::string::String| {
...
) -> Rc<Stage0PackageCrateDirLookup> {
    {
        ...
        let crate_dir =
            matches
                .iter()
                .cloned()
                .fold("".to_string(), |acc: std::string::String, row: _| {
                    if (acc.clone() == "".to_string()) {
                        row.crate_dir.clone()
                    } else {
                        acc.clone()
...
pub fn stage0_reexport_path_dependencies_outcome(
    reexport_packages: Rc<Vec<std::string::String>>,
    ...
    reexport_packages.iter().cloned().fold(
        ...
        |acc: Rc<Stage0ReexportPathDepsOutcome>, pkg: std::string::String| match (*acc).clone() {
...
pub fn stage0_partition_row_header_doc(row: Rc<GeneratedPartitionCrateRow>) -> std::string::String {
    match row.kind.clone() {
...
pub fn render_stage0_crate_dep(dep: Rc<CargoDependency>) -> std::string::String {
...
pub fn render_stage0_crate_feature(feature: Rc<CargoFeature>) -> std::string::String {
...
pub fn render_stage0_crate_features_section(
    features: Rc<Vec<Rc<CargoFeature>>>,
) -> std::string::String {
...
pub fn stage0_crate_mod_include(module_basename: std::string::String) -> std::string::String {
    v1_rt::concat(
        v1_rt::concat(
            v1_rt::concat(
                v1_rt::concat(
...
pub fn render_stage0_foundation_lib(spec: Rc<Stage0CrateSpec>) -> std::string::String {
    {
        let includes = Rc::new({
            let mut __result = Vec::new();
...
pub fn render_stage0_layered_core_lib(spec: Rc<Stage0CrateSpec>) -> std::string::String {
    {
        let sorted_reexports =
            Rc::new({
                ...
                __sorted.sort_by(|a: &std::string::String, b: &std::string::String| {
                    let __ka = (|pkg: std::string::String| {
                        stage0_package_name_to_rust_ident(pkg.clone())
                    })(a.clone());
                    let __kb = (|pkg: std::string::String| {
                        stage0_package_name_to_rust_ident(pkg.clone())
                    })(b.clone());
...
pub fn stage0_emit_shell_module_reexports_outcome(
    ...
    modules.iter().cloned().fold(
        ...
        |acc: Rc<Stage0EmitShellReexportsOutcome>, module_basename: std::string::String| {
            match (*acc).clone() {
