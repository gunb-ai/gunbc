...
pub fn generated_stage0_dirs() -> Rc<Vec<String>> {
    thread_local! {
        static CACHED: Rc<Vec<String>> = {
            Rc::new(vec!["cli_run".to_string(), "module_path_index".to_string()])
        };
    }
    CACHED.with(|c: &Rc<Vec<String>>| c.clone())
}
