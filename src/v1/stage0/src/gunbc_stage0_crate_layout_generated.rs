...
pub fn stage0_crate_layout_generated_note() -> std::string::String {
    thread_local! {
...
pub fn generated_pub_mod_block() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
