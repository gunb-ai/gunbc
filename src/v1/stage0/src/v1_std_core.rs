...
pub fn diagnostic_to_message(d: Rc<CompilerDiagnostic>) -> String {
    ...
    CompilerDiagnostic::CallArgumentDuplicate { callee: c, argument: a, .. } => v1_rt::concat(v1_rt::concat(v1_rt::concat("call shape mismatch calling '".to_string(), c.clone()), "': argument '".to_string()), v1_rt::concat(a.clone(), "' supplied more than once".to_string())),
