...
#[serde(tag = "_variant")]
pub enum CallCalleeSurface {
    NamedCallableCallee,
    ComplexExpressionCallee,
}
...
pub enum ExprData {
    ...
    ExprCall {
        ...
        callee_surface: CallCalleeSurface,
    },
    ExprMethodCall {
...
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
pub struct NamedCallableCallee;
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
pub struct ComplexExpressionCallee;
#[derive(Debug, Clone, Copy, PartialEq, Eq, serde::Serialize, serde::Deserialize)]
