...
pub use crate::v1_std_core::{
    ...
    variant_node_name_at, with_required_cardinality, Cardinality, CompilerDiagnostic, Connective,
    ErrorNode, ExprData, ExprErrorKind, InferredNode, InternResult, InternTable, MatchPattern,
