...
pub fn mint_parsed_node_identity(ctx: Rc<ParseContext>) -> Rc<ParsedNodeIdentityMint> {
    {
        let allocated =
            crate::std_occurrence_identity::alloc_occurrence_id(ctx.occurrence_allocator.clone());
        Rc::new(ParsedNodeIdentityMint {
            identity: crate::std_occurrence_identity::node_occurrence_identity_minted(
                allocated.id.clone(),
            ),
...
pub fn parse_context_occurrence_index(ctx: Rc<ParseContext>) -> Rc<OccurrenceIndex> {
    match ctx.occurrence_index.clone() {
        ...
        std::option::Option::None => Rc::new(OccurrenceIndex {
            entries: Rc::new(vec![]),
        }),
    }
}
    ...
    if enabled.clone() {
        {
            ...
            Rc::new(ParsedPropertiesResult {
                properties: Rc::new(vec![crate::v1_std_core::make_field_init_node(
...
pub fn mint_parsed_bool_property(
...
) -> Rc<ParsedPropertyResult> {
    {
        ...
        Rc::new(ParsedPropertyResult {
            property: crate::v1_std_core::make_field_init_node(
                property_mint.identity.clone(),
                name.clone(),
                crate::v1_std_core::make_expr_node(
                    value_mint.identity.clone(),
...
pub fn mint_parsed_optional_int_property(
    ...
    match value.clone() {
        ...
        std::option::Option::None => Rc::new(ParsedPropertiesResult {
            properties: Rc::new(vec![]),
            ctx: ctx.clone(),
        }),
    }
...
pub fn token_span(tok: Option<Rc<Token>>) -> Rc<SourceSpan> {
    match tok.clone() {
        Some(t) => t.span.clone(),
        std::option::Option::None => crate::v1_std_core::no_span(),
    }
}
...
pub fn advance(tokens: Rc<TokenStream>) -> Rc<AdvanceResult> {
    match token_stream_first(tokens.clone()) {
        ...
        std::option::Option::None => Rc::new(AdvanceResult::AdvanceEof),
    }
}
...
pub fn parse_string_literal_value(tokens: Rc<TokenStream>) -> Rc<StringLitResult> {
    {
        ...
        match tok.clone() {
            ...
            std::option::Option::None => Rc::new(StringLitResult {
                value: "".to_string(),
                tokens: tokens.clone(),
                err: Some(parse_error(
                    "expected string literal".to_string(),
            ...
            Some(t) => match t.shape.clone() {
                TokenShape::ShLitInt => {
                    ...
                    match n_opt.clone() {
                        ...
                        std::option::Option::None => Rc::new(IntLitResult {
                            value: 0,
                            tokens: tokens.clone(),
                            err: Some(parse_error(
                                v1_rt::concat(
        ...
        if matches.clone() {
        ...
        } else {
            {
                let found = match tok.clone() {
                    ...
                    std::option::Option::None => "EOF".to_string(),
                };
...
pub fn eat(tokens: Rc<TokenStream>, expected: Rc<ExpectedToken>) -> Rc<EatResult> {
    match token_stream_first(tokens.clone()) {
        ...
        std::option::Option::None => Rc::new(EatResult::EatUnchanged {
            tokens: tokens.clone(),
        }),
    }
}
            ...
            if (acc.clone() != std::option::Option::None) {
            ...
            } else {
                {
                    ...
                    let matches_state = match crate::v1_std_core::arg_name_at(
                        ...
                        std::option::Option::None => (idx.clone() == 0),
                    };
        ...
        ExprData::ExprCall { .. } => {
            match crate::v1_std_core::expr_call_func_at(expr.clone(), source_indices.clone()) {
                ...
                callee => match parser_helper_identity(callee.clone()) {
                    ...
                    std::option::Option::None => Rc::new(ParserResultWitness::ParserWitnessCall {
...
pub fn stamp_parsed_optional_node(
    ...
    match node.clone() {
        ...
        std::option::Option::None => Rc::new(ParsedOptionalNodeStampResult {
...
pub fn stamp_parsed_pattern(
    ...
    match pattern.clone().as_deref().cloned() {
        ...
        std::option::Option::None => Rc::new(ParsedPatternStampResult {
...
pub fn stamp_parsed_node_list_with_head_role(
    ...
    match nodes.clone().first().cloned() {
        ...
        std::option::Option::None => Rc::new(ParsedNodeListStampResult {
            nodes: Rc::new(vec![]),
            ctx: ctx.clone(),
            err: std::option::Option::None,
        }),
...
pub fn stamp_parsed_module_items(
    ...
    ctx: acc.ctx.clone(),
    err: Some(parse_error("module item form carries no item kind, so its occurrence category cannot be decided; the type bucket is not a default".to_string(), node.span.clone())),
}),
    ParsedModuleItemKind::NotAModuleItem => Rc::new(ParsedNodeListStampResult {
    nodes: acc.nodes.clone(),
    ctx: acc.ctx.clone(),
    err: Some(parse_error("node in module-item position was not constructed by an item constructor, so it carries no item kind; the type bucket is not a default".to_string(), node.span.clone())),
}),
    _ => {
...
pub fn stamp_parsed_node(
...
) -> Rc<ParsedNodeStampResult> {
    {
        ...
        let child_ancestors = match occurrence.clone() {
            ...
            std::option::Option::None => ancestors.clone(),
        };
...
pub fn parse_with_table_ready_module_path(parsed: Rc<ParseWithTableResult>) -> Option<String> {
    match parsed.result.clone().error.clone() {
        ...
        std::option::Option::None => match parsed.result.clone().module.clone() {
...
pub fn parse_fn_body_from_prefix(
    ...
    err: Some(parse_error(v1_rt::concat("generic effectful declaration is not realized: `".to_string(), v1_rt::concat(name.clone(), "` carries both type parameters and a `uses` row. No emitter plumbs type parameters through the effectful path -- the Rust, Python and Go effectful emitters each construct the resource-aware body directly and none routes through the generic-fn split. Declare it with type parameters and no `uses`, or with a `uses` row and no type parameters.".to_string())), name_span.clone())),
        ...
        let body_result = if tok_is_eq(token_stream_first(tokens.clone())) {
            ...
            if tok_is_lbrace(token_stream_first(tokens.clone())) {
                parse_item_block_body(tokens.clone(), ctx.clone())
            } else {
                {
...
pub fn parse_block_body_from_prefix(
...
) -> Rc<ItemResult> {
    {
        ...
        let r = parse_item_block_body(skip_newlines(prefix.tokens.clone()), ctx.clone());
        if has_err(r.err.clone()) {
            return Rc::new(ItemResult {
                item: named_dummy.clone(),
                tokens: r.tokens.clone(),
            ...
            || tok_is_eof(token_stream_first(tokens.clone())))
        {
            let cfg = Rc::new(ServiceConfig {
                endpoint: match endpoint.clone() {
                    Some(e) => e.clone(),
                    std::option::Option::None => crate::v1_std_core::make_expr_node(
                        Rc::new(NodeOccurrenceIdentity::OccurrenceSynthetic),
                        Rc::new(ExprData::ExprLiteral {
                            value: Rc::new(LiteralValue::LitStr {
                                value: "".to_string(),
            ...
            match fname.clone().as_str() {
                "endpoint" => {
                    ...
                    __tco_loop_endpoint = __tco_0;
                    continue;
                }
                "auth" => {
                    let __tco_0 = Some(r3.expr.clone());
                    __tco_loop_auth = __tco_0;
                    continue;
                }
                "auth_input" => {
                    let __tco_0 = Some(r3.expr.clone());
                    __tco_loop_auth_input = __tco_0;
                    continue;
                }
                "auth_source" => {
                    let __tco_0 = Some(r3.expr.clone());
                    __tco_loop_auth_source = __tco_0;
                    continue;
                }
                "rate_limit" => {
                    let __tco_0 = Some(r3.expr.clone());
                    __tco_loop_rate_limit = __tco_0;
                    continue;
                }
                _ => {
                    break Rc::new(ConfigResult {
            ...
            if (fname.clone() == transport_url_key()) {
                ...
                if (fname.clone() == transport_method_key()) {
                    ...
                    if (fname.clone() == transport_path_template_key()) {
                        {
                            let __tco_0 = Some(r3.expr.clone());
                            __tco_loop_path_template = __tco_0;
                            continue;
                        }
                    } else {
                        if (fname.clone() == transport_query_key()) {
                            ...
                            if (fname.clone() == transport_body_key()) {
                                {
                                    let __tco_0 = Some(r3.expr.clone());
                                    __tco_loop_request_body = __tco_0;
                                    continue;
                                }
                            } else {
                                if (fname.clone() == transport_response_format_key()) {
                                    {
                                        let __tco_0 = Some(r3.expr.clone());
                                        __tco_loop_response_format = __tco_0;
                                        continue;
                                    }
                                } else {
                        ...
                        if (kw_text.clone() == "output".to_string()) {
                            ...
                            if (kw_text.clone() == "idempotent".to_string()) {
                                ...
                                );
                                {
                                    ...
                                    __tco_loop_tokens = __tco_0;
                                    __tco_loop_ctx = __tco_1;
                                    __tco_loop_modifier_props = __tco_2;
                                    continue;
                                }
                            } else {
                        ...
                        if (id.clone() == "exit".to_string()) {
                            ...
                            if (id.clone() == "response".to_string()) {
                                ...
                                }
                                {
                                    ...
                                    __tco_loop_tokens = __tco_0;
                                    __tco_loop_ctx = __tco_1;
                                    __tco_loop_response_props = __tco_2;
                                    continue;
                                }
                            } else {
...
pub fn node_to_name_str(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        ...
        let is_keyed_container = (crate::std_types::is_container_type(effective_name.clone())
        ...
        if is_keyed_container.clone() {
            ...
            if (effective_n.type_annotation.clone() != std::option::Option::None) {
                ...
                if crate::std_types::is_container_type(effective_name.clone()) {
                    match effective_n.children.clone().first().cloned() {
                        Some(ch) => v1_rt::concat(
        ...
        match sh.clone() {
            Some(TokenShape::ShLitInt) => {
                ...
                match next_tok.clone() {
                    ...
                    std::option::Option::None => parsed_expr_result(
                        token_stream_advance(tokens.clone(), 1),
                        ctx.clone(),
                        |identity| {
                            crate::v1_std_core::make_expr_node(
                ...
                Some(TokenShape::ShKeyword) => {
                    ...
                    if (kw_text.clone() == "capability".to_string()) {
                        ...
                        }
                        {
                            ...
                            __tco_loop_tokens = __tco_0;
                            __tco_loop_ctx = __tco_1;
                            __tco_loop_capabilities = __tco_2;
                            continue;
                        }
                    } else {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct HeadsBlockSkipResult {
    pub tokens: Rc<TokenStream>,
    pub err: Option<Rc<ErrorNode>>,
}
                    ...
                    Some(t) => {
                        ...
                        if (((b.clone() < 0) || (p.clone() < 0)) || (s.clone() < 0)) {
                        ...
                        } else {
                            {
                                ...
                                let __tco_3 = s.clone();
                                let __tco_4 = true;
                                __tco_loop_offset = __tco_0;
                                __tco_loop_braces = __tco_1;
                                __tco_loop_parens = __tco_2;
                                __tco_loop_brackets = __tco_3;
                                __tco_loop_seen = __tco_4;
                                continue;
                            }
                        }
                    }
...
pub fn heads_skip_block_tokens(
    ...
    loop {
        ...
        let tok = token_stream_first(tokens.clone());
        if tok_is_eof(tok.clone()) {
            break Rc::new(HeadsBlockSkipResult {
                tokens: tokens.clone(),
                err: Some(parse_error(
                    "heads-only parse: unterminated function body".to_string(),
                    token_span(tok.clone()),
                )),
            });
        } else {
...
pub fn parse_block_heads_only(tokens: Rc<TokenStream>, ctx: Rc<ParseContext>) -> Rc<ExprResult> {
    {
        ...
        let skipped = heads_skip_block_tokens(r.tokens.clone(), 1);
        if has_err(skipped.err.clone()) {
            return Rc::new(ExprResult {
                expr: dummy_expr.clone(),
                tokens: skipped.tokens.clone(),
                ctx: ctx.clone(),
...
pub fn parse_item_block_body(tokens: Rc<TokenStream>, ctx: Rc<ParseContext>) -> Rc<ExprResult> {
    if ctx.heads_only.clone() {
        parse_block_heads_only(tokens.clone(), ctx.clone())
    } else {
    ...
    loop {
        ...
        if tok_is_dot(token_stream_first(tokens.clone())) {
            ...
            let next_spine = match spine.clone() {
                std::option::Option::None => crate::v1_std_core::make_named_expr_node(
                    minted.identity.clone(),
                    name.clone(),
                    Rc::new(ExprData::ExprVar {
                        binding_kind: std::option::Option::None,
...
pub fn parse_pipe_rhs(
...
) -> Rc<ExprResult> {
    {
        ...
        let leading_result = match callee.spine.clone() {
            std::option::Option::None => Rc::new(ParsedNodesResult {
                    ...
                    if (is_uppercase_start(last_seg.clone()) && (14 <= min_bp.clone())) {
                        ...
                        if is_uppercase_start(last_seg.clone()) {
                            match crate::v1_std_core::field_access_spine(
                                ...
                                std::option::Option::None => Rc::new(PostfixResult {
                                    expr: lhs.clone(),
                                    changed: false,
                                    tokens: tokens.clone(),
                                    ctx: ctx.clone(),
        ...
        match sh.clone() {
            ...
            Some(TokenShape::ShKeyword) => {
                ...
                match lit_val.clone() {
                    ...
                    std::option::Option::None => Rc::new(PatternResult {
                        pattern: Rc::new(MatchPattern::Wildcard),
                        tokens: tokens.clone(),
                        ctx: ctx.clone(),
                        err: std::option::Option::None,
        ...
        match (*texpr.expr_data.clone()).clone() {
            ExprData::ExprFieldAccess { summary: _, .. } => {
                ...
                let chain_end = match texpr.ident_span.clone() {
                    ...
                    std::option::Option::None => texpr.span.clone().end.clone(),
                };
                Rc::new(SourceSpan {
