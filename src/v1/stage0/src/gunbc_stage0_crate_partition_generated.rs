...
pub fn generated_partition_crate_rows() -> Rc<Vec<Rc<GeneratedPartitionCrateRow>>> {
    thread_local! {
        ...
        modules: Rc::new(vec!["std_content_hash".to_string(), "std_coercion".to_string(), "std_currency".to_string(), "std_decl_ref".to_string(), "std_keyed_row".to_string(), "std_keyed_roster".to_string(), "std_roster_frontier".to_string(), "std_disposition".to_string(), "std_error_primitives".to_string(), "std_http_path".to_string(), "std_emit_model".to_string(), "std_magnitude".to_string(), "std_measure".to_string(), "std_types".to_string(), "std_unicode_types".to_string(), "std_lens_verdict".to_string(), "std_algebra".to_string(), "std_nat".to_string(), "std_node".to_string(), "std_syntax".to_string(), "std_computation".to_string(), "std_termination".to_string(), "std_induction".to_string(), "std_iteration".to_string(), "std_graph".to_string(), "extdeps_uri".to_string(), "extdeps_external_authority".to_string(), "extdeps_process_posix_exit".to_string(), "extdeps_process_gnu_bash_exit".to_string(), "std_process".to_string(), "extdeps_container_oci_digest".to_string(), "extdeps_units_dimensionless".to_string(), "extdeps_units_iec_80000_13".to_string(), "extdeps_units_iso8601".to_string(), "std_occurrence_identity".to_string(), "std_source_annotation".to_string(), "v1_std_core".to_string()]),
