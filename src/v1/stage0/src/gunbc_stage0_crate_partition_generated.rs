...
pub fn generated_partition_crate_rows() -> Rc<Vec<Rc<GeneratedPartitionCrateRow>>> {
    thread_local! {
        ...
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: Rc::new(vec!["gunbc_rust_source_type_bindings".to_string(), "gunbc_structural_realization_bindings".to_string(), "v1_compiler_parse".to_string(), "v1_compiler_coercion".to_string(), "v1_compiler_compiler_tests_rust".to_string(), "v1_compiler_infer_emit_info".to_string(), "v1_compiler_infer_env".to_string(), "v1_compiler_infer_items".to_string(), "v1_compiler_infer_occurrence_binding".to_string(), "v1_compiler_infer_resolve".to_string(), "v1_compiler_infer_service".to_string(), "v1_compiler_infer_sigs".to_string(), "v1_compiler_infer_types".to_string(), "v1_compiler_type_head_exposure".to_string()]),
