...
pub fn generated_partition_crate_rows() -> Rc<Vec<Rc<GeneratedPartitionCrateRow>>> {
    thread_local! {
        ...
        package_name: "v1-stage0-std-primitives".to_string(),
        crate_dir: "src/v1/stage0_std_primitives".to_string(),
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: Rc::new(vec!["std_content_hash".to_string(), "std_coercion".to_string(), "std_decl_ref".to_string(), "std_disposition".to_string(), "std_error_primitives".to_string(), "std_http_path".to_string(), "std_emit_model".to_string(), "std_magnitude".to_string(), "std_measure".to_string(), "std_types".to_string(), "std_lens_verdict".to_string()]),
        ...
        reexport_packages: Rc::new(vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-primitives".to_string(), "v1-stage0-std-core".to_string()]),
        carries_non_empty_wrappers: false,
    }), Rc::new(GeneratedPartitionCrateRow {
        package_name: "v1-stage0-extdeps".to_string(),
        crate_dir: "src/v1/stage0_extdeps".to_string(),
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: Rc::new(vec!["extdeps_external_authority".to_string(), "extdeps_languages_dag_emit".to_string(), "extdeps_languages_dag_syntax".to_string(), "extdeps_languages_dag_types".to_string(), "extdeps_languages_go_emit".to_string(), "extdeps_languages_go_syntax".to_string(), "extdeps_languages_go_types".to_string(), "extdeps_languages_python_emit".to_string(), "extdeps_languages_python_syntax".to_string(), "extdeps_languages_python_types".to_string(), "extdeps_languages_rust_emit".to_string(), "extdeps_languages_rust_syntax".to_string(), "extdeps_languages_rust_types".to_string(), "extdeps_uri".to_string()]),
        reexport_packages: Rc::new(vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-primitives".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string()]),
        carries_non_empty_wrappers: false,
    }), Rc::new(GeneratedPartitionCrateRow {
        ...
        reexport_packages: Rc::new(vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-primitives".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string(), "v1-stage0-extdeps".to_string()]),
        carries_non_empty_wrappers: false,
    }), Rc::new(GeneratedPartitionCrateRow {
        ...
        reexport_packages: Rc::new(vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-primitives".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string(), "v1-stage0-extdeps".to_string(), "v1-stage0-v1-infer".to_string()]),
        carries_non_empty_wrappers: false,
    }), Rc::new(GeneratedPartitionCrateRow {
