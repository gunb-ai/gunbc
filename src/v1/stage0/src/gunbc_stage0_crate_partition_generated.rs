...
pub fn generated_partition_crate_rows() -> Rc<Vec<Rc<GeneratedPartitionCrateRow>>> {
    thread_local! {
        ...
        modules: vec!["v1_rt".to_string()],
        reexport_packages: vec![],
        ...
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: vec!["std_effects".to_string(), "std_execution_mode".to_string(), "std_interface_summary".to_string(), "std_pareto".to_string(), "std_realization_schedule".to_string()],
        reexport_packages: vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-core".to_string()],
        carries_non_empty_wrappers: false,
    }, GeneratedPartitionCrateRow {
        package_name: "v1-stage0-extdeps-base".to_string(),
        crate_dir: "src/v1/stage0_extdeps_base".to_string(),
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: vec!["extdeps_external_authority".to_string(), "extdeps_uri".to_string()],
        reexport_packages: vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string()],
        carries_non_empty_wrappers: false,
    }, GeneratedPartitionCrateRow {
        package_name: "v1-stage0-extdeps-languages".to_string(),
        crate_dir: "src/v1/stage0_extdeps_languages".to_string(),
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: vec!["extdeps_languages_dag_emit".to_string(), "extdeps_languages_dag_syntax".to_string(), "extdeps_languages_dag_types".to_string(), "extdeps_languages_go_emit".to_string(), "extdeps_languages_go_syntax".to_string(), "extdeps_languages_go_types".to_string(), "extdeps_languages_python_emit".to_string(), "extdeps_languages_python_syntax".to_string(), "extdeps_languages_python_types".to_string(), "extdeps_languages_rust_emit".to_string(), "extdeps_languages_rust_syntax".to_string(), "extdeps_languages_rust_types".to_string()],
        reexport_packages: vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string(), "v1-stage0-extdeps-base".to_string()],
        carries_non_empty_wrappers: false,
    }, GeneratedPartitionCrateRow {
        package_name: "v1-stage0-v1-infer".to_string(),
        crate_dir: "src/v1/stage0_v1_infer".to_string(),
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: vec!["v1_compiler_infer_emit_info".to_string(), "v1_compiler_infer_env".to_string(), "v1_compiler_infer_items".to_string(), "v1_compiler_infer_service".to_string(), "v1_compiler_infer_sigs".to_string(), "v1_compiler_infer_types".to_string()],
        reexport_packages: vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string(), "v1-stage0-extdeps-base".to_string(), "v1-stage0-extdeps-languages".to_string()],
        carries_non_empty_wrappers: false,
    }, GeneratedPartitionCrateRow {
        package_name: "v1-stage0-v1-artifact".to_string(),
        crate_dir: "src/v1/stage0_v1_artifact".to_string(),
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: vec!["v1_compiler_artifact".to_string(), "v1_compiler_languages".to_string()],
        reexport_packages: vec!["v1-stage0-runtime".to_string(), "v1-stage0-std-core".to_string(), "v1-stage0-std-surface".to_string(), "v1-stage0-extdeps-base".to_string(), "v1-stage0-extdeps-languages".to_string(), "v1-stage0-v1-infer".to_string()],
        carries_non_empty_wrappers: false,
    }, GeneratedPartitionCrateRow {
        ...
        modules: vec!["v1_compiler_artifact".to_string(), "v1_compiler_infer_items".to_string(), "v1_compiler_infer_service".to_string(), "v1_compiler_infer_types".to_string(), "v1_compiler_languages".to_string(), "v1_rt".to_string(), "v1_std_core".to_string()],
        reexport_packages: vec![],
        carries_non_empty_wrappers: false,
    }])
            };
