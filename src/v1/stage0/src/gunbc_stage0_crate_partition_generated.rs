...
pub fn generated_stage0_crate_partition_note() -> String {
    thread_local! {
        static CACHED: String = {
            "Generated by gunbc stage0_crate_partition_emit — do not hand-edit. Authority: v2.workflow.rust_crate_partition; regen via dag/gunbc/instruments/generated_artifact_gate.dag main_wet.".to_string()
        };
    }
...
pub fn generated_partition_crate_rows() -> Rc<Vec<Rc<GeneratedPartitionCrateRow>>> {
    thread_local! {
        ...
        modules: Rc::new(vec!["std_content_hash".to_string(), "std_coercion".to_string(), "extdeps_currency_currency".to_string(), "std_decl_ref".to_string(), "std_keyed_row".to_string(), "std_keyed_roster".to_string(), "std_roster_frontier".to_string(), "std_dissolution".to_string(), "std_disposition".to_string(), "std_error_primitives".to_string(), "std_emit_model".to_string(), "std_magnitude".to_string(), "std_measure".to_string(), "std_types".to_string(), "std_unicode_types".to_string(), "std_algebra".to_string(), "std_nat".to_string(), "std_node".to_string(), "std_syntax".to_string(), "std_computation".to_string(), "std_termination".to_string(), "std_checked_arithmetic".to_string(), "std_induction".to_string(), "std_graph".to_string(), "extdeps_uri".to_string(), "extdeps_external_authority".to_string(), "extdeps_ietf_http_semantics".to_string(), "std_process_termination".to_string(), "std_primitive_projection".to_string(), "extdeps_container_oci_digest".to_string(), "extdeps_units_dimensionless".to_string(), "extdeps_units_iec_80000_13".to_string(), "extdeps_units_iso8601".to_string(), "extdeps_units_iso_80000_3".to_string(), "std_occurrence_identity".to_string(), "std_source_annotation".to_string(), "std_target_representation".to_string(), "std_literal_elaboration".to_string(), "std_operator_realization".to_string(), "std_import".to_string(), "v1_std_core".to_string(), "gunbc_rust_emitted_edge".to_string()]),
        ...
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: Rc::new(vec!["std_effects".to_string(), "std_execution_mode".to_string(), "extdeps_uri_path".to_string(), "std_interface_summary".to_string(), "std_realization_schedule".to_string(), "std_trait_derive_shape".to_string(), "std_witness_admission".to_string()]),
        ...
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: Rc::new(vec!["extdeps_languages_dag_emit".to_string(), "extdeps_languages_dag_syntax".to_string(), "extdeps_languages_dag_types".to_string(), "extdeps_languages_go_emit".to_string(), "extdeps_languages_go_syntax".to_string(), "extdeps_languages_go_types".to_string(), "extdeps_languages_python_emit".to_string(), "extdeps_languages_python_syntax".to_string(), "extdeps_languages_python_types".to_string(), "extdeps_languages_rust_capabilities".to_string(), "extdeps_languages_rust_emit".to_string(), "extdeps_languages_rust_representation".to_string(), "extdeps_languages_rust_syntax".to_string(), "extdeps_languages_rust_types".to_string()]),
        ...
        kind: GeneratedPartitionCrateKind::GeneratedLayeredCoreCrate,
        modules: Rc::new(vec!["gunbc_rust_source_type_bindings".to_string(), "gunbc_structural_realization_bindings".to_string(), "v1_compiler_parse".to_string(), "v1_compiler_coercion".to_string(), "v1_compiler_compiler_tests_rust".to_string(), "v1_compiler_resolve".to_string(), "v1_compiler_infer".to_string(), "v1_compiler_infer_access".to_string(), "v1_compiler_infer_cycle".to_string(), "v1_compiler_infer_emit_info".to_string(), "v1_compiler_infer_env".to_string(), "v1_compiler_infer_items".to_string(), "v1_compiler_infer_lookup".to_string(), "v1_compiler_infer_method".to_string(), "v1_compiler_infer_occurrence_binding".to_string(), "v1_compiler_infer_patterns".to_string(), "v1_compiler_infer_resolve".to_string(), "v1_compiler_infer_service".to_string(), "v1_compiler_infer_sigs".to_string(), "v1_compiler_infer_types".to_string(), "v1_compiler_ownership".to_string(), "v1_compiler_emit_core_support".to_string(), "v1_compiler_type_head_exposure".to_string()]),
        ...
        modules: Rc::new(vec!["gunbc_rust_emitted_edge".to_string(), "v1_compiler_artifact".to_string(), "v1_compiler_infer_env".to_string(), "v1_compiler_infer_items".to_string(), "v1_compiler_infer_service".to_string(), "v1_compiler_infer_types".to_string(), "v1_compiler_languages".to_string(), "v1_compiler_parse".to_string(), "v1_rt".to_string(), "v1_std_core".to_string()]),
        reexport_packages: Rc::new(vec![]),
        carries_non_empty_wrappers: false,
    })])
            };
