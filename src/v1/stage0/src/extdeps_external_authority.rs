...
pub fn external_model_scope_revision_grain_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn external_model_scope_citations_shape_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn fact_citation_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn declared_scope_facts_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn downstream_support_roster_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
