...
pub fn scale_exponent(s: Scale) -> Option<i64> {
    match s.clone() {
        ...
        Scale::TurnAngle => std::option::Option::None,
        Scale::Sixty => std::option::Option::None,
        Scale::RackUnitHeight => std::option::Option::None,
        Scale::SquareFootArea => std::option::Option::None,
        Scale::Kilo => Some(3),
        Scale::Mega => Some(6),
        Scale::Giga => Some(9),
        Scale::Tera => Some(12),
...
pub fn time_scale_factor_seconds(s: Scale) -> Option<Nat> {
    match s.clone() {
        ...
        Scale::Nano => std::option::Option::None,
        Scale::Micro => std::option::Option::None,
        Scale::Milli => std::option::Option::None,
        Scale::Kilo => std::option::Option::None,
        Scale::Mega => std::option::Option::None,
        Scale::Giga => std::option::Option::None,
        Scale::Tera => std::option::Option::None,
        Scale::Peta => std::option::Option::None,
        Scale::Exa => std::option::Option::None,
        Scale::Kibi => std::option::Option::None,
        Scale::Mebi => std::option::Option::None,
        Scale::Gibi => std::option::Option::None,
        Scale::Tebi => std::option::Option::None,
    }
}
...
// PLANTED SEED-MIRROR DRIFT (control, do not merge): this line is not what the authority emits.
