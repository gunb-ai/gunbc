...
pub fn builtin_function_registry() -> Rc<HashMap<String, Rc<Node>>> {
    {
        let m = seed_node_map("count".to_string(), crate::v1_std_core::int_type());
        let m = v1_rt::rc_map_insert(
            m.clone(),
            "string_length".to_string(),
            crate::v1_std_core::int_type(),
        );
        let m = v1_rt::rc_map_insert(
            m.clone(),
        ...
        let m = v1_rt::rc_map_insert(
            m.clone(),
            "parse_int".to_string(),
            crate::v1_std_core::with_optional_cardinality(crate::v1_std_core::int_type()),
        );
        let m = v1_rt::rc_map_insert(
            m.clone(),
            "char_at".to_string(),
