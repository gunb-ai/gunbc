...
pub use crate::std_occurrence_identity::{
    OccurrenceId, OccurrenceIdAllocator, OccurrenceIndex, OccurrenceTransport,
};
...
pub use crate::v1_compiler_complexity::{ComplexityReport, FuncEntry, RecursionContext};
...
pub use crate::v1_std_core::{
    ...
    make_error_node, module_imports, no_span, param_node_default_value, param_node_name_at,
...
pub fn json_optional_span(value: Option<Rc<SourceSpan>>) -> String {
    match value.clone() {
        Some(inner) => crate::v1_compiler_compile::serialize_span(inner.clone()),
        None => "null".to_string(),
    }
}
...
) -> String {
    {
        ...
        v1_rt::concat(
            v1_rt::concat(
                ...
                crate::v1_compiler_compile::serialize_span(imp.span.clone()),
            ),
            "}".to_string(),
        )
    }
    ...
    match (*value.clone()).clone() {
        ...
        LiteralValue::LitBool { value: inner, .. } => v1_rt::concat(
            v1_rt::concat(
                ...
                crate::v1_compiler_compile::json_bool(inner.clone()),
            ),
            "}".to_string(),
        ),
    ...
    match (*inferred.clone()).clone() {
        ...
        InferredNode::CompilerError { message, span, .. } => v1_rt::concat(
            v1_rt::concat(
                ...
                crate::v1_compiler_compile::serialize_span(span.clone()),
            ),
            "}".to_string(),
        ),
...
pub fn serialize_resource_use(
    ...
    v1_rt::concat(
        v1_rt::concat(
            ...
            crate::v1_compiler_compile::serialize_span(resource_use.span.clone()),
        ),
        "}".to_string(),
    )
}
...
pub fn serialize_field(
    ...
    v1_rt::concat(
        v1_rt::concat(
            ...
            crate::v1_compiler_compile::serialize_span(field_node_span(field.clone())),
        ),
        "}".to_string(),
    )
}
...
pub fn serialize_param(
    ...
    v1_rt::concat(
        v1_rt::concat(
            ...
            crate::v1_compiler_compile::serialize_span(param_node_span(param.clone())),
        ),
        "}".to_string(),
    )
}
                    ...
                    v1_rt::concat(
                        v1_rt::concat(
                            v1_rt::concat(
                                ...
                                crate::v1_compiler_compile::serialize_span(diagnostic_to_span(
                                    diagnostic.diagnostic.clone(),
                                )),
                            ),
...
pub fn front_end_sources(sources: Rc<Vec<Rc<SourceFile>>>) -> Rc<FrontendResult> {
    {
        ...
        let occurrence_transport =
            crate::v1_compiler_compile::merge_occurrence_transports(Rc::new({
                let mut __result = Vec::new();
...
pub fn parse_census_fill_sources(sources: Rc<Vec<Rc<SourceFile>>>) -> Rc<CensusFillParse> {
    {
        ...
        Rc::new(CensusFillParse {
            ...
            occurrence_transport: crate::v1_compiler_compile::merge_occurrence_transports(Rc::new(
                {
                    let mut __result = Vec::new();
                    for input in module_inputs.clone().iter().cloned() {
                        __result.push(module_occurrence_input_transport(input.clone()));
