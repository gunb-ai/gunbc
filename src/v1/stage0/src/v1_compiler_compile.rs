...
pub fn emit_dag_artifact(typed: Rc<ResolvedGraph>) -> Rc<EmitResult> {
    {
        ...
        let _ = trace_mark("compile.emit.dag.collect.done".to_string());
        ...
        let _ = trace_mark("compile.emit.dag.serialize.done".to_string());
        Rc::new(EmitResult {
...
pub fn compile_to_resolved_with_options(
    ...
    {
        let _ = trace_mark("compile.frontend.begin".to_string());
        let frontend = front_end_sources(sources);
        let _ = trace_mark("compile.frontend.done".to_string());
        ...
        match frontend.graph.clone() {
            ...
            Some(graph) => {
                ...
                let _ = trace_mark("compile.normalize.done".to_string());
                ...
                let _ = trace_mark("compile.reconcile.done".to_string());
                ...
                let _ = trace_mark("compile.analyses.done".to_string());
...
pub fn emit_resolved_for_target(
    ...
    match emittable_graph(resolved.clone()) {
        ...
        Some(emittable) => {
            ...
            let _ = trace_mark("compile.emit.begin".to_string());
            let emit_result = emit_from_artifact_plan(emittable.clone(), artifact_plan.clone());
            let _ = trace_mark("compile.emit.done".to_string());
