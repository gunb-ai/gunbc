...
pub struct SerializationSpec {
    pub struct_derives: String,
    pub struct_derives_copy: String,
    pub enum_derives: String,
    pub enum_derives_copy: String,
    pub tag_attribute: String,
    pub rename_attribute_template: String,
...
pub struct IndexingSemantics {
    ...
    pub list_slice: String,
    pub string_slice: String,
}
...
pub struct LanguageSpec {
    ...
    pub callable_type_template: String,
    ...
    pub char_sanitization: Rc<CharSanitization>,
}
...
pub enum CharSanitization {
    NoCharSanitization,
    EmojiEscape { rule: Rc<EmojiCharEscape> },
}
impl CharSanitization {
    pub fn rule(&self) -> Rc<EmojiCharEscape> {
        match self {
            CharSanitization::NoCharSanitization => panic!("no rule on unit variant"),
            CharSanitization::EmojiEscape { rule: __val, .. } => __val.clone(),
        }
    }
}
...
pub fn rust_spec() -> Rc<LanguageSpec> {
    Rc::new(LanguageSpec {
        ...
        char_sanitization: Rc::new(CharSanitization::EmojiEscape {
            rule: Rc::new(EmojiCharEscape {
...
pub fn dag_spec() -> Rc<LanguageSpec> {
    Rc::new(LanguageSpec {
        ...
        service_return: Rc::new(ServiceReturnStrategy::ArrowReturn),
        char_sanitization: Rc::new(CharSanitization::NoCharSanitization),
    })
}
