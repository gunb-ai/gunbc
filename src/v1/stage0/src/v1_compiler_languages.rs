...
pub use crate::extdeps_languages_go_emit::{
    ...
    go_list_literal_empty, go_list_literal_template, go_manifest_file, go_method_templates,
    go_module_keyword, go_null_coalesce_template, go_param_separator, go_param_type_sep,
    go_reserved, go_reserved_escape_suffix, go_return_arrow, go_source_extension, go_string_types,
...
pub use crate::extdeps_languages_python_emit::{
    ...
    python_list_literal_empty, python_list_literal_template, python_method_templates,
    python_module_init, python_module_keyword, python_null_coalesce_template,
    python_param_separator, python_param_type_sep, python_reserved, python_reserved_escape_suffix,
    python_return_arrow, python_source_extension, python_string_types, python_struct_keyword,
    python_tuple_empty, python_tuple_multi_template, python_tuple_pair_template,
    python_tuple_separator, python_type_alias_keyword, python_type_arg_close, python_type_arg_open,
    python_void_type,
};
