...
pub fn python_type_checkpoints() -> Arc<Vec<Arc<TypeCheckpoint>>> {
    thread_local! {
...
pub fn python_algebra_inhabitants() -> Arc<Vec<Arc<InhabitantDecl>>> {
    thread_local! {
...
pub fn python_callable() -> Arc<CallableRepr> {
    thread_local! {
...
pub fn python_cast_syntax() -> Arc<CastSyntax> {
    thread_local! {
