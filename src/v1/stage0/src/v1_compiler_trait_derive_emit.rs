...
pub fn trait_derive_emit_scope_note() -> std::string::String {
    thread_local! {
...
pub fn trait_derive_emit_fn_clone_bound_wf_propagation_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn trait_derive_emit_freemonoid_supplemental_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn trait_derive_emit_set_ord_supplemental_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn trait_derive_emit_ord_propagation_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn v1_record_derive_traits_heap_for_construction(
    ...
    crate::extdeps_languages_rust_capabilities::rust_traits_for_construction_contract(
...
pub fn v1_emit_enum_derives(
...
) -> std::string::String {
    {
        ...
        if ((fm_params.clone().len() as i64) > 0) {
            return v1_rt::concat(v1_rt::concat(v1_rt::concat(v1_freemonoid_unroutable_row_refusal(), crate::extdeps_languages_rust_emit::rust_trait_derive_attr_from_traits(v1_freemonoid_filter_hand_written(crate::extdeps_languages_rust_capabilities::rust_traits_for_construction_contract(crate::extdeps_languages_rust_capabilities::payload_coproduct_derive_traits(), deserialize_forbidden.clone())))), "\n".to_string()), v1_freemonoid_serde_bound_attr(generic_param_names.clone(), fm_params.clone()));
        }
        ...
        for decl_name in Rc::new(v1_rt::map_keys(&type_decl_items)).iter().cloned() {
            if match v1_rt::map_get(&type_decl_items, decl_name.clone()) {
                Some(decl) => {
                    ...
                    if !{
                        let mut __found = false;
                        for dg in decl_generics.iter().cloned() {
...
pub fn v1_item_field_type_exprs_alias_hop_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
