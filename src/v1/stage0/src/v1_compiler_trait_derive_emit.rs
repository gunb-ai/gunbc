...
pub use crate::std_trait_derive_shape::{
    ...
    repr_grounding_derive_shape_has_trait, trait_derive_attr_from_traits,
};
    ...
    if has_fn_fields.clone() {
        ...
        if v1_symbol_wrapped_ord_carrier_shape_eligible(children.clone(), source_indices.clone()) {
            if repr_grounding_derive_completeness_predicate(
                ...
                trait_derive_attr_from_traits(nullary_coproduct_derive_traits())
            } else {
            ...
            if v1_rt::set_contains(&shared_types, name.clone()) {
                trait_derive_attr_from_traits(record_derive_traits_heap())
            } else {
                trait_derive_attr_from_traits(record_derive_traits_copy())
            }
        }
    }
}
...
pub fn v1_emit_enum_derives(
    ...
    if v1_coproduct_all_variants_nullary(children.clone()) {
        ...
        trait_derive_attr_from_traits(payload_coproduct_derive_traits())
    }
}
