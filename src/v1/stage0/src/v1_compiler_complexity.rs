    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.expr_data.clone()).clone() {
            ...
            ExprData::ExprMatch => {
                ...
                match arm_progresses.clone().first().cloned().as_deref().cloned() {
...
pub fn parser_block_state_progress(
    ...
    match stmts.clone().last().cloned().as_deref().cloned() {
        None => DescentEvidence::DescentUnknown,
        Some(last_stmt) => {
            let leading = Rc::new(
                stmts
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.expr_data.clone()).clone() {
            ...
            ExprData::ExprBlock => {
                ...
                match expr.children.clone().last().cloned().as_deref().cloned() {
...
pub fn infer_parser_always_advancing_members_worklist(
    ...
    loop {
        match queue.clone().first().cloned().as_deref().cloned() {
            Some(name) => {
                let rest = Rc::new(
                    queue
                        .clone()
                        ...
                        if {
                            ...
                            (((max_path_target_calls(
                                ...
                                && match recursive_param_name_for_arg(
                                    ...
                                    Some(param_name) => {
                                        (v1_rt::map_get(&callee_measure_params, param_name.clone())
                                            != None)
                                    }
                                    None => false,
                                })
    ...
    Rc::new(v1_rt::map_keys(&names)).iter().cloned().fold(
        ...
        |acc: Rc<HashMap<String, String>>, name: String| {
            if (name.clone() == key.clone()) {
                ...
                match v1_rt::map_get(&names, name.clone()).as_deref().cloned() {
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.expr_data.clone()).clone() {
            ExprData::ExprVar {
                ...
                let name = expr_var_name_at(expr.clone(), si.clone());
                match v1_rt::map_get(&param_set, name.clone()).as_deref().cloned() {
...
pub fn consuming_tokens_arg(
    ...
    expr.children
        ...
        .fold(None, |acc: _, child: Rc<Node>| {
            match acc.clone().as_deref().cloned() {
                Some(_) => acc.clone(),
...
pub fn collect_descent_vars(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprReturn => {
                match body.children.clone().first().cloned().as_deref().cloned() {
...
pub fn unwrap_to_match(mut body: Rc<Node>) -> Option<Rc<Node>> {
    loop {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprBlock => {
                match body.children.clone().last().cloned().as_deref().cloned() {
                    Some(last_stmt) => {
        ...
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprIf => {
                ...
                let else_path = if branching_only.clone() {
                    match else_opt.clone().as_deref().cloned() {
...
pub fn construct_termination_proof(
    ...
    let structural_proof = params
        ...
        .iter()
        .cloned()
        .fold(None, |best: _, p: Rc<Node>| {
            match best.clone().as_deref().cloned() {
                Some(_) => best.clone(),
                None => {
                    let pname = param_node_name_at(p.clone(), si.clone());
                    ...
                    match type_iteration_dimension(type_name.clone()) {
                        ...
                        None => {
                            ...
                            match tree_evidence.clone().as_deref().cloned() {
                                Some(DescentEvidence::Strict) => Some(Rc::new(TerminationProof {
                                ...
                                _ => {
                                    ...
                                    match list_evidence.clone().as_deref().cloned() {
                                        ...
                                        _ => {
                                            ...
                                            match arith_evidence.clone().as_deref().cloned() {
                                                Some(DescentEvidence::Strict) => {
                                                    Some(Rc::new(TerminationProof {
                                                        dimensions: Rc::new(vec![Rc::new(
    ...
    let single_dim_proof = match structural_proof.clone().as_deref().cloned() {
    ...
    match single_dim_proof.clone().as_deref().cloned() {
                ...
                None => {
                    ...
                    match type_iteration_dimension(type_name.clone()) {
                        ...
                        None => {
                            ...
                            match tree_ev.clone().as_deref().cloned() {
                                Some(DescentEvidence::Strict) => Some(Rc::new(TerminationProof {
                                    dimensions: Rc::new(vec![Rc::new(
                                        RankingDimension::TreeSize {
                                            param: pname.clone(),
                                ...
                                _ => {
                                    ...
                                    match list_ev.clone().as_deref().cloned() {
                                        Some(DescentEvidence::Strict) => {
                                            Some(Rc::new(TerminationProof {
                                                dimensions: Rc::new(vec![Rc::new(
                                                    RankingDimension::ListLength {
...
pub fn classify_recursion_pattern(
    ...
    if (path_calls.clone() == 0) {
        {
            let outer = match params.clone().first().cloned().as_deref().cloned() {
            ...
            if all_structural.clone() {
                {
                    ...
                    let first_call =
                        if all_calls_arithmetic_only.clone() {
                            Rc::new({
                                let mut __result = Vec::new();
                                for call_ev in all_evidence.clone().iter().cloned() {
                                    __result.extend(
    ...
    _ => false,
                                ...
                                match tree_rels.clone().first().cloned().as_deref().cloned() {
    ...
    _ => false,
                    ...
                    let is_arithmetic_branching = match first_call.clone().as_deref().cloned() {
                    ...
                    if is_arithmetic_branching.clone() {
                        ...
                        match first_call.clone().as_deref().cloned() {
            ...
            } else {
                {
                    ...
                    let proof_safe_for_branching = match proof.clone().as_deref().cloned() {
                        Some(p) => {
                            ...
                            } else {
                                {
                                    ...
                                    for dim in p.dimensions.clone().iter().cloned() {
                                        if !(match (*dim.clone()).clone() {
                                            ...
                                            RankingDimension::ListLength { param: _, .. } => true,
                                            _ => false,
                                        }) {
                                            __all = false;
                                            break;
                    ...
                    let branching_proof_safe = match branching_proof.clone().as_deref().cloned() {
                        Some(bp) => {
    ...
    match p.clone().as_deref().cloned() {
        ...
        None => Rc::new(CostExpr::CostUnknown {
            reason: v1_rt::concat(
                ...
                match members.clone().first().cloned().as_deref().cloned() {
                    Some(n) => n.clone(),
                    None => "scc".to_string(),
                },
            ),
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprIf => {
                ...
                let else_edges = match else_opt.clone().as_deref().cloned() {
...
pub fn count_unknown_proof_edges(edges: Rc<Vec<Rc<ProofEdge>>>) -> i64 {
    (Rc::new({
        let mut __result = Vec::new();
        for e in edges.clone().iter().cloned() {
            if match e.evidence.clone().first().cloned().as_deref().cloned() {
...
pub fn collect_scc_proof_edges_for_dim(
    ...
    Rc::new({
        let mut __result = Vec::new();
        for name in members.clone().iter().cloned() {
            __result.extend((*match v1_rt::map_get(&func_index, name.clone()).as_deref().cloned() {
    Some(entry) => {
...
Rc::new({ let mut __result = Vec::new(); for callee in Rc::new(v1_rt::map_keys(&best_map)).iter().cloned() { __result.push({
            let ev = match v1_rt::map_get(&best_map, callee.clone()).as_deref().cloned() {
    Some(e) => e.clone(),
    None => DescentEvidence::DescentUnknown,
};
Rc::new(ProofEdge {
...
pub fn count_known_in_edge_map(m: Rc<HashMap<String, DescentEvidence>>) -> i64 {
    (Rc::new({
        ...
        for k in Rc::new(v1_rt::map_keys(&m)).iter().cloned() {
            if match v1_rt::map_get(&m, k.clone()).as_deref().cloned() {
...
Rc::new({ let mut __result = Vec::new(); for callee in Rc::new(v1_rt::map_keys(&unique_keys)).iter().cloned() { __result.push({
            let tree_ev = match v1_rt::map_get(&tree_edge_map, callee.clone()).as_deref().cloned() {
    Some(ev) => ev.clone(),
    None => DescentEvidence::DescentUnknown,
};
let list_ev = match v1_rt::map_get(&list_edge_map, callee.clone()).as_deref().cloned() {
    Some(ev) => ev.clone(),
    None => DescentEvidence::DescentUnknown,
};
Rc::new(ProofEdge {
...
let parser_ev = match v1_rt::map_get(&parser_edge_map, callee.clone()).as_deref().cloned() {
    Some(ev) => ev.clone(),
    None => DescentEvidence::DescentUnknown,
};
Rc::new(ProofEdge {
...
let descending_param = match self_evidence.clone().first().cloned().as_deref().cloned() {
            ...
            if (found.clone() != "".to_string()) {
                    ...
                    .cloned()
                {
                    Some(entry) => {
                        ...
                        match evidence.clone().first().cloned().as_deref().cloned() {
                            ...
                            } else {
                                {
                                        ...
                                        ) == false))
                                    {
                                    ...
                                    } else {
                                        {
                                            ...
                                            let tp_all_known = {
                                                let mut __all = true;
                                                for e in tree_parser_edges.clone().iter().cloned() {
                                                    if !(match e
                                                        .evidence
                                                        .clone()
                                                        .first()
                                            ...
                                            if ((tp_all_known.clone()
                                                && ((tree_parser_edges.clone().len() as i64) > 0))
                                                && (proof_has_non_descending_cycle(
                                                    tp_proof.clone(),
                                                    members.clone(),
        ...
        |acc: Rc<SccBuildAcc>, name: String| {
            if v1_rt::set_contains(&acc.assigned.clone(), name.clone()) {
            ...
            } else {
                {
                    ...
                    let member_set = component
                        .members
                        .clone()
                        .iter()
                        .cloned()
                        .fold(v1_rt::rc_empty_set::<_>(), |inner: _, member: String| {
...
pub fn cost_account_space_from_summary(
    ...
    match summary.peak_space.clone().as_deref().cloned() {
    ...
    loop {
        match (*recv.expr_data.clone()).clone() {
            ...
            ExprData::ExprMethodCall {
                ...
                let inner_recv = match recv.children.clone().first().cloned().as_deref().cloned() {
                    Some(r) => r.clone(),
                    None => recv.clone(),
                };
...
pub fn resolve_lambda_arg(
    ...
    .first()
    .cloned();
    match f_arg.clone().as_deref().cloned() {
...
pub fn resolve_callback_cost(
    ...
    match lambda_arg.clone().as_deref().cloned() {
...
pub fn cost_of_method_by_shape(
    ...
    match shape.clone() {
        ...
        CostShape::ShapeSortBody => {
            let lambda_arg = resolve_lambda_arg(mc_args.clone(), si.clone());
            let key_result = match lambda_arg.clone().as_deref().cloned() {
...
pub fn build_legend(size_names: Rc<Vec<String>>) -> Rc<Legend> {
    ...
    if ((unique.clone().len() as i64) == 0) {
        ...
        if ((unique.clone().len() as i64) == 1) {
            match unique.clone().first().cloned().as_deref().cloned() {
...
pub fn substitute_size(size: Rc<SizeExpr>, legend: Rc<HashMap<String, String>>) -> Rc<SizeExpr> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*size.clone()).clone() {
            SizeExpr::SizeLen { collection: c, .. } => {
                match v1_rt::map_get(&legend, c.clone()).as_deref().cloned() {
            ...
            SizeExpr::SizeVar { name: n, .. } => {
                match v1_rt::map_get(&legend, n.clone()).as_deref().cloned() {
                    Some(short) => Rc::new(SizeExpr::SizeVar {
                        name: short.clone(),
                    }),
                    None => size.clone(),
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*texpr.expr_data.clone()).clone() {
            ...
            ExprData::ExprMethodCall {
                ...
                match method_cost_result.clone().as_deref().cloned() {
    ...
    match lookup_summary(table.clone(), func_name.clone()) {
            ...
            .cloned()
        {
            Some(entry) => {
                ...
                let bounded = match target.clone().as_deref().cloned() {
                    Some(t) => {
                        if is_scc.clone() {
                            Rc::new(ComplexitySummary {
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprIf => {
                ...
                let else_count = match else_branch.clone().as_deref().cloned() {
                    ...
                    .fold(Rc::new(vec![]), |pacc: _, pair: (i64, Rc<Node>)| {
                        ...
                        match evidence.clone() {
                            DescentEvidence::Strict => {
                                ...
                                match factor_opt.clone().as_deref().cloned() {
                                    Some(factor) => {
    ...
    let fan_in = func_entries.clone().iter().cloned().fold(
        ...
        |acc: Rc<HashMap<String, i64>>, entry: Rc<FuncEntry>| {
            ...
            let unique_set = callees.clone().iter().cloned().fold(
                v1_rt::rc_empty_map::<String, bool>(),
                |s: Rc<HashMap<String, bool>>, c: String| v1_rt::rc_map_insert(s, c.clone(), true),
            );
            Rc::new(v1_rt::map_keys(&unique_set)).iter().cloned().fold(
                acc,
                |inner: Rc<HashMap<String, i64>>, callee: String| {
                    let current = match v1_rt::map_get(&inner, callee.clone()).as_deref().cloned() {
                        Some(v) => v.clone(),
                        None => 0,
                    };
    ...
    let result = scc_result.processing_order.clone().iter().cloned().fold(
        ...
        .cloned()
        {
            Some(entry) => {
                ...
                let new_classes =
                    v1_rt::rc_map_insert(acc.classes.clone(), func_name.clone(), class_str.clone());
                let space_class_str =
                ...
                let new_fan_in = unique_callees.clone().iter().cloned().fold(
                    ...
                    |fi: Rc<HashMap<String, i64>>, callee: String| {
                        let current = match v1_rt::map_get(&fi, callee.clone()).as_deref().cloned()
                        {
                            Some(v) => v.clone(),
                            None => 0,
                        };
