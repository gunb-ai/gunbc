...
pub struct ComplexitySummary {
    ...
    pub output_size: Rc<HashMap<std::string::String, Rc<CostExpr>>>,
...
pub struct CostInternTable {
    pub summaries: Rc<HashMap<std::string::String, Rc<ComplexitySummary>>>,
}

pub fn empty_cost_intern_table() -> Rc<CostInternTable> {
    Rc::new(CostInternTable {
        summaries: v1_rt::rc_empty_map::<std::string::String, Rc<ComplexitySummary>>(),
    })
}
...
pub fn evict_summary(
    ...
    cache_summary(
        ...
        Rc::new(ComplexitySummary {
            ...
            output_size: v1_rt::rc_empty_map::<std::string::String, Rc<CostExpr>>(),
...
pub struct SccBuildAcc {
    ...
    pub index: Rc<HashMap<std::string::String, Rc<SccInfo>>>,
}

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct SccResult {
    pub index: Rc<HashMap<std::string::String, Rc<SccInfo>>>,
    pub topo_order: Rc<Vec<std::string::String>>,
    pub processing_order: Rc<Vec<std::string::String>>,
...
pub struct ParserProgressEnv {
    pub state_aliases: Rc<HashMap<std::string::String, DescentEvidence>>,
    pub result_sources: Rc<HashMap<std::string::String, Rc<ParserResultSource>>>,
}
...
pub struct DescentCheckAcc {
    pub ok: bool,
    pub vars: Rc<HashMap<std::string::String, bool>>,
}
...
pub fn proof_has_non_descending_cycle(
    ...
    members: Rc<Vec<std::string::String>>,
    edges: Rc<Vec<Rc<ProofEdge>>>,
) -> bool {
    (crate::std_graph::is_valid_proof(proof.clone(), edges.clone()) == false)
}

pub fn set_has(m: Rc<HashMap<std::string::String, bool>>, key: std::string::String) -> bool {
...
pub fn empty_parser_progress_env() -> Rc<ParserProgressEnv> {
    Rc::new(ParserProgressEnv {
        state_aliases: v1_rt::rc_empty_map::<std::string::String, DescentEvidence>(),
        result_sources: v1_rt::rc_empty_map::<std::string::String, Rc<ParserResultSource>>(),
    })
}
...
pub fn parser_result_state_progress(
    ...
    parser_always_advancing: Rc<HashMap<std::string::String, bool>>,
    consumed_true_set: Rc<HashMap<std::string::String, bool>>,
    result_name: std::string::String,
) -> DescentEvidence {
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.expr_data.clone()).clone() {
            ExprData::ExprVar {
                ...
                let name = crate::v1_std_core::expr_var_name_at(expr.clone(), si.clone());
            ...
            ExprData::ExprFieldAccess { .. } => {
                if (crate::v1_std_core::field_access_field_at(expr.clone(), si.clone())
                    == "state".to_string())
                {
            ...
            ExprData::ExprCall { .. } => {
                match crate::v1_compiler_parse::parser_passthrough_state_expr(
                    expr.clone(),
                    si.clone(),
                ) {
            ...
            ExprData::ExprIf => {
                let cond = crate::v1_std_core::if_condition(expr.clone());
                let then_consumed = match crate::v1_compiler_parse::parser_progress_flag_var(
                    cond.clone(),
                    si.clone(),
                ) {
                    Some(name) => {
                ...
                let then_progress = parser_state_expr_progress(
                    crate::v1_std_core::if_then_branch(expr.clone()),
                    state_param.clone(),
                    env.clone(),
                    parser_always_advancing.clone(),
                    then_consumed.clone(),
                ...
                let else_progress = match crate::v1_std_core::if_else_branch(expr.clone()) {
                ...
                crate::std_termination::descent_evidence_lattice_meet(
                    then_progress.clone(),
                    else_progress.clone(),
                )
            }
            ExprData::ExprLet => {
                let next_env = parser_env_with_binding(
                    crate::v1_std_core::let_binding_name_at(expr.clone(), si.clone()),
                    crate::v1_std_core::let_value(expr.clone()),
                    env.clone(),
                    state_param.clone(),
                    parser_always_advancing.clone(),
                    consumed_true_set.clone(),
                ...
                match crate::v1_std_core::let_body(expr.clone()) {
            ...
            ExprData::ExprMatch => {
                let arm_progresses = Rc::new({
                    ...
                    for arm_node in crate::v1_std_core::match_arm_nodes(expr.clone())
                        .iter()
                        .cloned()
                    {
                ...
                match arm_progresses.clone().first().cloned() {
                    Some(initial) => arm_progresses.iter().cloned().fold(
                        initial.clone(),
                        |acc: DescentEvidence, p: DescentEvidence| {
                            crate::std_termination::descent_evidence_lattice_meet(acc, p.clone())
                        },
                    ),
                    None => DescentEvidence::DescentUnknown,
                }
        ...
        Some(last_stmt) => {
            ...
            let final_env = leading.iter().cloned().fold(
                ...
                |acc_env: Rc<ParserProgressEnv>, stmt: Rc<Node>| match (*stmt.expr_data.clone())
                    .clone()
                {
                    ExprData::ExprLet => match crate::v1_std_core::let_body(stmt.clone()) {
                        None => parser_env_with_binding(
                            crate::v1_std_core::let_binding_name_at(stmt.clone(), si.clone()),
                            crate::v1_std_core::let_value(stmt.clone()),
                            acc_env.clone(),
                            state_param.clone(),
                            parser_always_advancing.clone(),
                            consumed_true_set.clone(),
...
pub fn parser_result_source_for_expr(
    ...
    match (*expr.expr_data.clone()).clone() {
        ExprData::ExprCall { .. } => {
            ...
            match (*crate::v1_compiler_parse::parser_result_witness(expr.clone(), si.clone()))
                .clone()
            {
...
pub fn parser_call_edge_progress(
    ...
    match parser_state_arg_expr(call_node.clone(), state_param.clone(), si.clone()) {
        Some(state_expr) => {
            ...
            if set_has(
                parser_always_advancing.clone(),
                crate::v1_std_core::expr_call_func_at(call_node.clone(), si.clone()),
            ) {
...
pub fn collect_parser_progress_block_edges(
    ...
    stmts: Rc<Vec<Rc<Node>>>,
    state_param: Rc<ParserStateParam>,
    scc_name_set: Rc<HashMap<std::string::String, bool>>,
    env: Rc<ParserProgressEnv>,
    parser_always_advancing: Rc<HashMap<std::string::String, bool>>,
    consumed_true_set: Rc<HashMap<std::string::String, bool>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> Rc<Vec<Rc<ParserProgressEdge>>> {
    {
        let acc = stmts.iter().cloned().fold(
            ...
            |acc: Rc<ParserProgressAcc>, stmt: Rc<Node>| match (*stmt.expr_data.clone()).clone() {
                ExprData::ExprLet => match crate::v1_std_core::let_body(stmt.clone()) {
                    None => {
                        let value_expr = crate::v1_std_core::let_value(stmt.clone());
        ...
        match (*body.expr_data.clone()).clone() {
            ExprData::ExprCall { .. } => {
                let own_edges = if set_has(
                    scc_name_set.clone(),
                    crate::v1_std_core::expr_call_func_at(body.clone(), si.clone()),
                ) {
                    Rc::new(vec![Rc::new(ParserProgressEdge {
                        caller: caller.clone(),
                        callee: crate::v1_std_core::expr_call_func_at(body.clone(), si.clone()),
            ...
            ExprData::ExprIf => {
                let cond = crate::v1_std_core::if_condition(body.clone());
                ...
                let then_edges = collect_parser_progress_edges(
                    caller.clone(),
                    crate::v1_std_core::if_then_branch(body.clone()),
                    state_param.clone(),
                    scc_name_set.clone(),
                    env.clone(),
                    parser_always_advancing.clone(),
                ...
                let else_edges = match crate::v1_std_core::if_else_branch(body.clone()) {
            ...
            ExprData::ExprLet => {
                let value_expr = crate::v1_std_core::let_value(body.clone());
                let value_edges = collect_parser_progress_edges(
                    caller.clone(),
                    value_expr.clone(),
                    state_param.clone(),
                ...
                let next_env = parser_env_with_binding(
                    crate::v1_std_core::let_binding_name_at(body.clone(), si.clone()),
                    value_expr.clone(),
                    env.clone(),
                    state_param.clone(),
                    parser_always_advancing.clone(),
                ...
                let body_edges = match crate::v1_std_core::let_body(body.clone()) {
            ...
            ExprData::ExprMatch => {
                let scrut_edges = collect_parser_progress_edges(
                    caller.clone(),
                    crate::v1_std_core::match_scrutinee(body.clone()),
                    state_param.clone(),
                    scc_name_set.clone(),
                    env.clone(),
                    parser_always_advancing.clone(),
    ...
    Rc::new({
        ...
        for child in Rc::new({
            ...
            for child in expr.children.clone().iter().cloned() {
                if (crate::v1_std_core::field_init_node_name_at(child.clone(), si.clone())
                    == field_name.clone())
                {
                    __result.push(child);
                }
        ...
        .cloned()
        {
            __result.push(crate::v1_std_core::field_init_node_value(child.clone()));
        }
        __result
    })
    .first()
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.expr_data.clone()).clone() {
            ExprData::ExprReturn => parser_success_progress(
                crate::v1_std_core::return_value(expr.clone()),
                state_param.clone(),
                env.clone(),
                parser_always_advancing.clone(),
                consumed_true_set.clone(),
            ...
            ExprData::ExprVar {
                ...
                &env.result_sources.clone(),
                crate::v1_std_core::expr_var_name_at(expr.clone(), si.clone()),
            ) {
                Some(source) => parser_result_state_progress(
                    source.clone(),
                    parser_always_advancing.clone(),
                ...
                let acc = prefix.iter().cloned().fold(
                        ...
                        .clone()
                    {
                        ExprData::ExprLet => match crate::v1_std_core::let_body(stmt.clone()) {
                            None => {
                                let next_env = parser_env_with_binding(
                                    crate::v1_std_core::let_binding_name_at(
                                        stmt.clone(),
                                        si.clone(),
                                    ),
                                    crate::v1_std_core::let_value(stmt.clone()),
...
pub fn parser_member_is_always_advancing(
    entry: Rc<FuncEntry>,
    parser_name_set: Rc<HashMap<std::string::String, bool>>,
    proven: Rc<HashMap<std::string::String, bool>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> bool {
...
pub fn infer_parser_always_advancing_members_worklist(
    ...
    mut func_index: Rc<HashMap<std::string::String, Rc<FuncEntry>>>,
    mut parser_name_set: Rc<HashMap<std::string::String, bool>>,
    mut reverse_graph: Rc<HashMap<std::string::String, Rc<Vec<std::string::String>>>>,
    mut proven: Rc<HashMap<std::string::String, bool>>,
    mut si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
...
pub fn infer_parser_always_advancing_members(
    members: Rc<Vec<std::string::String>>,
    func_index: Rc<HashMap<std::string::String, Rc<FuncEntry>>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> Rc<HashMap<std::string::String, bool>> {
    {
        let parser_name_set = members.iter().cloned().fold(
            v1_rt::rc_empty_map::<std::string::String, bool>(),
        ...
        let reverse_graph =
            crate::std_graph::reverse_adjacency(members.clone(), call_graph.clone());
...
pub fn seed_bool_map(key: std::string::String) -> Rc<HashMap<std::string::String, bool>> {
    v1_rt::rc_map_insert(
        v1_rt::rc_empty_map::<std::string::String, bool>(),
        key.clone(),
        true,
...
pub fn seed_cost_map(
    key: std::string::String,
    value: Rc<CostExpr>,
) -> Rc<HashMap<std::string::String, Rc<CostExpr>>> {
    v1_rt::rc_map_insert(
        v1_rt::rc_empty_map::<std::string::String, Rc<CostExpr>>(),
        key.clone(),
        value.clone(),
    )
}
...
pub fn seed_func_entry_map(
    key: std::string::String,
    value: Rc<FuncEntry>,
) -> Rc<HashMap<std::string::String, Rc<FuncEntry>>> {
    v1_rt::rc_map_insert(
        v1_rt::rc_empty_map::<std::string::String, Rc<FuncEntry>>(),
        key.clone(),
        value.clone(),
    )
}
...
pub fn same_progress_subgraph_has_cycle(
...
) -> bool {
    {
        ...
        let has_self_cycle = {
            ...
            for edge in same_edges.iter().cloned() {
                if (edge.caller.clone() == edge.callee.clone()) {
                    __found = true;
                    break;
                }
        ...
        if has_self_cycle.clone() {
        ...
        } else {
            {
                ...
                crate::std_graph::graph_has_multi_node_scc(members.clone(), graph.clone())
            }
        }
    }
}
...
pub fn classify_parser_scc_recursion_pattern(
    ...
    {
        let scc_name_set = members.iter().cloned().fold(
            v1_rt::rc_empty_map::<std::string::String, bool>(),
            |acc: Rc<HashMap<std::string::String, bool>>, name: std::string::String| {
                v1_rt::rc_map_insert(acc, name.clone(), true)
            },
        ...
        if ((edges.clone().len() as i64) == 0) {
        ...
        } else {
            {
                ...
                {
                    Some(crate::std_computation::lower_call_pattern(Rc::new(
...
pub fn count_self_calls(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        let own = match (*body.expr_data.clone()).clone() {
            ExprData::ExprCall { .. } => {
                let f = crate::v1_std_core::expr_call_func_at(body.clone(), si.clone());
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprMatch => {
                ...
                let max_arm = crate::v1_std_core::match_arm_nodes(body.clone())
                    .iter()
                    .cloned()
                    .fold(continue_calls.clone(), |acc: i64, arm_node: Rc<Node>| {
            ...
            ExprData::ExprIf => {
                let cond_calls = max_path_self_calls_with_cont(
                    crate::v1_std_core::if_condition(body.clone()),
                    func_name.clone(),
                    0,
                    si.clone(),
                );
                ...
                let else_calls = match crate::v1_std_core::if_else_branch(body.clone()) {
            ...
            ExprData::ExprLet => {
                ...
                let body_calls = match crate::v1_std_core::let_body(body.clone()) {
            ...
            ExprData::ExprMethodCall {
                ...
                let arg_calls = crate::v1_std_core::method_arg_nodes(body.clone())
                    .iter()
                    .cloned()
...
pub fn count_target_calls(
    body: Rc<Node>,
    target_set: Rc<HashMap<std::string::String, bool>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> i64 {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        let own = match (*body.expr_data.clone()).clone() {
...
pub fn build_scc_measure_params(
    ...
    func_index: Rc<HashMap<std::string::String, Rc<FuncEntry>>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> Rc<HashMap<std::string::String, Rc<HashMap<std::string::String, std::string::String>>>> {
    members.iter().cloned().fold(
        ...
        >(),
        |acc: Rc<
            HashMap<std::string::String, Rc<HashMap<std::string::String, std::string::String>>>,
        >,
         name: std::string::String| match v1_rt::map_get(&func_index, name.clone()) {
...
pub fn target_call_has_arithmetic_descent(
    ...
    target_set: Rc<HashMap<std::string::String, bool>>,
    func_index: Rc<HashMap<std::string::String, Rc<FuncEntry>>>,
    scc_measure_params: Rc<
        HashMap<std::string::String, Rc<HashMap<std::string::String, std::string::String>>>,
    >,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> bool {
    {
        let callee = crate::v1_std_core::expr_call_func_at(call_node.clone(), si.clone());
            ...
            match v1_rt::map_get(&func_index, callee.clone()) {
                Some(callee_entry) => {
                        ...
                        };
                    {
                        ...
                        {
                            if {
                                let arg_expr = crate::v1_std_core::arg_value(pair.1.clone());
...
pub fn descending_name_set_without_key(
    names: Rc<HashMap<std::string::String, std::string::String>>,
    key: std::string::String,
) -> Rc<HashMap<std::string::String, std::string::String>> {
    Rc::new(v1_rt::map_keys(&names)).iter().cloned().fold(
        v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
        |acc: Rc<HashMap<std::string::String, std::string::String>>, name: std::string::String| {
...
pub fn expr_descending_witness_source(
    mut expr: Rc<Node>,
    mut descending_witness_names: Rc<HashMap<std::string::String, std::string::String>>,
    mut si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> Option<std::string::String> {
    loop {
        match (*expr.expr_data.clone()).clone() {
...
pub fn condition_param_names(
    expr: Rc<Node>,
    param_set: Rc<HashMap<std::string::String, std::string::String>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> Rc<HashMap<std::string::String, std::string::String>> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.expr_data.clone()).clone() {
            ExprData::ExprVar {
                ...
                match v1_rt::map_get(&param_set, name.clone()) {
                    ...
                    None => v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
                }
            }
            _ => expr.children.clone().iter().cloned().fold(
                v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
                |acc: Rc<HashMap<std::string::String, std::string::String>>, child: Rc<Node>| {
                    v1_rt::rc_map_merge(
                        acc,
...
pub fn recursive_measure_param_names(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        let param_set = params.iter().cloned().fold(
            v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
            |acc: Rc<HashMap<std::string::String, std::string::String>>, param: Rc<Node>| {
                v1_rt::rc_map_insert(
                    acc,
                    crate::v1_std_core::param_node_name_at(param.clone(), si.clone()),
                    crate::v1_std_core::param_node_name_at(param.clone(), si.clone()),
                )
            },
        );
        match (*body.expr_data.clone()).clone() {
            ExprData::ExprIf => {
                ...
                let else_names = match crate::v1_std_core::if_else_branch(body.clone()) {
                    Some(eb) => {
            ...
            ExprData::ExprMatch => {
                ...
                let arm_names = crate::v1_std_core::match_arm_nodes(body.clone())
                    .iter()
                    .cloned()
                    .fold(
                        v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
            ...
            ExprData::ExprBlock => body.children.clone().iter().cloned().fold(
                v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
                |acc: Rc<HashMap<std::string::String, std::string::String>>, stmt: Rc<Node>| {
                    v1_rt::rc_map_merge(
                        acc,
...
pub fn is_descending_expr(expr: Rc<Node>) -> bool {
    match (*expr.expr_data.clone()).clone() {
        ExprData::ExprBinOp { op, .. } => match op.clone() {
            BinOp::Sub => match (*crate::v1_std_core::binop_left(expr.clone())
                .expr_data
                .clone())
            .clone()
            {
            ...
            BinOp::Div => match (*crate::v1_std_core::binop_left(expr.clone())
                .expr_data
                .clone())
            .clone()
            {
...
pub fn has_arithmetic_descent(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ExprData::ExprCall { .. } => {
                let own_ok = if (crate::v1_std_core::expr_call_func_at(body.clone(), si.clone())
                    == func_name.clone())
                {
                    {
                        let mut __found = false;
                        for arg_node in body.children.clone().iter().cloned() {
                            if is_descending_expr(crate::v1_std_core::arg_value(arg_node.clone())) {
                                __found = true;
                                break;
                            }
                        }
...
pub fn is_accessor_of_param(
    ...
    vars: Rc<HashMap<std::string::String, bool>>,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> bool {
    match (*expr.expr_data.clone()).clone() {
        ExprData::ExprCall { .. } => {
            let callee = crate::v1_std_core::expr_call_func_at(expr.clone(), si.clone());
            (crate::v1_std_core::is_child_accessor_in_model(callee.clone()) && {
                let mut __found = false;
                for arg_node in expr.children.clone().iter().cloned() {
                    if match (*crate::v1_std_core::arg_value(arg_node.clone())
                        .expr_data
                        .clone())
                    .clone()
                    {
...
pub fn is_children_of_param(
    mut expr: Rc<Node>,
    mut param_name: std::string::String,
    mut vars: Rc<HashMap<std::string::String, bool>>,
    mut si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> bool {
    loop {
        match (*expr.expr_data.clone()).clone() {
            ExprData::ExprFieldAccess { .. } => {
                ...
                let field = crate::v1_std_core::field_access_field_at(expr.clone(), si.clone());
                break (crate::v1_std_core::is_children_list_field(field.clone())
        ...
        (is_children_of_param(expr.clone(), param_name.clone(), vars.clone(), si.clone())
            || match (*expr.expr_data.clone()).clone() {
                ExprData::ExprFieldAccess { .. } => {
                    let base = crate::v1_std_core::field_access_base(expr.clone());
                    let field = crate::v1_std_core::field_access_field_at(expr.clone(), si.clone());
                    (crate::v1_std_core::is_children_list_field(field.clone())
                        && match (*base.expr_data.clone()).clone() {
                            ExprData::ExprVar {
                                binding_kind: _, ..
                            } => set_has(
                ...
                ExprData::ExprMethodCall {
                    ...
                    Some(CollectionSizeEffect::ShrinkEffect) => is_structural_children(
                        crate::v1_std_core::method_receiver(expr.clone()),
                        param_name.clone(),
                        vars.clone(),
                        si.clone(),
                    ),
...
pub fn is_tree_size_preserving_wrapper(
    ...
    match (*expr.expr_data.clone()).clone() {
        ExprData::ExprCall { .. } => {
            let callee = crate::v1_std_core::expr_call_func_at(expr.clone(), si.clone());
            crate::v1_std_core::is_tree_size_preserving(callee.clone())
        }
        _ => false,
    }
}
...
pub fn wrapper_inner_arg(expr: Rc<Node>) -> Rc<Node> {
    match expr.children.clone().first().cloned() {
        Some(arg_node) => crate::v1_std_core::arg_value(arg_node.clone()),
        None => expr,
    }
}
...
pub fn is_list_shrink_expr(
    ...
    match (*expr.expr_data.clone()).clone() {
        ExprData::ExprMethodCall {
            ...
            ((is_shrink.clone()
                && match (*crate::v1_std_core::method_receiver(expr.clone())
                    .expr_data
                    .clone())
                .clone()
                {
                ...
                && match crate::v1_std_core::method_arg_nodes(expr.clone())
                    .first()
                    .cloned()
                {
                    Some(arg_node) => match (*crate::v1_std_core::arg_value(arg_node.clone())
                        .expr_data
                        .clone())
                    .clone()
                    {
...
pub fn list_passthrough_inner(
    ...
    crate::v1_compiler_parse::parser_passthrough_state_expr(expr.clone(), si.clone())
}
    ...
    loop {
        match (*expr.expr_data.clone()).clone() {
            ExprData::ExprVar {
                ...
                let vname = crate::v1_std_core::expr_var_name_at(expr.clone(), si.clone());
...
pub fn is_descent_arg(
    expr: Rc<Node>,
    param_name: std::string::String,
    descent_vars: Rc<HashMap<std::string::String, bool>>,
    check_child: bool,
    check_list: bool,
    si: Rc<HashMap<std::string::String, Rc<NewlineIndex>>>,
) -> bool {
            ...
            match (*expr.expr_data.clone()).clone() {
                ExprData::ExprIf => {
                    (expr_contains_descent(
                        ...
                        check_list.clone(),
                        si.clone(),
                    ) && match crate::v1_std_core::if_else_branch(expr.clone()) {
                ...
                ExprData::ExprFieldAccess { .. } => {
                    let field = crate::v1_std_core::field_access_field_at(expr.clone(), si.clone());
                    let base = crate::v1_std_core::field_access_base(expr.clone());
                    (crate::v1_std_core::is_sub_value_field(field.clone())
                        && match (*base.expr_data.clone()).clone() {
                            ExprData::ExprVar {
                                binding_kind: _, ..
                            } => {
                ...
                ExprData::ExprMethodCall {
                    ...
                    let receiver = crate::v1_std_core::method_receiver(expr.clone());
                    match method_size_effect(ms.clone()) {
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*crate::v1_std_core::field_binding_pattern(fb.clone())).clone() {
            ...
            MatchPattern::VariantPattern {
                ...
                vars.clone(),
                |inner: Rc<HashMap<std::string::String, bool>>, nested_fb: Rc<Node>| {
...
pub fn is_if_option_descent(
    ...
    match (*val.expr_data.clone()).clone() {
        ExprData::ExprIf => {
            let then_branch = crate::v1_std_core::if_then_branch(val.clone());
            ...
            let else_is_none = match crate::v1_std_core::if_else_branch(val.clone()) {
                Some(eb) => match (*eb.expr_data.clone()).clone() {
                    ExprData::ExprVar {
                        binding_kind: _, ..
                    } => {
                        (crate::v1_std_core::expr_var_name_at(eb.clone(), si.clone())
                            == "none".to_string())
                    }
                    ExprData::ExprLiteral { value: v, .. } => match (*v.clone()).clone() {
                        LiteralValue::LitNull => true,
...
pub fn is_match_option_descent(
    ...
    match (*val.expr_data.clone()).clone() {
        ExprData::ExprMatch => {
            let scrut = crate::v1_std_core::match_scrutinee(val.clone());
            ...
            if scrut_has_descent.clone() {
                {
                    let has_extraction = {
                        let mut __found = false;
                        for arm_node in crate::v1_std_core::match_arm_nodes(val.clone())
                            .iter()
                            .cloned()
                        {
                            if match (*crate::v1_std_core::arm_pattern(arm_node.clone())).clone() {
                                MatchPattern::VariantPattern {
...
pub fn collect_descent_vars(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ExprData::ExprLet => {
                ...
                let is_descent_var = match (*val.expr_data.clone()).clone() {
                    ExprData::ExprVar {
                        ...
                        vars.clone(),
                        crate::v1_std_core::expr_var_name_at(val.clone(), si.clone()),
                    ),
                    _ => false,
                };
                ...
                {
                    {
                        ...
                        let inner_is_var = match (*inner.expr_data.clone()).clone() {
                            ExprData::ExprVar {
                                ...
                                vars.clone(),
                                crate::v1_std_core::expr_var_name_at(inner.clone(), si.clone()),
                            ),
                            _ => false,
                        };
                ...
                let is_children_list = match (*val.expr_data.clone()).clone() {
                    ExprData::ExprFieldAccess { .. } => {
                        let base = crate::v1_std_core::field_access_base(val.clone());
                        let field =
                            crate::v1_std_core::field_access_field_at(val.clone(), si.clone());
                        (crate::v1_std_core::is_children_list_field(field.clone())
                            && match (*base.expr_data.clone()).clone() {
                                ExprData::ExprVar {
                                    binding_kind: _, ..
                                } => {
                                    let bname = crate::v1_std_core::expr_var_name_at(
                                        base.clone(),
                                        si.clone(),
                                    );
                                    ((bname.clone() == param_name.clone())
                ...
                match crate::v1_std_core::let_body(body.clone()) {
            ...
            ExprData::ExprMatch => {
                let scrut = crate::v1_std_core::match_scrutinee(body.clone());
                ...
                let scrut_is_param = match (*scrut.expr_data.clone()).clone() {
                    ExprData::ExprVar {
                        ...
                        let sname = crate::v1_std_core::expr_var_name_at(scrut.clone(), si.clone());
                ...
                let with_patterns = if (scrut_is_descent.clone() || scrut_is_param.clone()) {
                    crate::v1_std_core::match_arm_nodes(body.clone())
                        ...
                        .fold(
                            vars.clone(),
                            |acc: Rc<HashMap<std::string::String, bool>>, arm_node: Rc<Node>| {
                                match (*crate::v1_std_core::arm_pattern(arm_node.clone())).clone() {
                                    MatchPattern::VariantPattern {
                                        ...
                                        acc.clone(),
                                        |inner: Rc<HashMap<std::string::String, bool>>,
                                         fb: Rc<Node>| {
            ...
            ExprData::ExprIf => {
                ...
                let else_vars = match crate::v1_std_core::if_else_branch(body.clone()) {
            ...
            ExprData::ExprBlock => body.children.clone().iter().cloned().fold(
                vars.clone(),
                |acc: Rc<HashMap<std::string::String, bool>>, stmt: Rc<Node>| {
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprLet => {
                ...
                let body_ok = match crate::v1_std_core::let_body(body.clone()) {
            ...
            ExprData::ExprIf => {
                ...
                let else_ok = match crate::v1_std_core::if_else_branch(body.clone()) {
            ...
            ExprData::ExprMethodCall {
                ...
                let receiver = crate::v1_std_core::method_receiver(body.clone());
                ...
                if (is_iter.clone() && is_struct.clone()) {
                    {
                        ...
                        let args_ok = {
                            let mut __all = true;
                            for arg_node in crate::v1_std_core::method_arg_nodes(body.clone())
                                .iter()
                                .cloned()
                            {
                                if !({
    ...
    match unwrap_to_match(body.clone()) {
        Some(m) => {
            ...
            match (*scrut.expr_data.clone()).clone() {
                ExprData::ExprFieldAccess { .. } => {
                    let base = crate::v1_std_core::field_access_base(scrut.clone());
                    let field =
                        crate::v1_std_core::field_access_field_at(scrut.clone(), si.clone());
                    (crate::v1_std_core::is_sub_value_field(field.clone())
                        && match (*base.expr_data.clone()).clone() {
                            ExprData::ExprVar {
                                binding_kind: _, ..
...
pub fn is_arithmetic_descent_expr(
    ...
    match (*expr.expr_data.clone()).clone() {
        ExprData::ExprBinOp { op: BinOp::Sub, .. } => {
            let left = crate::v1_std_core::binop_left(expr.clone());
            let right = crate::v1_std_core::binop_right(expr.clone());
            match (*left.expr_data.clone()).clone() {
                ExprData::ExprVar {
                    binding_kind: _, ..
                } => {
                    ((crate::v1_std_core::expr_var_name_at(left.clone(), si.clone())
                        == param_name.clone())
                    ...
                    && is_arithmetic_descent_expr(arg_expr.clone(), param_name.clone(), si.clone()))
                {
                    ...
                    match (*arg_expr.expr_data.clone()).clone() {
                        ExprData::ExprVar {
                            ...
                            let vname =
                                crate::v1_std_core::expr_var_name_at(arg_expr.clone(), si.clone());
                        ...
                        ExprData::ExprFieldAccess { .. } => {
                            let base = crate::v1_std_core::field_access_base(arg_expr.clone());
                            match (*base.expr_data.clone()).clone() {
                                ExprData::ExprVar {
                                    binding_kind: _, ..
                                } => {
                        ...
                        ExprData::ExprMethodCall {
                            ...
                            if is_generalized_shrink(arg_expr.clone(), si.clone()) {
                                {
                                    let recv =
                                        crate::v1_std_core::method_receiver(arg_expr.clone());
...
pub fn merge_optional_evidence(
    ...
    crate::std_termination::optional_evidence_meet(a.clone(), b.clone())
}
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprLet => {
                ...
                let body_ev = match crate::v1_std_core::let_body(body.clone()) {
            ...
            ExprData::ExprMatch => {
                ...
                let arms_ev = crate::v1_std_core::match_arm_nodes(body.clone()).iter().cloned().fold(std::option::Option::None, |acc: _, arm_node: Rc<Node>| {
                let is_base_case = if branching_only.clone() {
                    (max_path_self_calls(crate::v1_std_core::arm_body(arm_node.clone()), func_name.clone(), si.clone()) == 0)
                } else {
                    false
                };
if is_base_case.clone() {
                ...
                } else {
                    {
                        let arm_vars = if (scrut_is_descent.clone() || scrut_is_param.clone()) {
                            match (*crate::v1_std_core::arm_pattern(arm_node.clone())).clone() {
    MatchPattern::VariantPattern { field_bindings: bindings, .. } => bindings.iter().cloned().fold(vars.clone(), |inner: Rc<HashMap<std::string::String, bool>>, fb: Rc<Node>| collect_field_binding_names(fb.clone(), inner)),
    MatchPattern::Bind { declaration: declaration, .. } => if scrut_is_descent.clone() {
                                v1_rt::rc_map_insert(vars.clone(), declaration.name.clone(), true)
                            } else {
                                vars.clone()
                            },
...
let arm_ev = collect_evidence_incremental(crate::v1_std_core::arm_body(arm_node.clone()), func_name.clone(), param_name.clone(), arm_vars.clone(), check_child.clone(), check_list.clone(), branching_only.clone(), si.clone());
merge_optional_evidence(acc.clone(), arm_ev.clone())
            ...
            ExprData::ExprIf => {
                ...
                let then_branch = crate::v1_std_core::if_then_branch(body.clone());
                let else_opt = crate::v1_std_core::if_else_branch(body.clone());
                                ...
                                let ev = match (*arg_val.expr_data.clone()).clone() {
                                    ExprData::ExprLambda => match iteration_element_name(
                                        ...
                                        Some(iter_name) => {
                                            ...
                                            collect_evidence_incremental(
                                                crate::v1_std_core::lambda_body(arg_val.clone()),
                                                func_name.clone(),
                                                param_name.clone(),
                                                ext_vars.clone(),
                                                check_child.clone(),
        ...
        let structural_proof = params.iter().cloned().fold(
            ...
            |best: _, p: Rc<Node>| match best.clone() {
                ...
                None => {
                    ...
                    match crate::std_computation::type_iteration_dimension(type_name.clone()) {
...
pub fn classify_recursion_pattern(
        ...
        if (path_calls.clone() == 0) {
            {
                let outer = match params.clone().first().cloned() {
                    Some(p0) => crate::v1_std_core::param_node_name_at(p0.clone(), si.clone()),
                    None => "_fold_body".to_string(),
                };
                crate::std_computation::lower_call_pattern(Rc::new(CallPattern::FoldBodyCall {
        ...
        } else {
            {
                ...
                let all_structural = (has_evidence.clone() && {
                    let mut __all = true;
                    for call_ev in all_evidence.iter().cloned() {
                        if !({
                            let mut __found = false;
                            for rel in call_ev.iter().cloned() {
    ...
    _ => false,
                        ...
                        if is_arithmetic_branching.clone() {
                            crate::std_computation::lower_call_pattern(Rc::new(
                                CallPattern::SameArgumentCall,
                            ))
                        } else {
                            match first_call.clone() {
                                Some(rel) => {
                                    match crate::std_induction::sub_value_to_lowering_target(
                                        rel.clone(),
                                    ) {
                                        Some(target) => target.clone(),
                                        None => crate::std_computation::lower_call_pattern(
                                            Rc::new(CallPattern::SameArgumentCall),
                                        ),
                                    }
                                }
                                None => crate::std_computation::lower_call_pattern(Rc::new(
                                    CallPattern::SameArgumentCall,
                                )),
                            }
                        }
                ...
                } else {
                    {
                        ...
                        match proof.clone() {
                            Some(p) => {
                                if ((path_calls.clone() == 1) || proof_safe_for_branching.clone()) {
                                    crate::std_computation::lower_call_pattern(
                                        proof_to_call_pattern(p.clone()),
                                    )
                                } else {
                                    if branching_proof_safe.clone() {
                                        match branching_proof.clone() {
                                            Some(bp) => crate::std_computation::lower_call_pattern(
                                                proof_to_call_pattern(bp.clone()),
                                            ),
                                            None => crate::std_computation::lower_call_pattern(
                                                Rc::new(CallPattern::SameArgumentCall),
                                            ),
...
pub fn bounded_recursive_cost(
    ...
    {
        let p = crate::std_computation::size_bound_param(target.bound.clone());
        match p.clone() {
            Some(v) => {
...
pub fn extract_unknown_reason(mut expr: Rc<CostExpr>) -> std::string::String {
    loop {
        match (*expr.clone()).clone() {
...
pub fn build_call_graph(
...
) -> Rc<CallGraph> {
    {
        let names = Rc::new({
            let mut __result = Vec::new();
            for entry in func_entries.iter().cloned() {
...
pub fn scc_label(members: Rc<Vec<std::string::String>>) -> std::string::String {
    match members.clone().first().cloned() {
            ...
            if is_list_shrink_expr(arg_expr.clone(), param_name.clone(), si.clone()) {
                ...
                match (*arg_expr.expr_data.clone()).clone() {
                    ...
                    ExprData::ExprMethodCall {
                        ...
                        if is_generalized_shrink(arg_expr.clone(), si.clone()) {
                            {
                                let recv = crate::v1_std_core::method_receiver(arg_expr.clone());
                ...
                let own_edges = if set_has(target_set.clone(), callee.clone()) {
                    {
                        ...
                        let progress = body.children.clone().iter().cloned().fold(
                            DescentEvidence::DescentUnknown,
                            |acc: DescentEvidence, arg_node: Rc<Node>| {
                                let targets_measure = match crate::v1_std_core::arg_name_at(
                                    arg_node.clone(),
                                    si.clone(),
                                ) {
                                    Some(aname) => {
...
pub fn collect_scc_proof_edges_for_dim(
    ...
    Some(entry) => {
            let best_map = entry.params.clone().iter().cloned().fold(v1_rt::rc_empty_map::<std::string::String, DescentEvidence>(), |best: Rc<HashMap<std::string::String, DescentEvidence>>, p: Rc<Node>| {
                let pname = crate::v1_std_core::param_node_name_at(p.clone(), si.clone());
let descent_vars = collect_descent_vars(entry.body.clone(), pname.clone(), v1_rt::rc_empty_map::<std::string::String, bool>(), check_child.clone(), check_list.clone(), si.clone());
...
let param_map = param_edges.iter().cloned().fold(v1_rt::rc_empty_map::<std::string::String, DescentEvidence>(), |bm: Rc<HashMap<std::string::String, DescentEvidence>>, pe: Rc<ParserProgressEdge>| merge_edge_evidence(bm, pe.clone()));
...
pub fn merge_edge_evidence(
    acc_map: Rc<HashMap<std::string::String, DescentEvidence>>,
    pe: Rc<ParserProgressEdge>,
) -> Rc<HashMap<std::string::String, DescentEvidence>> {
    crate::std_termination::map_evidence_merge_at(
        acc_map.clone(),
        pe.callee.clone(),
        pe.progress.clone(),
    )
...
pub fn count_known_in_edge_map(m: Rc<HashMap<std::string::String, DescentEvidence>>) -> i64 {
    (Rc::new({
        let mut __result = Vec::new();
...
pub fn pick_best_param_edges(
    current: Rc<HashMap<std::string::String, DescentEvidence>>,
    candidate: Rc<HashMap<std::string::String, DescentEvidence>>,
) -> Rc<HashMap<std::string::String, DescentEvidence>> {
...
) -> Rc<Vec<Rc<ProofEdge>>> {
    {
        ...
        Rc::new({
            ...
            for name in members.iter().cloned() {
                __result.extend((*match v1_rt::map_get(&func_index, name.clone()) {
    Some(entry) => {
            let tree_edge_map = entry.params.clone().iter().cloned().fold(v1_rt::rc_empty_map::<std::string::String, DescentEvidence>(), |best_map: Rc<HashMap<std::string::String, DescentEvidence>>, p: Rc<Node>| {
                let pname = crate::v1_std_core::param_node_name_at(p.clone(), si.clone());
let tree_vars = collect_descent_vars(entry.body.clone(), pname.clone(), v1_rt::rc_empty_map::<std::string::String, bool>(), true, false, si.clone());
...
let list_edge_map = entry.params.clone().iter().cloned().fold(v1_rt::rc_empty_map::<std::string::String, DescentEvidence>(), |best_map: Rc<HashMap<std::string::String, DescentEvidence>>, p: Rc<Node>| {
                let pname = crate::v1_std_core::param_node_name_at(p.clone(), si.clone());
let list_vars = collect_descent_vars(entry.body.clone(), pname.clone(), v1_rt::rc_empty_map::<std::string::String, bool>(), false, true, si.clone());
...
let unique_keys = all_keys.iter().cloned().fold(v1_rt::rc_empty_map::<std::string::String, bool>(), |acc: Rc<HashMap<std::string::String, bool>>, k: std::string::String| v1_rt::rc_map_insert(acc, k.clone(), true));
...
let my_parser_edges = Rc::new({ let mut __result = Vec::new(); for pe in all_parser_edges.iter().cloned() { if (pe.caller.clone() == name.clone()) { __result.push(pe); } } __result });
let parser_edge_map = my_parser_edges.iter().cloned().fold(v1_rt::rc_empty_map::<std::string::String, DescentEvidence>(), |bm: Rc<HashMap<std::string::String, DescentEvidence>>, pe: Rc<ParserProgressEdge>| merge_edge_evidence(bm, pe.clone()));
...
let self_all_structural = (self_has_calls.clone() && { let mut __all = true; for call_ev in self_evidence.iter().cloned() { if !({ let mut __found = false; for rel in call_ev.iter().cloned() { if match (*rel.clone()).clone() {
    SubValueRelation::StrictSubValue { .. } => true,
    SubValueRelation::IteratedSubValue { field: _, .. } => true,
    SubValueRelation::ArithmeticDescent { .. } => true,
    _ => false,
...
let descending_param = match self_evidence.clone().first().cloned() {
    Some(call_ev) => call_ev.iter().cloned().fold("".to_string(), |found: std::string::String, rel: Rc<SubValueRelation>| if (found.clone() != "".to_string()) {
                found.clone()
            } else {
...
let self_edge = if self_has_calls.clone() {
                if self_all_structural.clone() {
                    {
                        let derived = self_evidence.iter().cloned().fold(DescentEvidence::Strict, |worst: DescentEvidence, call_ev: Rc<Vec<Rc<SubValueRelation>>>| {
                            let call_best = call_ev.iter().cloned().fold(DescentEvidence::DescentUnknown, |best: DescentEvidence, rel: Rc<SubValueRelation>| {
                                let ev = crate::std_induction::sub_value_to_evidence(rel.clone());
match ev.clone() {
    DescentEvidence::Strict => DescentEvidence::Strict,
    _ => match best {
    DescentEvidence::Strict => DescentEvidence::Strict,
...
crate::std_termination::descent_evidence_lattice_meet(worst, call_best.clone())
});
...
let cross_edges = Rc::new({ let mut __result = Vec::new(); for callee in other_members.iter().cloned() { __result.extend((*{
...
pub fn scc_descending_param(
    ...
    members.iter().cloned().fold(
        "".to_string(),
        |found: std::string::String, name: std::string::String| {
                ...
                match v1_rt::map_get(&func_index, name.clone()) {
                    Some(entry) => {
                        ...
                        match evidence.clone().first().cloned() {
                            Some(call_ev) => call_ev.iter().cloned().fold(
                                "".to_string(),
                                |p: std::string::String, rel: Rc<SubValueRelation>| {
...
pub fn construct_scc_termination_proof(
...
) -> Option<Rc<TerminationProof>> {
    {
        ...
        let cx_l2_all_known = {
            let mut __all = true;
            for e in cx_l2_edges.iter().cloned() {
                if !(match e.evidence.clone().first().cloned() {
                    Some(DescentEvidence::DescentUnknown) => false,
                    _ => true,
                }) {
            ...
            ) == false))
        {
        ...
        } else {
            {
                ...
                let tree_all_known = {
                    let mut __all = true;
                    for e in tree_edges.iter().cloned() {
                        if !(match e.evidence.clone().first().cloned() {
                            Some(DescentEvidence::DescentUnknown) => false,
                            _ => true,
                        }) {
                    ...
                    ) == false))
                {
                ...
                } else {
                    {
                        ...
                        let list_all_known = {
                            let mut __all = true;
                            for e in list_edges.iter().cloned() {
                                if !(match e.evidence.clone().first().cloned() {
                                    Some(DescentEvidence::DescentUnknown) => false,
                                    _ => true,
                                }) {
                            ...
                            ) == false))
                        {
                        ...
                        } else {
                            {
                                ...
                                let parser_all_known = {
                                    let mut __all = true;
                                    for e in parser_edges.iter().cloned() {
                                        if !(match e.evidence.clone().first().cloned() {
                                            Some(DescentEvidence::DescentUnknown) => false,
                                            _ => true,
                                        }) {
                                    ...
                                    ) == false))
                                {
                                ...
                                } else {
                                    {
                                        ...
                                        let lex_all_known = {
                                            let mut __all = true;
                                            for e in lex_edges.iter().cloned() {
                                                if !(match e.evidence.clone().first().cloned() {
                                            ...
                                            ) == false))
                                        {
                                        ...
                                        } else {
                                            {
                                                ...
                                                let tp_all_known = {
                                                    let mut __all = true;
                                                    for e in tree_parser_edges.iter().cloned() {
                                                        if !(match e
                                                            .evidence
                                                            .clone()
                                                            .first()
...
pub fn classify_scc_recursion_pattern(
...
) -> Rc<LoweringTarget> {
    {
        ...
        match proof.clone() {
            Some(p) => crate::std_computation::lower_call_pattern(proof_to_call_pattern(p.clone())),
            None => {
...
pub fn build_scc_index(
...
) -> Rc<SccResult> {
    {
        ...
        let adjacency = crate::std_graph::forward_adjacency(names.clone(), graph.clone());
        let reverse_graph = crate::std_graph::reverse_adjacency(names.clone(), graph.clone());
        let finish = names.iter().cloned().fold(
            ...
            |acc: Rc<DfsFinishAcc>, name: std::string::String| {
                crate::std_graph::dfs_finish_order(name.clone(), adjacency.clone(), acc)
            },
        );
        let topo_order = v1_rt::reverse(finish.order.clone());
        let result = topo_order.iter().cloned().fold(Rc::new(SccBuildAcc {
    assigned: v1_rt::rc_empty_set::<String>(),
    index: v1_rt::rc_empty_map::<std::string::String, Rc<SccInfo>>(),
}), |acc: Rc<SccBuildAcc>, name: std::string::String| if v1_rt::set_contains(&acc.assigned.clone(), name.clone()) {
            acc.clone()
        } else {
            {
                let component = crate::std_graph::dfs_collect_component(name.clone(), reverse_graph.clone(), Rc::new(SccComponentAcc {
    visited: acc.assigned.clone(),
    members: Rc::new(vec![]),
}));
let member_set = component.members.clone().iter().cloned().fold(v1_rt::rc_empty_set::<_>(), |inner: _, member: std::string::String| v1_rt::rc_set_insert(inner, member.clone()));
let members = Rc::new({ let mut __result = Vec::new(); for member in names.iter().cloned() { if v1_rt::set_contains(&member_set, member.clone()) { __result.push(member); } } __result });
...
let next_index = members.iter().cloned().fold(acc.index.clone(), |inner: Rc<HashMap<std::string::String, Rc<SccInfo>>>, member: std::string::String| v1_rt::rc_map_insert(inner, member.clone(), info.clone()));
Rc::new(SccBuildAcc {
...
pub fn space_of_note() -> std::string::String {
    thread_local! {
...
pub fn derive_peak_space_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn derive_peak_space(
    work: Rc<CostExpr>,
    output_size: Rc<HashMap<std::string::String, Rc<CostExpr>>>,
) -> Rc<CostExpr> {
...
pub fn cost_account_space_from_summary_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn cost_account_space_from_summary(
    summary: Rc<ComplexitySummary>,
    size_env: Rc<HashMap<std::string::String, i64>>,
) -> Option<ByteSize> {
...
pub fn cost_expr_degree_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn degree_to_bound(degree: i64, param: std::string::String) -> Rc<CostBound> {
    if (degree.clone() == 0) {
        crate::std_induction::cost_constant()
    } else {
        crate::std_induction::cost_poly(param.clone(), degree.clone())
    }
}

pub fn space_asymptotic_bound(work: Rc<CostExpr>, param: std::string::String) -> Rc<CostBound> {
...
pub fn time_asymptotic_bound(work: Rc<CostExpr>, param: std::string::String) -> Rc<CostBound> {
...
pub fn eval_size_expr_concrete(
    s: Rc<SizeExpr>,
    env: Rc<HashMap<std::string::String, i64>>,
) -> Option<i64> {
...
pub fn eval_cost_expr_concrete(
    e: Rc<CostExpr>,
    env: Rc<HashMap<std::string::String, i64>>,
) -> Option<i64> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || match (*e.clone()).clone() {
...
pub fn scalar_output() -> Rc<HashMap<std::string::String, Rc<CostExpr>>> {
    v1_rt::rc_empty_map::<std::string::String, Rc<CostExpr>>()
}
        ...
        match (*recv.expr_data.clone()).clone() {
            ExprData::ExprVar { .. } => {
                break Rc::new(SizeExpr::SizeLen {
                    collection: crate::v1_std_core::expr_var_name_at(recv.clone(), si.clone()),
                });
            }
            ExprData::ExprFieldAccess { .. } => {
                break Rc::new(SizeExpr::SizeLen {
                    collection: crate::v1_std_core::field_access_field_at(recv.clone(), si.clone()),
                });
            }
            ExprData::ExprMethodCall {
...
pub fn size_binder_name(size: Rc<SizeExpr>) -> std::string::String {
...
pub fn resolve_lambda_arg(
...
) -> Option<Rc<Node>> {
    {
        let f_arg = Rc::new({
            let mut __result = Vec::new();
            for a in mc_arg_nodes.iter().cloned() {
                if (crate::v1_std_core::authored_name_at(si.clone(), a.clone()) == "f".to_string())
                {
                    __result.push(a);
                }
            }
        ...
        .cloned();
        match f_arg.clone() {
            Some(fa) => Some(crate::v1_std_core::arg_value(fa.clone())),
            None => Rc::new({
                let mut __result = Vec::new();
                for a in mc_arg_nodes.iter().cloned() {
...
pub fn resolve_callback_cost(
    ...
    func_index: Rc<HashMap<std::string::String, Rc<FuncEntry>>>,
    scc_index: Rc<HashMap<std::string::String, Rc<SccInfo>>>,
    parser_always_advancing: Rc<HashMap<std::string::String, bool>>,
    ...
    match lambda_arg.clone() {
        Some(la) => match (*la.expr_data.clone()).clone() {
            ExprData::ExprVar { .. } => {
                let fn_ref = crate::v1_std_core::expr_var_name_at(la.clone(), si.clone());
...
pub struct ComplexityReport {
    pub function_classes: Rc<HashMap<std::string::String, std::string::String>>,
    pub space_classes: Rc<HashMap<std::string::String, std::string::String>>,
    pub function_space_bytes: Rc<HashMap<std::string::String, i64>>,
...
pub fn empty_complexity_report() -> Rc<ComplexityReport> {
    Rc::new(ComplexityReport {
        function_classes: v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
        space_classes: v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
        function_space_bytes: v1_rt::rc_empty_map::<std::string::String, i64>(),
...
pub fn format_size(size: Rc<SizeExpr>) -> std::string::String {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*size.clone()).clone() {
...
pub fn format_cost_class(expr: Rc<CostExpr>) -> std::string::String {
    match (*expr.clone()).clone() {
...
pub fn format_cost_inner(expr: Rc<CostExpr>) -> std::string::String {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.clone()).clone() {
...
pub fn parenthesize_additive_cost(expr: Rc<CostExpr>) -> std::string::String {
    match (*expr.clone()).clone() {
        CostExpr::CostAdd { .. } => v1_rt::concat(
...
pub fn short_var_name(index: i64) -> std::string::String {
    if (index.clone() == 0) {
        "n".to_string()
    } else {
        if (index.clone() == 1) {
...
#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct Legend {
    pub substitution: Rc<HashMap<std::string::String, std::string::String>>,
    pub suffix: std::string::String,
}

pub fn build_legend(size_names: Rc<Vec<std::string::String>>) -> Rc<Legend> {
    {
        let unique = deduplicate(size_names.clone());
        if ((unique.clone().len() as i64) == 0) {
            Rc::new(Legend {
                substitution: v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
                suffix: "".to_string(),
            })
        } else {
            if ((unique.clone().len() as i64) == 1) {
                ...
                {
                    let indexed = unique.iter().cloned().fold(
                        Rc::new(Legend {
                            substitution: v1_rt::rc_empty_map::<
                                std::string::String,
                                std::string::String,
                            >(),
                            suffix: "".to_string(),
                        }),
                        |acc: Rc<Legend>, name: std::string::String| {
                            let idx =
...
pub fn substitute_size(
    size: Rc<SizeExpr>,
    legend: Rc<HashMap<std::string::String, std::string::String>>,
) -> Rc<SizeExpr> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*size.clone()).clone() {
...
pub fn classify_complexity(expr: Rc<CostExpr>) -> std::string::String {
    {
...
pub fn collect_size_vars_from_size(size: Rc<SizeExpr>) -> Rc<Vec<std::string::String>> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*size.clone()).clone() {
            SizeExpr::SizeLen { collection: c, .. } => {
...
pub fn collect_size_vars(expr: Rc<CostExpr>) -> Rc<Vec<std::string::String>> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*expr.clone()).clone() {
            CostExpr::CostSum {
                upper: u, body: bd, ..
...
pub struct DeduplicateAcc {
    ...
    pub out: Rc<Vec<std::string::String>>,
}

pub fn deduplicate(items: Rc<Vec<std::string::String>>) -> Rc<Vec<std::string::String>> {
    {
        let result = items.iter().cloned().fold(
            ...
            |acc: Rc<DeduplicateAcc>, item: std::string::String| match v1_rt::map_get(
                &acc.seen.clone(),
                item.clone(),
            ) {
                Some(_) => acc.clone(),
...
pub struct TopoBuildAcc {
    pub table: Rc<CostInternTable>,
    pub classes: Rc<HashMap<std::string::String, std::string::String>>,
    pub space_classes: Rc<HashMap<std::string::String, std::string::String>>,
    pub function_space_bytes: Rc<HashMap<std::string::String, i64>>,
    pub violations: Rc<Vec<Rc<ComplexityViolation>>>,
    pub fan_in: Rc<HashMap<std::string::String, i64>>,
    pub processed: Rc<HashMap<std::string::String, bool>>,
}
...
pub fn cost_of_expr(
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*texpr.expr_data.clone()).clone() {
            ...
            ExprData::ExprBinOp { .. } => {
                let l = crate::v1_std_core::binop_left(texpr.clone());
                let r = crate::v1_std_core::binop_right(texpr.clone());
                let lr = cost_of_expr(
                    l.clone(),
                    func_index.clone(),
                    scc_index.clone(),
    ...
    table: callee_result.table.clone(),
                ...
                let ar = cost_of_expr(crate::v1_std_core::arg_value(a.clone()), func_index.clone(), scc_index.clone(), acc.table.clone(), parser_always_advancing.clone(), recursion_ctx.clone(), si.clone());
Rc::new(SummaryResult {
    summary: Rc::new(ComplexitySummary {
    ...
    table: ar.table.clone(),
            ...
            ExprData::ExprMethodCall {
                ...
                let method_cost_result = if (ms.clone() == std::option::Option::None) {
                    ...
                    match (*ms.clone().unwrap()).clone() {
                        MethodSemantics::AlgebraMethodSemantics {
                            ...
                            let pc = crate::v1_compiler_infer_types::node_is_collection(
                                crate::v1_compiler_infer_types::resolved_type(texpr.clone()),
                                si.clone(),
                            );
                            match cs.clone() {
                                ...
                                None => Some(Rc::new(SummaryResult {
                                    summary: Rc::new(ComplexitySummary {
                                        ...
                                        output_size: v1_rt::rc_empty_map::<
                                            std::string::String,
                                            Rc<CostExpr>,
                                        >(),
                                        certainty: recv_r.summary.clone().certainty.clone(),
                ...
                match method_cost_result.clone() {
                    ...
                    _ => {
                        let args_result = mc_args.iter().cloned().fold(
                            Rc::new(SummaryResult {
                                summary: Rc::new(ComplexitySummary {
                                    work: Rc::new(CostExpr::CostConst { value: 0 }),
                                    span: Rc::new(CostExpr::CostConst { value: 0 }),
            ...
            ExprData::ExprIf => {
                ...
                let e_result = match crate::v1_std_core::if_else_branch(texpr.clone()) {
                    Some(eb) => {
                        let er = cost_of_expr(
                            eb.clone(),
                            func_index.clone(),
            ...
            ExprData::ExprForEach => {
                let c = crate::v1_std_core::foreach_collection(texpr.clone());
                let bd = crate::v1_std_core::foreach_body(texpr.clone());
                let c_r = cost_of_expr(
                    c.clone(),
                    func_index.clone(),
                    scc_index.clone(),
...
pub fn derive_edge_evidence(all_calls: Rc<Vec<Rc<Vec<Rc<SubValueRelation>>>>>) -> DescentEvidence {
    all_calls.iter().cloned().fold(
        ...
        |worst: DescentEvidence, call_ev: Rc<Vec<Rc<SubValueRelation>>>| {
            let call_best = call_ev.iter().cloned().fold(
                DescentEvidence::DescentUnknown,
    ...
    all_calls.iter().cloned().fold(
            ...
            .next()
        {
            Some(rel) => crate::std_termination::descent_evidence_lattice_meet(
                acc.clone(),
                crate::std_induction::sub_value_to_evidence(rel.clone()),
            ),
            None => acc.clone(),
        },
    )
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        match (*body.expr_data.clone()).clone() {
            ...
            ExprData::ExprIf => {
                ...
                let else_branch = crate::v1_std_core::if_else_branch(body.clone());
...
pub fn distinct_descended_fields(
...
) -> i64 {
    {
        let field_set = all_calls.iter().cloned().fold(
            v1_rt::rc_empty_map::<std::string::String, bool>(),
            |acc: Rc<HashMap<std::string::String, bool>>,
             call_evidence: Rc<Vec<Rc<SubValueRelation>>>| match call_evidence
                .clone()
                .iter()
                .cloned()
                .skip(param_index.clone() as usize)
...
pub fn build_complexity_report(
...
) -> Rc<ComplexityReport> {
    {
        ...
        let func_index = func_entries.iter().cloned().fold(
            v1_rt::rc_empty_map::<std::string::String, Rc<FuncEntry>>(),
            |acc: Rc<HashMap<std::string::String, Rc<FuncEntry>>>, entry: Rc<FuncEntry>| {
        ...
        let full_scc_index = func_entries.iter().cloned().fold(
            ...
            |acc: Rc<HashMap<std::string::String, Rc<SccInfo>>>, entry: Rc<FuncEntry>| {
                match v1_rt::map_get(&acc, entry.name.clone()) {
                    Some(_) => acc.clone(),
                    None => {
        ...
        let call_forward = crate::std_graph::forward_adjacency(
            Rc::new({
                let mut __result = Vec::new();
                for entry in func_entries.iter().cloned() {
                    __result.push(entry.name.clone());
        ...
        let fan_in = func_entries.iter().cloned().fold(
            ...
            |acc: Rc<HashMap<std::string::String, i64>>, entry: Rc<FuncEntry>| {
                let callees = match v1_rt::map_get(&call_forward, entry.name.clone()) {
                    Some(cs) => cs.clone(),
                    None => Rc::new(vec![]),
                };
                let unique_set = callees.iter().cloned().fold(
                    v1_rt::rc_empty_map::<std::string::String, bool>(),
                    |s: Rc<HashMap<std::string::String, bool>>, c: std::string::String| {
                        v1_rt::rc_map_insert(s, c.clone(), true)
                    },
                );
                Rc::new(v1_rt::map_keys(&unique_set)).iter().cloned().fold(
                    acc,
                    |inner: Rc<HashMap<std::string::String, i64>>, callee: std::string::String| {
        ...
        let result = scc_result.processing_order.clone().iter().cloned().fold(
            Rc::new(TopoBuildAcc {
                ...
                classes: v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
                space_classes: v1_rt::rc_empty_map::<std::string::String, std::string::String>(),
                function_space_bytes: v1_rt::rc_empty_map::<std::string::String, i64>(),
                violations: Rc::new(vec![]),
                fan_in: fan_in.clone(),
                processed: v1_rt::rc_empty_map::<std::string::String, bool>(),
            }),
            |acc: Rc<TopoBuildAcc>, func_name: std::string::String| match v1_rt::map_get(
                &func_index,
                func_name.clone(),
            ) {
                Some(entry) => {
                    ...
                    let new_function_space_bytes = match space_bytes_opt.clone() {
                        Some(bs) => v1_rt::rc_map_insert(
                            ...
                            func_name.clone(),
                            crate::std_measure::byte_size_count(bs.clone()),
                        ),
                    ...
                    let new_fan_in = unique_callees.iter().cloned().fold(
                        acc.fan_in.clone(),
                        |fi: Rc<HashMap<std::string::String, i64>>, callee: std::string::String| {
                    ...
                    let evicted_table = unique_callees.iter().cloned().fold(
                        sr.table.clone(),
                        |t: Rc<CostInternTable>, callee: std::string::String| {
