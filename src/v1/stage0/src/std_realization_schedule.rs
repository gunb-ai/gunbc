...
#[serde(tag = "_variant")]
pub enum CostAxisObservation<T> {
    CostAxisObserved { value: T },
    CostAxisUnobserved { obligation: NonEmptyStr },
}

#[derive(Debug, Clone, PartialEq, serde::Serialize, serde::Deserialize)]
pub struct CostAccount<S> {
    pub time: Rc<Measure<Time, S, i64>>,
    pub space: CostAxisObservation<ByteSize>,
    pub power: CostAxisObservation<Watt>,
    pub basis: CostBasis,
...
pub fn cost_account_predicted_zero<S>() -> Rc<CostAccount<S>> {
    Rc::new(CostAccount {
        ...
        space: CostAxisObservation::CostAxisObserved {
            value: crate::std_measure::byte_size(0),
        },
        power: CostAxisObservation::CostAxisObserved {
...
pub fn cost_account_measured<S>(time: Rc<Measure<Time, S, i64>>) -> Rc<CostAccount<S>> {
    Rc::new(CostAccount {
        time: time.clone(),
        space: CostAxisObservation::CostAxisUnobserved {
            obligation: "space not observed by time-only measurement".to_string(),
        },
        power: CostAxisObservation::CostAxisUnobserved {
            obligation: "power not observed by time-only measurement".to_string(),
        },
