...
pub use crate::std_witness_admission::compare_declared_derived_enrollment_cadence_wires;
pub use crate::std_witness_admission::EnrollmentCadenceWireCompare;
use crate::std_witness_admission::EnrollmentCadenceWireCompare::{
    EnrollmentCadenceWireMismatch, EnrollmentCadenceWireUnrecognized, EnrollmentCadenceWiresMatch,
};
use crate::v1_rt;
...
pub fn compare_span_enrolled_wall_budget(
    ...
    match (*compare_declared_derived_enrollment_cadence_wires(
        envelope.cadence.clone(),
        derived_cadence.clone(),
    ))
    .clone()
    {
        EnrollmentCadenceWireCompare::EnrollmentCadenceWireUnrecognized { wire: wire, .. } => {
            Rc::new(WitnessEnvelopeCompareVerdict::UnrecognizedDeclaredCadence {
                wire: wire.clone(),
            })
        }
        EnrollmentCadenceWireCompare::EnrollmentCadenceWireMismatch {
            ...
            declared_cadence: d.clone(),
            derived_cadence: r.clone(),
        }),
        EnrollmentCadenceWireCompare::EnrollmentCadenceWiresMatch => match (*observed.clone())
            .clone()
        {
