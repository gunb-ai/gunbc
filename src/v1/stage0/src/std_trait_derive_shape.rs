...
pub fn trait_derive_shape_note() -> std::string::String {
    thread_local! {
...
pub fn trait_derive_shape_grounding_lane_handoff() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn pair_completion_shape_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn repr_grounding_group_completion_carrier_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
