...
use crate::v1_compiler_languages::TestNameStyle::*;
...
pub fn to_screaming_snake(name: String) -> String {
    {
        ...
        Rc::new({
            ...
            for ch in Rc::new(snake.clone().chars().map(|c| c as i64).collect::<Vec<_>>())
                ...
                .cloned()
            {
                __result.push(crate::v1_compiler_emit_core_support::to_upper_char(
                    ch.clone(),
                ));
            }
            __result
...
pub fn sanitize_service_name(name: String) -> String {
    {
        ...
        let pascal_parts = Rc::new({
            ...
            for p in parts.clone().iter().cloned() {
                __result.push(crate::v1_compiler_emit_core_support::capitalize_first(
                    p.clone(),
                ));
            }
            __result
            ...
            Rc::new({
                ...
                .cloned()
                {
                    __result.push(if (pair.0.clone() == 0) {
                        crate::v1_compiler_emit_core_support::to_upper_char(pair.1.clone())
                    } else {
