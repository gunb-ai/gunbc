...
pub fn positive_descent_amount_from_positive_int(k: i64) -> Rc<PositiveDescentAmount> {
...
pub fn proportional_divisor_from_int_at_least_two(k: i64) -> Rc<ProportionalDivisor> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        if (k.clone() < 2) {
            None
        } else {
