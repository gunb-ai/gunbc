...
use crate::v1_compiler_stage0_crates::Stage0CrateBoundaryEmitRefusalCause::Stage0CrateBoundaryEmitPackageIdentRefused;
use crate::v1_compiler_stage0_crates::Stage0CratePlanOutcome::{
    Stage0CratePlanIdentRefused, Stage0CratePlanOk, Stage0CratePlanRefused,
};
...
pub use crate::v1_compiler_stage0_crates::{
    Stage0CrateBoundaryEmitRefusalCause, Stage0CratePlanOutcome, Stage0CrateSpec,
};
use crate::v1_rt;
...
pub fn stage0_workspace_member_region() -> String {
    match (*crate::v1_compiler_stage0_crates::stage0_crate_plan_outcome()).clone() {
        ...
        Stage0CratePlanOutcome::Stage0CratePlanIdentRefused { cause: cause, .. } => v1_rt::concat(
            "    # REFUSED: ".to_string(),
            crate::v1_compiler_stage0_crates::stage0_crate_boundary_emit_refusal_message(Rc::new(
                Stage0CrateBoundaryEmitRefusalCause::Stage0CrateBoundaryEmitPackageIdentRefused {
                    cause: cause.clone(),
                },
            )),
        ),
