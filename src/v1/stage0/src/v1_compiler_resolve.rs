...
) -> Arc<ModuleOccurrenceInput> {
    Arc::new(ModuleOccurrenceInput {
        module: module.clone(),
        occurrence_transport: occurrence_transport.clone(),
    })
}

pub fn module_occurrence_input_node(input: Arc<ModuleOccurrenceInput>) -> Arc<Node> {
    input.module.clone()
}

pub fn module_occurrence_input_transport(
    input: Arc<ModuleOccurrenceInput>,
