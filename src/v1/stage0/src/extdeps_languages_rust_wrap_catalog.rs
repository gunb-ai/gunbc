...
pub fn rust_sg_rc_wrap_catalog_note() -> String {
    thread_local! {
        static CACHED: String = {
            "Single authority for rust_sg_rc_use_site_ownership_catalog rows (v1 seed emitter + v2.extdeps.languages.rust). Carrier is a closed enum (not a string tag); NonEmptyDiagnostics aliases Diagnostics at the lookup boundary.".to_string()
        };
    }
