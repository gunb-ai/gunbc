...
pub fn parent_closure_callable_candidates(
    ...
    env.parents.clone().iter().cloned().fold(
        Rc::new(vec![]),
        |acc: Rc<Vec<Rc<CallableCandidate>>>, p: Rc<ResolvedFuncEnv>| match v1_rt::map_get(
            &p.local.clone(),
            name.clone(),
        ) {
...
pub fn topo_resolve_loop(
    ...
    loop {
        ...
        #[allow(unused_mut)]
        let mut resolved = __tco_loop_resolved;
        #[allow(unused_mut)]
        let mut declared_sigs = __tco_loop_declared_sigs;
        #[allow(unused_mut)]
        let mut call_edges = __tco_loop_call_edges;
        #[allow(unused_mut)]
        let mut local_func_set = __tco_loop_local_func_set;
        #[allow(unused_mut)]
        let mut module_name = __tco_loop_module_name;
        #[allow(unused_mut)]
        let mut diagnostics = __tco_loop_diagnostics;
        #[allow(unused_mut)]
        let mut parent_envs = __tco_loop_parent_envs;
        #[allow(unused_mut)]
