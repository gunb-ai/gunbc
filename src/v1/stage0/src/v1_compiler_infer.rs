...
pub fn lookup_variant_parent_enum(scope: Rc<InferScope>, name: String) -> String {
...
pub fn record_lit_expected_fields(type_name: String, scope: Rc<InferScope>) -> Rc<Vec<Rc<Node>>> {
    match type_name {
...
pub fn method_name_is(opt: String, expected: String) -> bool {
    if (opt.clone() == None) {
        false
    } else {
