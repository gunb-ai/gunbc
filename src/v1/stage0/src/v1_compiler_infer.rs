...
let arm_ctx = match variant_arm_ctx.clone() {
    ...
    MatchPattern::Bind { declaration: bdecl, .. } => Rc::new(DescentContext {
    fn_name: c.fn_name.clone(),
    param_names: v1_rt::rc_map_insert(c.param_names.clone(), authored_name_at(c.type_env.clone().source_indices.clone(), bdecl.clone()), ind_field.element_type.clone()),
    param_order: c.param_order.clone(),
    type_env: c.type_env.clone(),
    sub_value_vars: v1_rt::rc_map_insert(c.sub_value_vars.clone(), authored_name_at(c.type_env.clone().source_indices.clone(), bdecl.clone()), Rc::new(SubValueRelation::StrictSubValue {
    field: ind_field.clone(),
    factor: Rc::new(ShrinkFactor::UnitShrink),
})),
...
let inner_bind_name = match (*field_binding_pattern(inner_fb.clone())).clone() {
    MatchPattern::Bind { declaration: ibdecl, .. } => authored_name_at(ic.type_env.clone().source_indices.clone(), ibdecl.clone()),
    _ => "".to_string(),
};
...
let bind_name = match (*field_binding_pattern(fb.clone())).clone() {
    MatchPattern::Bind { declaration: bdecl, .. } => authored_name_at(c.type_env.clone().source_indices.clone(), bdecl.clone()),
    _ => "".to_string(),
};
...
match matching.clone() {
    ...
    MatchPattern::Bind { declaration: bdecl, .. } => if (scrut_type.clone() != "".to_string()) {
                        Rc::new(DescentContext {
    fn_name: ctx.fn_name.clone(),
    param_names: v1_rt::rc_map_insert(ctx.param_names.clone(), authored_name_at(ctx.type_env.clone().source_indices.clone(), bdecl.clone()), scrut_type.clone()),
    param_order: ctx.param_order.clone(),
    type_env: ctx.type_env.clone(),
    sub_value_vars: v1_rt::rc_map_insert(ctx.sub_value_vars.clone(), authored_name_at(ctx.type_env.clone().source_indices.clone(), bdecl.clone()), Rc::new(SubValueRelation::PreservedValue)),
    size_aliases: ctx.size_aliases.clone(),
    scope_locals: ctx.scope_locals.clone(),
    func_env: ctx.func_env.clone(),
    per_field_vars: ctx.per_field_vars.clone(),
    ...
    fn_name: ctx.fn_name.clone(),
    param_names: v1_rt::rc_map_insert(ctx.param_names.clone(), authored_name_at(ctx.type_env.clone().source_indices.clone(), bdecl.clone()), ind_field.element_type.clone()),
    param_order: ctx.param_order.clone(),
    type_env: ctx.type_env.clone(),
    sub_value_vars: v1_rt::rc_map_insert(ctx.sub_value_vars.clone(), authored_name_at(ctx.type_env.clone().source_indices.clone(), bdecl.clone()), Rc::new(SubValueRelation::StrictSubValue {
    field: ind_field.clone(),
    factor: Rc::new(ShrinkFactor::UnitShrink),
})),
    size_aliases: ctx.size_aliases.clone(),
...
let bind_name = match (*field_binding_pattern(binding.clone())).clone() {
    MatchPattern::Bind { declaration: bdecl, .. } => authored_name_at(type_env.source_indices.clone(), bdecl.clone()),
    _ => "".to_string(),
};
...
v1_rt::rc_map_insert(acc.clone(), bind_name.clone(), field_prov.clone())
    ...
    MatchPattern::Bind { declaration: bdecl, .. } => v1_rt::rc_map_insert(let_prov.clone(), authored_name_at(type_env.source_indices.clone(), bdecl.clone()), scrut_prov.clone()),
    _ => let_prov.clone(),
};
                    ...
                    |c: Rc<DescentContext>, fb: Rc<Node>| {
                        ...
                        let bind_name = match (*field_binding_pattern(fb.clone())).clone() {
                            MatchPattern::Bind {
                                ...
                                c.type_env.clone().source_indices.clone(),
                                bdecl.clone(),
                            ),
                            _ => "".to_string(),
                        };
