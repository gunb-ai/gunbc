...
pub fn find_global_variant_parent_enum(env: Rc<TypeEnv>, arm_name: String) -> Option<String> {
    {
        let parents = Rc::new(v1_rt::map_keys(&env.global_bare.clone()))
            .iter()
            .cloned()
            .fold(
                Rc::new(vec![]),
                |acc: _, census_key: String| match v1_rt::map_get(
        ...
        .cloned()
    {
        ...
        Some(GlobalBareLookupState::GlobalBareUniqueBinding {
            ...
            if existing.resolved.clone() == binding.resolved.clone() {
                ...
                let existing_owner = v1_rt::map_get(&owners, binding.name.clone()).unwrap_or_default();
