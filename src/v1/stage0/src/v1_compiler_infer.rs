...
// MIRROR of the .dag authority, NOT a regen fixpoint. One of three class-3
// files (with v1_compiler_emit_rust.rs, v1_compiler_infer_emit_info.rs) spliced
// from a faithful regen of the class-3 .dag onto the committed seed.
