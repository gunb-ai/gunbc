...
///
/// FIFTH TRANSITION, SAME RULE (2026-09-03, gunbc#10170). The five canonical add-tree fixture
/// values moved from the full `v2.extdeps.languages.dag` model into the focused
/// `v2.extdeps.languages.dag_add_fixture` authority, so fixture-only consumers stop resolving the
/// unrelated grammar closure. The declarations were removed at their old home, every consumer
/// imports the new one, and the ten changed bindings below are the complete identity-grain
/// population reported by namespace-wave-admission. The five new membership edges are
/// `ExplicitlyEvaluatedZeroDelta` and auto-admit; no row is authored for them.
///
/// DISSOLVE-ON: #10170 merging. Base and head will then both carry the relocation, so these rows
/// become consumed and must be removed by the next roster-touching change.
const DAG_ADD_FIXTURE_RELOCATION_LABEL: &str = "DAG add fixture relocation gunbc#10170 2026-09-03";

pub const NAMESPACE_TRANSITION_ADMISSIONS: &[TransitionAdmission] = &[
    TransitionAdmission {
        label: DAG_ADD_FIXTURE_RELOCATION_LABEL,
        subject: AdmissionSubject::Binding {
            module: "v2.test.complexity_gate.table_fixture_add_subject_producer",
            in_declaration: "table_fixture_add_arrow_with_body",
            spelling: "dag_add_arrow_with_body_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
    ...
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            module: "v2.test.complexity_gate.table_fixture_add_subject_producer",
            in_declaration: "table_fixture_add_arrow_with_body_swapped_operands",
            spelling: "dag_add_arrow_with_body_swapped_operands_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            ...
            in_declaration: "add_body_ts_canonical_grounding_for",
            spelling: "dag_add_arrow_signature_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    ...
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            module: "v2.test.manual.add_body_emit_typescript",
            in_declaration: "add_body_ts_canonical_grounding_for",
            spelling: "dag_add_binary_body_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            module: "v2.test.manual.add_body_emit_typescript",
            in_declaration: "add_body_ts_canonical_grounding_for",
            spelling: "dag_add_binary_body_swapped_operands_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            ...
            in_declaration: "add_body_operand_order_differs",
            spelling: "dag_add_binary_body_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            ...
            in_declaration: "body_lowering_fixture_resolves",
            spelling: "dag_add_arrow_with_body_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            module: "v2.test.manual.body_lowering_normalize_add",
            in_declaration: "body_lowering_normalized_matches_fixture_operands",
            spelling: "dag_add_arrow_with_body_fixture",
            target: "v2.extdeps.languages.dag_add_fixture",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
