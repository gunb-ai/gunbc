...
/// go when their transition is present at base. gunbc#11214's fifteen relocation rows went on that
/// trigger, reported CONSUMED by the floor on gunbc#10729. The #11182 relocation rows that an
