...
/// rows below. The paragraph is left standing as the record of that sweep; the roster's CURRENT
/// state is the five open rows, and their DISSOLVE-ON is gunbc#10011 merging.
///
