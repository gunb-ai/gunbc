...
///
/// THIRTY-SIXTH DISSOLUTION (2026-09-12, gunbc#11144). #11137 merged in
/// 34d2a8db32d, so both sides of the required run already carry its named Filesystem import.
/// Run 34680131682 compared base 0c93af0d087 with merge head 2d8af9ce4a2 and reported
/// the sha256sum row as STALE ADMISSION: it matched no delta (not CONSUMED, whose
/// singleton-binding proof did not hold). All 13 actual deltas were adjudicated;
/// this unmatched permission was the sole blocker after 3810/3810 floor claims ran.
/// Its declared trigger was #11137 merging, which has fired. Delete the row and its
/// transition rationale; empty is the resting state, not permission for an unadjudicated delta.
