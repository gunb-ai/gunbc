...
/// rows after this deletion.
///
/// A consumed row's deletion comes due on this roster's OWN next touch. #11156's two rows
/// (`ubuntu_seeded_install_media_remaster` TargetChanged and `srv3_boot_once_cd`
/// AuthoredReferenceResolution) were already satisfied at the base; this roster touch deletes
/// them. The array carries only gunbc#11056's eighteen BuildPathTreatment TargetChanged rows.
pub const NAMESPACE_TRANSITION_ADMISSIONS: &[TransitionAdmission] = &[
    ...
    // the same type. Eighteen TargetChanged bindings: five in ancestry (NativeGeneration plus
    // the four arms of build_path_admission) and thirteen in
    // v2.test.claim.self_host.ancestry_witness. The three ExplicitlyEvaluatedZeroDelta membership
    // rows the same floor reported are auto-admitted and are not rostered here.
    //
    // TRIGGER / dissolve-on: these rows go when this PR (gunbc#11056) merges. The base then
    // binds each spelling to v2.compiler.self_host.generation, the deltas stop being
    // producible, and CONSUMED comes due on the roster's next touch. Adjudicate that deletion
    // by joining each row against main on its (module, in_declaration, spelling, target)
    // tuple, not by trusting this sentence.
    TransitionAdmission {
        label: "gunbc#11056 ancestry NativeGeneration binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.compiler.self_host.ancestry",
            in_declaration: "NativeGeneration",
            spelling: "BuildPathTreatment",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "gunbc#11056 ancestry build_path_admission binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.compiler.self_host.ancestry",
            in_declaration: "build_path_admission",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "gunbc#11056 ancestry build_path_admission binds BuildPathRemapped at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.compiler.self_host.ancestry",
            in_declaration: "build_path_admission",
            spelling: "BuildPathRemapped",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "gunbc#11056 ancestry build_path_admission binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.compiler.self_host.ancestry",
            in_declaration: "build_path_admission",
            spelling: "BuildPathTreatment",
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry build_path_admission binds BuildPathUnresolved at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.compiler.self_host.ancestry",
            in_declaration: "build_path_admission",
            spelling: "BuildPathUnresolved",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness a_genesis_numbered_other_than_zero_is_refused binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "a_genesis_numbered_other_than_zero_is_refused",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_generation binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_generation",
            spelling: "BuildPathTreatment",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_genesis binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_genesis",
            spelling: "BuildPathTreatment",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_good_genesis binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_good_genesis",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_remap binds BuildPathRemapped at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_remap",
            spelling: "BuildPathRemapped",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_remap binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_remap",
            spelling: "BuildPathTreatment",
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_successor binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_successor",
            spelling: "BuildPathTreatment",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness anc_successor_ran binds BuildPathTreatment at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "anc_successor_ran",
            spelling: "BuildPathTreatment",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness build_path_treatment_discriminates_genesis_from_recurrence binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "build_path_treatment_discriminates_genesis_from_recurrence",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness build_path_treatment_discriminates_genesis_from_recurrence binds BuildPathUnresolved at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "build_path_treatment_discriminates_genesis_from_recurrence",
            spelling: "BuildPathUnresolved",
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness genesis_whose_closure_omits_the_seed_is_refused binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "genesis_whose_closure_omits_the_seed_is_refused",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness joining_an_ancestor_that_was_never_built_is_refused_by_name binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "joining_an_ancestor_that_was_never_built_is_refused_by_name",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    ...
    TransitionAdmission {
        label: "gunbc#11056 ancestry_witness successor_joins_its_ancestor_by_artifact_identity binds BuildPathPinned at generation",
        subject: AdmissionSubject::Binding {
            module: "v2.test.claim.self_host.ancestry_witness",
            in_declaration: "successor_joins_its_ancestor_by_artifact_identity",
            spelling: "BuildPathPinned",
            expected_candidates: &["v2.compiler.self_host.generation"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
