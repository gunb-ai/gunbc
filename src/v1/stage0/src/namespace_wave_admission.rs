...
///
/// THE gunbc#10729 ROWS DISSOLVED HERE (2026-09-15, gunbc#11418), by the same trigger the block
/// above applied to #11373's: #10729 landed as `c48dc494db`, so its SCM re-home cohort is present
/// at this merge's base, every row of it reports consumed by its own merge, and CONSUMED comes due
/// on the roster's next touch. This merge is that touch. The two label consts go with the rows
/// they labelled.
///
...
///
/// DISSOLVE-ON: gunbc#11418 merging. Once the relocation is on main, base and head of every
/// pull_request build both carry it, all six report consumed and refuse every unrelated roster
/// touch -- the shape every shrink above records. Remove them by that trigger, not by
/// reinterpreting it.
const DECLARED_UNIT_DIGEST_HOME_LABEL: &str =
    "gunbc#11418 DeclaredUnitDigestStanding moves to pair_serving_realization";
...
pub const NAMESPACE_TRANSITION_ADMISSIONS: &[TransitionAdmission] = &[
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            ...
            in_declaration: "spark_serving_route_standing",
    ...
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            ...
            in_declaration: "a_declared_digest_in_another_family_is_incomparable_and_refuses",
    ...
    TransitionAdmission {
        ...
        subject: AdmissionSubject::Binding {
            module: "test.claim.spark.spark_serving_offer_route_witness_test",
            in_declaration: "t_unit_unavailable",
            spelling: "DeclaredUnitDigestStanding",
            expected_candidates: &["gunbc.spark.pair_serving_realization"],
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
