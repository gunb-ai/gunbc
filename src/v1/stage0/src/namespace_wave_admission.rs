...
///
/// THIS ROSTER NOW CARRIES TWO INDEPENDENT RELOCATIONS, and the paragraph above describes only
/// the first of them. gunbc#11071's rows came from main; the v2-native route's rows are this
/// PR's. They dissolve on different merges and are adjudicated by exact identity either way, so
/// neither narrative covers the other's rows.
