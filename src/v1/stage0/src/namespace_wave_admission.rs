...
/// runner hardware observation, DGX PXE and PXE-rescue consumers.
///
/// THE gunbc#11306 ROWS DISSOLVED HERE (2026-09-15), BY THE TRIGGER THAT BLOCK WROTE. Main carries
/// `9f5e4988c5` ("Derive the private-material ignore rows from repository visibility (#11306)"),
/// so `RepositoryVisibility` / `PublicRepository` / `PrivateRepository` already bind at
/// `extdeps.github.repository`. This roster touch deletes those six consumed rows rather than
