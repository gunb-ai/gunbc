...
///
/// DISSOLVE-ON: this stack merging. Base and head then both carry the relocations, all 56 report
/// stale, and they are removed by that trigger as every shrink above was — a stale row here
/// refuses every unrelated PR.
