...
///
/// Other branches in flight pay the same debt on their own heads; the deletion is owed once, so a
/// delete-versus-delete conflict resolves by keeping the deletion.
