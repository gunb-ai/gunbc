...
/// machine-intake ruling makes the boot-artifact-delivery solver the one authority and the
/// legacy install mechanism a frozen projection of it, so the standings live with the solver
/// that consumes them and the projection imports them. Every spelling that bound to the old
/// declarer now binds to the new one: 31 `TargetChanged` rows, each naming the exact module,
/// enclosing declaration and leaf, blast radius 0 on every one, transcribed from the required
/// run's own list on 2e55a403c7. These rows go STALE the moment #9690 merges and are removed
/// by that trigger, exactly as the shrinks above were.
pub const NAMESPACE_TRANSITION_ADMISSIONS: &[TransitionAdmission] = &[
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-01",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "fleet_firmware_transition_standing",
            spelling: "firmware_transition_requirements_all",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-02",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "fleet_firmware_transition_standing",
            spelling: "FirmwareTransitionStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-03",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "fleet_firmware_transition_standing",
            spelling: "FirmwareTransitionUnestablished",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-04",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "solve_delivery_from_capability_row",
            spelling: "FirmwareTransitionStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-05",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "solve_delivery_from_capability_row",
            spelling: "NetworkBootDeliveryStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-06",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "solve_install_mechanism_from_evidence",
            spelling: "FirmwareTransitionStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-07",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "solve_install_mechanism_from_evidence",
            spelling: "NetworkBootDeliveryStanding",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-08",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv1_network_boot_standing",
            spelling: "NetworkBootDeliveryStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-09",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv1_network_boot_standing",
            spelling: "NetworkBootDeliveryUnestablished",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-10",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv1_network_boot_standing",
            spelling: "network_boot_requirements_all",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-11",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv2_network_boot_standing",
            spelling: "NetworkBootDeliveryStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-12",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv2_network_boot_standing",
            spelling: "NetworkBootDeliveryUnestablished",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-13",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv2_network_boot_standing",
            spelling: "network_boot_requirements_all",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-14",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv3_network_boot_standing",
            spelling: "NetworkBootDeliveryStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-15",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv3_network_boot_standing",
            spelling: "NetworkBootDeliveryUnestablished",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-16",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv3_network_boot_standing",
            spelling: "network_boot_requirements_all",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-17",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv4_network_boot_standing",
            spelling: "NetworkBootDeliveryStanding",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-18",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv4_network_boot_standing",
            spelling: "NetworkBootDeliveryUnestablished",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-19",
        subject: AdmissionSubject::Binding {
            module: "gunbc.os_install_mechanism",
            in_declaration: "srv4_network_boot_standing",
            spelling: "network_boot_requirements_all",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-20",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "control_network_boot_axis",
            spelling: "NetworkBootRequirement",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-21",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "control_network_boot_axis",
            spelling: "NetworkBootRequirementEvidence",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-22",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_firmware_transition_for_control",
            spelling: "FirmwareTransitionEstablished",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-23",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_firmware_transition_for_control",
            spelling: "FirmwareTransitionStanding",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-24",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootBootArtifacts",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-25",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootBootSourceOverride",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-26",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootClientBootMode",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-27",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootDeliveryEstablished",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-28",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootDeliveryEstablishment",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-29",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootDeliveryStanding",
    ...
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-30",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration: "established_network_boot_for_control",
            spelling: "NetworkBootServingInfrastructure",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
    TransitionAdmission {
        label: "boot-delivery-standing-relocation-31",
        subject: AdmissionSubject::Binding {
            module: "test.claim.bmc_firmware_evidence_install_mechanism",
            in_declaration:
                "no_virtual_media_without_declared_network_boot_refuses_instead_of_inferring_pxe",
            spelling: "NetworkBootDeliveryUnestablished",
        },
        disposition: NamespaceDeltaDisposition::TargetChanged,
    },
