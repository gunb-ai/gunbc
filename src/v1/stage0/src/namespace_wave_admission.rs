...
///
/// THE ROSTER HOLDS gunbc#11214's and gunbc#10729's rows; empty is its resting state, and each
/// row goes when its transition is present at base. The #11182 relocation rows that an
