...
pub fn render_node_type_shared_wrap(target: RenderTarget, shared: bool, base: String) -> String {
    match target.clone() {
        RenderTarget::Rust => base,
        _ => {
            if shared.clone() {
        ...
        if is_disj.clone() {
            {
                ...
                let disj_str =
                    render_node_type_shared_wrap(target.clone(), shared.clone(), base.clone());
                return disj_str;
            }
        }
        if is_conj.clone() {
                ...
                if (n.ident_span.clone() != None) {
                    {
                        ...
                        if has_template.clone() {
                            {
                                ...
                                let conj_container_str = render_node_type_shared_wrap(
                                    target.clone(),
                                    shared.clone(),
                                    base.clone(),
                                );
                        ...
                        let conj_named_str = render_node_type_shared_wrap(
                            target.clone(),
                            shared.clone(),
                            base.clone(),
                        );
