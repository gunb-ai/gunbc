...
pub fn empty_emit_scope() -> Rc<InferScope> {
    Rc::new(InferScope {
        type_env: Rc::new(TypeEnv {
            ...
            recursive_type_set: panic!(
                "call target identity was not established before Rust emission"
            )(),
            inductive_fields: panic!(
                "call target identity was not established before Rust emission"
            )(),
        ...
        func_env: Rc::new(ResolvedFuncEnv {
            name: "".to_string(),
            local: panic!("call target identity was not established before Rust emission")(),
            parents: Rc::new(vec![]),
        }),
        locals: panic!("call target identity was not established before Rust emission")(),
        body_locals: panic!("call target identity was not established before Rust emission")(),
        match_bound_names: panic!("call target identity was not established before Rust emission")(
        ),
        module_name: "".to_string(),
        service_registry: panic!("call target identity was not established before Rust emission")(),
        item_registry: panic!("call target identity was not established before Rust emission")(),
        lambda_param_provenance: panic!(
            "call target identity was not established before Rust emission"
        )(),
