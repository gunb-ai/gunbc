...
use crate::std_coercion::TypeDeclarationProvenance::{CorpusDeclared, DeclarationIdentityAbsent};
pub use crate::v1_compiler_artifact::RenderTarget;
use crate::v1_compiler_artifact::RenderTarget::Rust;
pub use crate::v1_compiler_coercion::{literal_suffix, type_realization_decision};
    ...
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "dag/std/integer.dag".to_string(),
            }),
        ),
    )
    .as_deref()
...
pub fn table_absent_name_realizes_natively_for_the_std_declaration() -> bool {
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            "Nat".to_string(),
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "dag/std/nat.dag".to_string(),
            }),
        ),
    )
    .as_deref()
...
pub fn same_spelling_different_declaration_does_not_realize_natively() -> bool {
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            "Nat".to_string(),
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "src/v2/std/nat.dag".to_string(),
            }),
        ),
...
pub fn residue_table_present_int_bypasses_identity() -> bool {
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            "Int".to_string(),
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "src/v2/std/integer.dag".to_string(),
            }),
        ),
    )
    .as_deref()
...
pub fn table_present_hash_refuses_under_structural_declaration() -> bool {
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            "Hash".to_string(),
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "src/v2/std/node.dag".to_string(),
            }),
        ),
    ) == std::option::Option::None)
}
...
pub fn table_present_bool_refuses_under_structural_declaration_logic() -> bool {
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            "Bool".to_string(),
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "src/v2/std/logic.dag".to_string(),
            }),
        ),
    ) == std::option::Option::None)
}
...
pub fn table_present_bool_renders_natively_for_the_corpus_prelude() -> bool {
    (crate::v1_compiler_emit_rust::rust_scalar_checkpoint_reference_base(
        crate::v1_compiler_coercion::type_realization_decision(
            ...
            "Bool".to_string(),
            Rc::new(TypeDeclarationProvenance::CorpusDeclared {
                decl_file: "dag/std/types.dag".to_string(),
            }),
        ),
    )
    .as_deref()
