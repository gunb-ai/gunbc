...
pub fn table_present_bool_refuses_under_structural_declaration_types() -> bool {
...
pub fn literal_suffix_positive_control_symbol_not_enrolled() -> bool {
    (literal_suffix(Rust, "Symbol".to_string(), "".to_string()).as_deref()
...
pub fn literal_suffix_production_call_site_never_threads_declaration_identity() -> bool {
    (literal_suffix(Rust, "String".to_string(), "".to_string()).as_deref()
        == Some(".to_string()".to_string()).as_deref())
}
