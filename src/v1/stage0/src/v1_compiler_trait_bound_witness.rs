...
pub fn trait_bound_witness_import_note() -> std::string::String {
    thread_local! {
...
pub fn v1_call_forwarding_clone_bound_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
...
pub fn v1_call_forwarding_compound_type_arg_note() -> std::string::String {
    thread_local! {
        static CACHED: std::string::String = {
