...
// uniformly to zero:
//   (a) un-migrated modeling — e.g. the yaml `*_to_doc`/`*_element_doc` projectors, the
//       `eval_*_node*` Node-interpreter handlers,
...
const NON_FOLD_RESIDUE_ROSTER: &[&str] = &[
    ...
    "dsl/extdeps/formats/yaml.dag::block_sequence_element_doc",
    "dsl/extdeps/formats/yaml.dag::project_yaml_to_doc",
    ...
    "src/v2/compiler/manual/eval_runtime_mvp.dag::eval_mvp2_arg_is_two_literal",
