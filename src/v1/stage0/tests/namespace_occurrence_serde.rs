...
#[test]
fn list_slice_parser_does_not_reuse_authored_identity() {
    let parsed = parse_source(
...
#[test]
fn weather_example_parser_does_not_reuse_authored_identity() {
    let parsed = parse_source(
        include_str!("../../../../dag/examples/weather/weather.dag"),
