...
//! `src/v2/test/claim/manual/typescript_effect_io_emit.dag` to obtain the COMPILER-EMITTED
...
const WITNESS_ENTRY: &str = "src/v2/test/claim/manual/typescript_effect_io_emit.dag";
