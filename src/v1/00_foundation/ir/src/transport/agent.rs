...
//!
//! These types define the provider-neutral interface between the issue workflow's
...
///
/// Assembled by the workflow pipeline from the intake ledger, artifact ledger, and
