//! Generic workflow engine: planner, executor, coordination, SLO.
//!
//! This crate provides workflow planning, execution, and coordination logic
//! that is independent of any specific repository's DSL catalog or commands.
