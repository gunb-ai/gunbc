...
impl ClippyConfig {
    ...
    ///
    /// This is the repo-specific extension point: gunbc-codegen can supply a
...
const DEFAULT_REGENERATE_CMD: &str = "edit clippy.toml directly";
...
mod tests {
    ...
    fn test_render_implementation() {
        ...
        assert!(output.contains("edit clippy.toml directly"));
