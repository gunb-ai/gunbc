...
fn complexity_source_and_stage0_stay_in_parity_on_classifier_hooks() {
    ...
    for needle in [
        ...
        "type ParserBoundResult {",
        "type ParserResultErrStatus",
        "bound_results: Map<String, ParserBoundResult>",
        "fn parser_err_status_for_expr(",
        "fn parser_then_err_statuses(",
        "fn parser_else_err_statuses(",
        "fn parser_bound_result_success_summary(",
        "fn parser_call_input_progress(",
        "fn parser_bound_result_state_progress(",
        "fn parser_member_is_always_advancing(",
        "fn infer_parser_always_advancing_members_worklist(",
        "fn build_parser_result_call_graph(",
        "fn same_progress_cycle_members(",
    ...
    for needle in [
        ...
        "pub fn parser_err_status_for_expr(",
        "pub fn parser_then_err_statuses(",
        "pub fn parser_else_err_statuses(",
        "pub fn parser_bound_result_success_summary(",
        "pub fn parser_call_input_progress(",
        ...
        "pub fn build_parser_result_call_graph(",
        "pub fn same_progress_cycle_members(",
...
fn parser_progress_witness_hooks_live_in_parse_layer() {
    ...
    for needle in [
        ...
        "fn parser_error_result_var(",
        "fn parser_has_err_result_var(",
    ...
    for needle in [
        ...
        "pub fn parser_error_result_var(",
        "pub fn parser_has_err_result_var(",
