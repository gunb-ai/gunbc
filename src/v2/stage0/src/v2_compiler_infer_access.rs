...
pub use crate::std_types::{is_ordered_element_collection, SourceSpan};
...
) -> Rc<AccessCheckResultNode> {
    {
        ...
        if base_is_string {
            ...
            match keyed_collection_parts(&normed, source_indices.clone()) {
                ...
                None => {
                    if node_is_keyed_collection(&normed, source_indices.clone()) {
                        {
                        ...
                        if ((is_ordered_element_collection(authored_name_at(
                            source_indices.clone(),
                            &normed,
                        )) && node_is_element_collection(&normed, source_indices.clone()))
                            && index_is_int)
                        {
                            {
