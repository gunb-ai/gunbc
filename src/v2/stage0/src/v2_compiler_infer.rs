...
match bare_m {
    ...
    diagnostics: arg_diags,
                                        ...
                                        {
                                            let empty_set_diags = v2_rt::concat(arg_diags, Rc::new(vec![inference_error("empty_set expected type is not a Set collection".to_string(), span.clone(), scope.module_name.clone())]));
match bare_s {
