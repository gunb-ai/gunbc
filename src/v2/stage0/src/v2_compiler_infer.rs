...
pub fn optional_inner_type_compatible(expected: Rc<Node>, got: Rc<Node>, source_indices: Rc<HashMap<String, Rc<NewlineIndex>>>) -> bool {
    {
...
pub fn record_field_value_compatible(expected: &Rc<Node>, got: &Rc<Node>, source_indices: &Rc<HashMap<String, Rc<NewlineIndex>>>) -> bool {
    (node_type_compatible(expected.clone(), got.clone(), source_indices.clone()) || ((expected.return_cardinality.clone() == Cardinality::CardOptional) && optional_inner_type_compatible(expected.clone(), got.clone(), source_indices.clone())))
}
...
if record_field_value_compatible(&expected_node, &got_node, &scope.type_env.clone().source_indices.clone()) {
                    Rc::new(vec![])
                } else {
