...
pub use crate::v2_compiler_ownership::{
...
pub fn resolve_wire_serde_policy_from_encoding_node(
    ...
    {
        let encoding_name = authored_name_at(source_indices.clone(), &ve);
        if (encoding_name.clone().as_str() == "InternallyTaggedObject".to_string().as_str()) {
            rust_internal_policy_for_encoding(&ve, &source_indices)
        } else {
...
pub fn is_coproduct_wire_contract_row(
    ...
    if !is_data_def_item(&item) {
        ...
        if module_defines_local_coproduct_wire_contract_type(module_items, source_indices.clone()) {
            ...
            if !data_item_type_is_coproduct_wire_contract(item.clone(), imports, &source_indices) {
                false
            } else {
            ...
            match record_string_field(body.clone(), "coproduct".to_string(), source_indices) {
                Some(target_name) => {
                    if {
                        ...
                        emit_rust_compile_error_item(v2_rt::concat(
...
) -> Option<Rc<RustEnumWireSerde>> {
    {
        ...
        if ((contracts.clone().len() as i64) == 0) {
            ...
            if ((contracts.clone().len() as i64) == 1) {
                ...
                Some(rust_serde_error_policy(v2_rt::concat(
        ...
        |acc: Rc<HashMap<String, Rc<Node>>>, tm: Rc<TypedModule>| {
            ...
            .fold(
                ...
                |item_acc: Rc<HashMap<String, Rc<Node>>>, item: Rc<Node>| {
                    ...
                    v2_rt::rc_map_insert(item_acc, qualified_name.clone(), item.clone())
                },
            )
        },
    )
...
pub fn insert_scoped_data_item(
    ...
    {
        let existing = match v2_rt::map_get(&scoped, name.clone()) {
        ...
        v2_rt::rc_map_insert(
            scoped.clone(),
            name.clone(),
            v2_rt::concat(existing, Rc::new(vec![item])),
        )
    }
}
        ...
        .fold(
            ...
            |acc: Rc<HashMap<String, Rc<Vec<Rc<Node>>>>>, item: Rc<Node>| {
                insert_scoped_data_item(
                    &acc,
                    &authored_name_at(typed_module.type_env.clone().source_indices.clone(), &item),
                    item.clone(),
                )
            },
        );
                            ...
                            |inner: Rc<HashMap<String, Rc<Vec<Rc<Node>>>>>,
                             imported_name: String| {
                                let qualified = v2_rt::concat(
                                    v2_rt::concat(import_path.clone(), ".".to_string()),
                                    imported_name.clone(),
                                );
                                match v2_rt::map_get(&data_items, qualified.clone()) {
...
pub fn rust_test_file_path(module_name: String) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(file_dir, conventions.file_prefix.clone()),
                    filename,
                ),
        ...
        match (*summary.repr.clone()).clone() {
            ...
            TypeRepr::StructRepr => {
                if ((is_recursive || has_generics) || summary.has_fn_fields.clone()) {
                    ...
                    {
                        let field_count =
                            (Rc::new(v2_rt::map_keys(&summary.field_summaries.clone())).len()
                                as i64);
                        let ft_count = (Rc::new(v2_rt::map_keys(&summary.field_type_map.clone()))
                            .len() as i64);
                        if (ft_count < field_count) {
                        ...
                        } else {
                            {
                                let mut __all = true;
                                for tn in
                                    Rc::new(v2_rt::map_values(&summary.field_type_map.clone()))
                                        .iter()
                                        .cloned()
                                {
...
pub fn maybe_mark_shared_type(
...
) -> Rc<std::collections::BTreeSet<String>> {
    {
        ...
        if (needs_sharing && !is_type_constant(&summary, recursive_type_set)) {
            v2_rt::rc_set_insert(acc, summary.name.clone())
        } else {
            acc
        }
    }
...
pub fn build_shared_types(
...
) -> Rc<std::collections::BTreeSet<String>> {
    {
        ...
        let user_shared = Rc::new(v2_rt::map_values(&type_summaries))
            .iter()
            .cloned()
            .fold(
        ...
        let collection_keys = Rc::new({
            let mut __result = Vec::new();
            for k in Rc::new(v2_rt::map_keys(&rust_container_templates()))
                .iter()
                .cloned()
            {
        ...
        collection_keys.iter().cloned().fold(
            ...
            |acc: Rc<std::collections::BTreeSet<String>>, key: String| {
                ...
                v2_rt::rc_set_insert(acc, pascal.clone())
            },
        )
    }
}
    ...
    param_names: pnames.clone(),
        ...
        proofs.iter().cloned().fold(
            Rc::new(OwnershipBuildResult {
                ownership_index: v2_rt::rc_empty_map::<
                    String,
                    Rc<std::collections::BTreeSet<String>>,
                >(),
            ...
            |acc: Rc<OwnershipBuildResult>, entry: Rc<OwnershipProofEntry>| {
                let acc = Rc::try_unwrap(acc).unwrap_or_else(|rc| (*rc).clone());
                {
                    ...
                    Rc::new(OwnershipBuildResult {
                        ownership_index: v2_rt::rc_map_insert(
                            acc.ownership_index,
                            entry.name.clone(),
                            movable.clone(),
                        ),
                        read_only_params_index: v2_rt::rc_map_insert(
...
pub fn emit_rust(typed: &Rc<ResolvedGraph>) -> Rc<EmitResult> {
    {
            ...
            |acc: Rc<HashMap<String, String>>, tm: Rc<TypedModule>| {
                ...
                svc_items.clone().iter().cloned().fold(
                    ...
                    |a: Rc<HashMap<String, String>>, svc: Rc<Node>| {
                        v2_rt::rc_map_insert(
                            a,
                            authored_name_at(tm.type_env.clone().source_indices.clone(), &svc),
                            mod_filename.clone(),
                        )
                    },
                )
        ...
        let all_mod_files = v2_rt::concat(
            v2_rt::concat(module_files, Rc::new(vec![rt_file])),
            dry_run_file,
        );
...
pub fn emit_v2_rt_module() -> Rc<TextFile> {
    Rc::new(TextFile {
        path: v2_rt::concat(
            v2_rt::concat(rust_source_root(), "v2_rt".to_string()),
            rust_source_ext(),
        ),
...
pub fn emit_compiler_tests_module() -> Rc<TextFile> {
    Rc::new(TextFile {
        path: v2_rt::concat(
            v2_rt::concat(rust_source_root(), "compiler_tests".to_string()),
            rust_source_ext(),
        ),
...
pub fn emit_lib_rs_from_files(
...
) -> Rc<TextFile> {
    {
        ...
        Rc::new(TextFile {
            path: v2_rt::concat(
                v2_rt::concat(rust_source_root(), "lib".to_string()),
                rust_source_ext(),
            ),
...
pub fn emit_module_full(
...
) -> Rc<TextFile> {
    {
        ...
        let scoped_data_items = build_scoped_data_item_index(&typed_module, data_items);
        ...
        let local_enum_uses = Rc::new({
            ...
            for item in Rc::new({
                let mut __result = Vec::new();
                for item in typed_module.items.clone().iter().cloned() {
                    if (is_type_def_item(&item) && is_coproduct_type(item.clone())) {
                        __result.push(item);
                    }
                }
                __result
        ...
        let content = v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat("// Generated by v2 compiler -- do not edit.\n".to_string(), "// Source module: ".to_string()), authored_name(scope.type_env.clone(), m.clone())), "\n\n".to_string()), module_attrs), prelude), imports_section), svc_imports_str), local_uses_str), "\n\n".to_string()), coproduct_wire_contract_validation_section), items_str), "\n".to_string());
        Rc::new(TextFile {
            path: v2_rt::concat(
                v2_rt::concat(rust_source_root(), filename),
                rust_source_ext(),
            ),
            content: content,
        })
                    ...
                    __result.push({
                        ...
                        if import_is_all(imp.clone()) {
                        ...
                        } else {
                            {
                                ...
                                let filtered_names = Rc::new({
                                    let mut __result = Vec::new();
                                    for n in specific_names.clone().iter().cloned() {
                                        if {
                                            let mut __all = true;
                                ...
                                if ((filtered_names.clone().len() as i64) == 0) {
                                ...
                                } else {
                                    {
                                        ...
                                        let all_enum_names = Rc::new({
                                            let mut __result = Vec::new();
                                            for n in Rc::new(v2_rt::map_keys(&type_summaries))
                                                .iter()
                                                .cloned()
                                            {
...
pub fn emit_typed_item(
...
) -> String {
    {
        ...
        let qualified_name = v2_rt::concat(
            v2_rt::concat(module_name, ".".to_string()),
            ...
            if is_type_alias_item(&item, env.source_indices.clone()) {
                ...
                if is_type_decl_item(&item, env.source_indices.clone()) {
                    ...
                    if is_function_item(&item) {
                        {
                            let fn_movable = match v2_rt::map_get(
        ...
        } else {
            {
                ...
                let validations = if (policy_validation.clone().as_str() == "".to_string().as_str())
                {
                    ...
                    if (rename_validations.clone().as_str() == "".to_string().as_str()) {
                        ...
                        v2_rt::concat(
                            v2_rt::concat(policy_validation.clone(), "\n".to_string()),
                            rename_validations.clone(),
                        )
                    }
                };
                ...
                if (validations.clone().as_str() == "".to_string().as_str()) {
                    ...
                    v2_rt::concat(
                        v2_rt::concat(validations.clone(), "\n".to_string()),
                        enum_text,
                    )
                }
            }
...
) -> String {
    {
        ...
        .cloned()
        {
            Some(prop) => match (*field_init_node_value(&prop).expr_data.clone()).clone() {
                ExprData::ExprLiteral { value: lv, .. } => match (*lv.clone()).clone() {
                    LiteralValue::LitStr { value: key, .. } => v2_rt::concat(
                        v2_rt::concat(
                            "    ".to_string(),
                        ...
                        for child in children.clone().iter().cloned() {
                            __result.push({
                                ...
                                if ((child.children.clone().len() as i64) == 0) {
                                    ...
                                    {
                                        let sharing =
                                            language_spec(RenderTarget::Rust).sharing.clone();
                                        v2_rt::concat(
                                            v2_rt::concat(
                                                v2_rt::concat(
                                                    v2_rt::concat(
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat("impl".to_string(), type_params.clone()),
                                " ".to_string(),
                            ),
                            name.clone(),
                        ),
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        ...
        match (*body.expr_data.clone()).clone() {
            ExprData::ExprLet => {
                ...
                match inner {
                    Some(bd) => v2_rt::concat(
                        v2_rt::concat(let_line, "\n".to_string()),
                        emit_func_body(
                            &bd,
                            &registry,
                            &next_scope,
                ...
                } else {
                    {
                        ...
                        let last_str = match last_stmt {
                            Some(s) => match (*s.expr_data.clone()).clone() {
                                ExprData::ExprReturn => v2_rt::concat(
                                    v2_rt::concat(
                                        "return Ok(".to_string(),
                                        emit_typed_expr(
...
pub fn emit_tco_params(
...
) -> String {
    {
        let strs = Rc::new({
            let mut __result = Vec::new();
            for p in params.iter().cloned() {
                __result.push(emit_tco_param(&p, shared_types.clone(), &source_indices));
            }
            __result
        });
        strs.join(&", ".to_string())
...
pub fn positional_payload_scrut_type(
...
) -> String {
    {
        ...
        match lookup_emit_type_summary(emit_info, type_key) {
            Some(summary) => match v2_rt::map_get(&summary.field_type_map.clone(), "0".to_string())
            {
                ...
                Some(fb) => {
                    ...
                    if is_string_lit_pattern(fb_pat.clone()) {
                    ...
                    } else {
                        {
                            ...
                            v2_rt::concat(
                                v2_rt::concat("Some(".to_string(), inner_pat),
                                ")".to_string(),
                            )
                        }
                    }
                ...
                if ((field_bindings.clone().len() as i64) == 0) {
                    {
                        ...
                        let is_positional = (v2_rt::set_contains(
                        ...
                        let is_fielded = (v2_rt::set_contains(
                        ...
                        if is_positional {
                            v2_rt::concat(qualified.clone(), "(_)".to_string())
                        } else {
                            if is_fielded {
                                v2_rt::concat(qualified.clone(), " { .. }".to_string())
                            } else {
                        ...
                        if ((effective_bindings.clone().len() as i64) == 0) {
                            {
                                ...
                                let is_positional2 = (v2_rt::set_contains(
                                    emit_info.positional_payload_variants.clone(),
                                    shape_key2.clone(),
                                ) || v2_rt::set_contains(
                                    emit_info.positional_payload_variants.clone(),
        ...
        } else {
            {
                ...
                match summary {
                    Some(field_summary) => match field_summary.access_style.clone() {
                        ...
                        FieldAccessStyle::OptionalUnwrap => v2_rt::concat(
                            apply_type_template1(sharing.clone_value.clone(), base_str),
                            ".unwrap()".to_string(),
                        ),
                        FieldAccessStyle::EnumAccessor => v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(base_str, ".".to_string()),
...
pub fn rust_empty_map_value_type_str(
    ...
    match map_type.children.clone().get(1 as usize).cloned() {
        Some(value_child) => {
            let rendered =
                render_rust_type(child_type_node(&value_child), shared_types, source_indices);
...
pub fn rust_empty_map_kv_type_str(
...
) -> String {
    {
        ...
        {
            v2_rt::concat(
                v2_rt::concat(key_str.clone(), ", ".to_string()),
                val_str.clone(),
            )
        } else {
            "".to_string()
...
pub fn rust_runtime_bridge_wraps_collection_result_in_rc(function_name: &String) -> bool {
    (v2_rt::map_contains_key(&rt_wraps_result(), function_name.clone())
        || v2_rt::map_contains_key(&rust_method_wraps_result(), function_name.clone()))
}
...
pub fn rust_wrap_runtime_collection_result(
    ...
    if rust_runtime_bridge_wraps_collection_result_in_rc(&function_name) {
        if rust_runtime_bridge_collection_result_needs_rc_elements(
            ...
            v2_rt::concat(
                v2_rt::concat("Rc::new((".to_string(), call_str),
...
pub fn is_map_typed_expr(
    ...
    match texpr.inferred.clone().as_deref().cloned() {
        Some(InferredNode::Resolved { node: n, .. }) => {
            node_is_keyed_collection(&n, source_indices)
        }
        _ => false,
    }
}
...
pub fn emit_typed_call(
...
) -> String {
    {
                    ...
                    Some(list_arg) => match get_idx {
                        Some(idx_arg) => {
                            ...
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat(list_str, ".get((".to_string()),
                                        index_str,
                                    ),
                                    ") as usize)".to_string(),
                                ),
        ...
        if (func.clone().as_str() == "with".to_string().as_str()) {
            {
                ...
                if needs_rc.clone() {
                    return v2_rt::concat(
                        v2_rt::concat("Rc::new(".to_string(), raw),
                        ")".to_string(),
                    );
                } else {
                    return raw;
            ...
            && ((all_args.clone().len() as i64) > 2))
        {
            ...
            v2_rt::concat(
                v2_rt::concat(v2_rt::concat(func_name, "(".to_string()), args_str),
                ")".to_string(),
            )
        };
        match callee.clone() {
            ...
            let default_args = Rc::new({
                ...
                for p in missing_with_defaults.iter().cloned() {
                    __result.push(make_arg_node(
                        ...
                        param_node_default_value(&p).clone().unwrap(),
                        p.span.clone(),
                        p.span.clone(),
                    ));
                }
                ...
                __result.extend(
                    (*{
                        ...
                        match v2_rt::map_get(&arg_map, pname.clone()) {
                            ...
                            None => {
                                if (param_node_default_value(&p) != None) {
            ...
            Some(arg) => {
                let next_acc = if (acc.clone().as_str() == "".to_string().as_str()) {
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat("v2_rt::concat(".to_string(), acc.clone()),
                                ", ".to_string(),
                            ),
                            arg.clone(),
                        ),
...
pub fn emit_typed_index(
...
) -> String {
    {
        ...
        let is_map =
            node_is_keyed_collection(&base_node, scope.type_env.clone().source_indices.clone());
...
pub fn emit_typed_collection_lambda(
    ...
    match (*lambda_expr.expr_data.clone()).clone() {
        ExprData::ExprLambda => {
            ...
            v2_rt::concat(
                v2_rt::concat(v2_rt::concat("|".to_string(), params_str), "| ".to_string()),
                body_str,
            )
        }
        _ => emit_typed_expr(
                            ...
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat(
                                            v2_rt::concat(
                                                v2_rt::concat("|".to_string(), params_str),
                                                "| { let ".to_string(),
                                            ),
                                            acc_ident.clone(),
                                        ),
        ...
        let acc_type_node = match fold_accumulator_type {
            Some(acc_type) => {
                let acc_children_have_unit = ({
                    ...
                    for c in acc_type.children.clone().iter().cloned() {
                        if (is_unit_like(&c) || (c.ident_span.clone() == None)) {
                            __found = true;
                            break;
                        }
                    }
                    ...
                    for c in acc_type.children.clone().iter().cloned() {
                        if {
                            ...
                            for gc in c.children.clone().iter().cloned() {
                                if (is_unit_like(&gc) || (gc.ident_span.clone() == None)) {
                                    __found = true;
                                    break;
                                }
                            }
            ...
            None => match contextual_acc_type {
                ...
                None => match args.clone().first().cloned() {
                    Some(init_arg) => {
                        if (arg_value(&init_arg).inferred.clone() != None) {
                ...
                ExprData::ExprLambda => {
                    ...
                    match ps.first().cloned() {
                        Some(acc_name) => Rc::new(EmitGraphInfo {
                            ...
                            variant_to_enum: emit_info.variant_to_enum.clone(),
                            owned_bindings: v2_rt::rc_set_insert(
...
) -> String {
    {
        ...
        if recv_is_optional {
                ...
                Some(a) => match (*arg_value(&a).expr_data.clone()).clone() {
                    ExprData::ExprLambda => {
                        ...
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(v2_rt::concat(recv_str, ".map(|".to_string()), p),
                                    "| ".to_string(),
                                ),
                                body_str,
                            ),
                    ...
                    _ => v2_rt::concat(
                        v2_rt::concat(v2_rt::concat(recv_str, ".map(".to_string()), first_arg_str),
                        ")".to_string(),
                    ),
                },
                None => v2_rt::concat(
        ...
        } else {
            {
                ...
                match args.clone().first().cloned() {
                    Some(a) => {
                        match (*arg_value(&a).expr_data.clone()).clone() {
                            ExprData::ExprLambda => {
                                let bd = match arg_value(&a).children.clone().first().cloned() {
                                    Some(v) => v.clone(),
                                    None => arg_value(&a),
                            ...
                            _ => v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat("Rc::new(".to_string(), iter_str),
                                        ".map(".to_string(),
                                    ),
                                    first_arg_str,
                                ),
            ...
            Some(a) => match (*arg_value(&a).expr_data.clone()).clone() {
                ExprData::ExprLambda => {
                    ...
                    let inner_iter = apply_type_template1(
                        ...
                        v2_rt::concat(
                            v2_rt::concat("(*".to_string(), body_str.clone()),
                            ")".to_string(),
                        ),
                    );
...
) -> String {
    {
        ...
        if is_map_typed_expr(
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat("v2_rt::map_get(&".to_string(), recv_str),
                        ", ".to_string(),
                    ),
                    index_str,
                ),
            ...
            if receiver_resolved {
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(v2_rt::concat(recv_str, ".get((".to_string()), index_str),
                        ") as usize)".to_string(),
                    ),
                    clone_iterator_suffix(),
                )
            ...
            {
                {
                    ...
                    v2_rt::concat(
                        v2_rt::concat(v2_rt::concat(recv_str, ".get(".to_string()), arg_str),
    ...
    if (method_semantics.clone() != None) {
        match (*method_semantics.clone().unwrap()).clone() {
            MethodSemantics::ServiceMethodSemantics {
                ...
                let optional_param_set = Rc::new({
                    ...
                    for p in op_params.clone().iter().cloned() {
                        if (param_node_type_expr(&p).return_cardinality.clone()
                ...
                .fold(
                    ...
                    |acc: Rc<HashMap<String, bool>>, p: Rc<Node>| {
                        v2_rt::rc_map_insert(acc, param_node_name_at(p.clone(), si.clone()), true)
                    },
                );
                let json_param_set = Rc::new({
                    ...
                    for p in op_params.clone().iter().cloned() {
                        if (coerce_primitive_type(
                            RenderTarget::Rust,
                            authored_name_at(si.clone(), &param_node_type_expr(&p)),
                        )
                        .as_str()
                    ...
                    for a in filled_args.iter().cloned() {
                        __result.push({
                            ...
                            let param_is_optional =
                                match v2_rt::map_get(&optional_param_set, aname.clone()) {
                                    Some(_) => true,
                                    None => false,
                                };
                            ...
                            let coerced = if (param_is_json.clone()
                                && is_string_typed_expr(arg_value(&a), si.clone()))
                            {
                                v2_rt::concat(
                                    v2_rt::concat(
                            ...
                            if needs_optional.clone() {
                                v2_rt::concat(
                                    v2_rt::concat("Some(".to_string(), coerced.clone()),
                                    ")".to_string(),
                                )
                            } else {
                                coerced.clone()
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(var_name, ".".to_string()),
            ...
            MethodSemantics::AlgebraMethodSemantics {
                ...
                let method_name =
                    authored_name_at(scope.type_env.clone().source_indices.clone(), &method_def);
            ...
            MethodSemantics::PlainMethodSemantics => {
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(recv_str, ".".to_string()),
                                emit_ident(method, RenderTarget::Rust),
                            ),
                            "(".to_string(),
                        ),
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat("match ".to_string(), scrut_str),
                                ".as_deref()".to_string(),
                            ),
                            clone_iterator_suffix(),
                        ),
...
) -> String {
    {
        ...
        if rc_analysis.needs_rc_pattern.clone() {
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat("    ".to_string(), pat_str),
                                        guard_str,
                                    ),
                                    " => { ".to_string(),
                                ),
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(v2_rt::concat("    ".to_string(), pat_str), guard_str),
                        " => ".to_string(),
                    ),
                    body_str,
                ),
...
) -> String {
    {
        ...
        let qualified_name = match struct_name {
            ...
            None => {
                ...
                if ((resolved_type.ident_span.clone() != None)
                    && v2_rt::map_contains_key(&emit_info.type_summaries.clone(), rt_name.clone()))
                {
                    Some(rt_name.clone())
                } else {
                    None
                    ...
                    } else {
                        {
                            ...
                            match find_struct_name_by_fields(
                                ...
                                Some(resolved_sn) => {
                                    ...
                                    let struct_lit = v2_rt::concat(
                                        v2_rt::concat(
                                            v2_rt::concat(resolved_sn.clone(), " {\n".to_string()),
                                            body,
                                        ),
                                        "\n}".to_string(),
                                    );
                    ...
                    } else {
                        {
                            ...
                            if is_positional_ctor {
                            ...
                            } else {
                                {
                                    ...
                                    let summary =
                                        lookup_emit_type_summary(emit_info.clone(), tn.clone());
                                    let default_strs = match summary {
                                        Some(s) => {
                                            ...
                                            let missing = Rc::new({
                                                let mut __result = Vec::new();
                                                for k in
                                                    Rc::new(v2_rt::map_keys(&fs)).iter().cloned()
                                                {
                                                    if !emit_map_has(
                                                        provided_set.clone(),
                                                        k.clone(),
                                            ...
                                            let all_defaultable = {
                                                ...
                                                for fname in missing.clone().iter().cloned() {
                                                    if !({
                                                        let has_zv = match v2_rt::map_get(
                                                            &ftm,
                                                            fname.clone(),
                                                        ) {
                                                            Some(ft) => {
                                                                match rust_zero_value(&ft) {
                                                                    Some(_) => true,
                                                                    None => false,
                                                                }
                                                            }
                                            ...
                                            if all_defaultable {
                                                Rc::new({
                                                    let mut __result = Vec::new();
                                                    for fname in missing.clone().iter().cloned() {
                                                        __result.extend((*if is_optional_struct_field(emit_info.clone(), tn.clone(), fname.clone()) {
                        ...
                        if (l_optional.clone() || r_optional.clone()) {
                            {
                                let l_cmp = if l_optional.clone() {
                                    ...
                                    v2_rt::concat(
                                        v2_rt::concat("Some(".to_string(), l_str),
                                        ".as_str())".to_string(),
                                    )
                                };
                                let r_cmp = if r_optional.clone() {
                                    ...
                                    v2_rt::concat(
                                        v2_rt::concat("Some(".to_string(), r_str),
                                        ".as_str())".to_string(),
                                    )
                                };
                                v2_rt::concat(
...
pub fn emit_typed_string_interp(
...
) -> String {
    {
        ...
        if ((args.clone().len() as i64) == 0) {
            v2_rt::concat(
                v2_rt::concat("\"".to_string(), fmt_str),
                "\".to_string()".to_string(),
            )
        } else {
            {
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat("format!(\"".to_string(), fmt_str),
                            "\", ".to_string(),
                        ),
                        args_str,
                    ),
...
pub fn emit_tco_init_stmt(
    ...
    match (*stmt.expr_data.clone()).clone() {
        ExprData::ExprLet => {
            ...
            let val_str =
                emit_typed_expr(v, registry, &scope, depth, shared_types, emit_info, 1024);
            let is_param = {
                let mut __found = false;
                for p in params.iter().cloned() {
...
pub fn emit_rust_tco_non_self_call(
    ...
    match (*frame.expr.clone().expr_data.clone()).clone() {
        ExprData::ExprCall { .. } => {
            ...
            v2_rt::concat(
                v2_rt::concat("break ".to_string(), call_str),
                ";".to_string(),
            )
        }
        _ => emit_error_expr(
                            ...
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat(
                                            v2_rt::concat(
                                                v2_rt::concat("if ".to_string(), cond_str),
                                                " {\n".to_string(),
                                            ),
...
pub fn emit_rust_tco_match(
    ...
    match (*frame.expr.clone().expr_data.clone()).clone() {
        ExprData::ExprMatch => {
            ...
            let arms_str = arm_strs.join(&"\n".to_string());
            let tco_needs_as_str =
                (all_arms_are_string_lit(&arm_list) && ((arm_list.clone().len() as i64) > 0));
            if rc_match.needs_option_deref.clone() {
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
...
pub fn emit_rust_tco_default_return(
...
) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat("break ".to_string(), val_str),
            ";".to_string(),
        )
    }
}
        ...
        match (*node.expr_data.clone()).clone() {
            ...
            _ => {
                ...
                for c in node.children.clone().iter().cloned() {
                    if expr_references_var(&c, var_name.clone(), source_indices.clone()) {
                        __found = true;
                        break;
                    }
                }
...
pub fn emit_typed_tco_reassign(
...
) -> String {
    {
        ...
        let filtered_params = Rc::new({
            let mut __result = Vec::new();
            for p in params.clone().iter().cloned() {
                if match v2_rt::map_get(&identity_params, param_node_name_at(p.clone(), si.clone()))
                {
                    Some(_) => false,
                    None => true,
                } {
            ...
            filtered_params.clone().iter().cloned().fold(
                ...
                |m: Rc<std::collections::BTreeSet<String>>, p: Rc<Node>| {
                    ...
                    let ref_count = filtered_arg_values.clone().iter().cloned().fold(
                        0,
                        |n: i64, av: Rc<Node>| {
                            if expr_references_var(&av, pname.clone(), si.clone()) {
                                (n.clone() + 1)
                            } else {
                                n.clone()
                            }
                    ...
                    if (ref_count.clone() <= 1) {
                        v2_rt::rc_set_insert(m.clone(), pname.clone())
                    } else {
                        m.clone()
                    }
                },
...
) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(v2_rt::concat(derives, "\npub struct ".to_string()), name),
                        " {\n".to_string(),
                    ),
                    config_fields,
                ),
...
) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat("impl ".to_string(), name.clone()),
                        " {\n".to_string(),
                    ),
                    make_indent((depth.clone() + 1)),
                ),
...
) -> String {
    {
        ...
        let ctors = match service_config_auth_source(service_item.clone(), source_indices.clone()) {
            Some(src) => Rc::new({
                let mut __result = Vec::new();
                for c in ctors.clone().iter().cloned() {
                    __result.push(if v2_rt::contains(c.clone(), "auth_token".to_string()) {
...
pub fn emit_auth_source_ctor(
    ...
    ExprData::ExprLiteral { value: LiteralValue::LitStr { value: env_name, .. }, .. } => { let LiteralValue::LitStr { value: env_name, .. } = value.as_ref() else { unreachable!() }; v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat("        auth_token: std::env::var(\"".to_string(), env_name.clone()), "\").expect(\"missing credential: ".to_string()), env_name.clone()), "\"),\n".to_string()) },
...
let raw = match ch.inferred.clone().as_deref().cloned() {
    ...
    Some(wire_node) => emit_typed_wire_field_assign(field_name.clone(), &from_path, wire_node.clone(), source_indices.clone()),
    None => v2_rt::concat(v2_rt::concat("let ".to_string(), field_name.clone()), " = compile_error!(\"REST typed dry-run: response_200 wire type missing despite typed projection; illegal state\");\n".to_string()),
}
                                        } else {
...
pub fn emit_rest_call(
...
) -> String {
    {
        ...
        let auth_line =
            emit_rest_auth_line(&transport, &service_item, http_method, &source_indices);
    ...
    match transport_path_template(transport, source_indices.clone()) {
        Some(path_node) => match (*path_node.expr_data.clone()).clone() {
            ...
            ExprData::ExprStringInterp => {
                ...
                if ((args.clone().len() as i64) == 0) {
                    v2_rt::concat(
                        v2_rt::concat("let url = format!(\"{}".to_string(), fmt_str),
                        "\", self.base_url);".to_string(),
                    )
                } else {
                    {
...
pub fn emit_rest_auth_line(
    ...
    ExprData::ExprVar { binding_kind: _, .. } => v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat("let request = client.".to_string(), http_method), "(&url)\n    .header(\"Authorization\", format!(\"Bearer {}\", ".to_string()), token_param), "));".to_string()),
    ExprData::ExprCall { .. } => {
                let header_name = match auth.children.clone().first().cloned() {
    Some(arg_node) => match (*arg_value(&arg_node).expr_data.clone()).clone() {
    ExprData::ExprLiteral { value: LiteralValue::LitStr { value: s, .. }, .. } => { let LiteralValue::LitStr { value: s, .. } = value.as_ref() else { unreachable!() }; s.clone() },
                ...
                if transport_has_auth(transport.clone(), source_indices.clone()) {
                    {
                        ...
                        let token_node =
                            match transport_auth_token(transport.clone(), source_indices.clone()) {
                                Some(tn) => {
                                    emit_simple_expr(&tn, &RenderTarget::Rust, &source_indices)
                                }
                                None => "\"\"".to_string(),
                            };
                        v2_rt::concat(
                    ...
                    v2_rt::concat(
                        v2_rt::concat("let request = client.".to_string(), http_method),
                        "(&url);".to_string(),
                    )
                }
            }
                            ...
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat(
                                            v2_rt::concat(
                                                v2_rt::concat("(".to_string(), state.expr.clone()),
                                                ").get(".to_string(),
                                            ),
                                            seg.clone(),
                                        ),
...
) -> Rc<WirePathProjection> {
    {
        ...
        segs.iter().cloned().fold(
            ...
            |acc: Rc<WirePathProjection>, seg: String| {
                advance_wire_path_projection(&acc, &seg, from_path.clone(), &source_indices)
            },
        )
    }
}
...
pub fn emit_typed_wire_field_assign(
...
) -> String {
    {
        ...
        if projection.ok.clone() {
            ...
            v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat("let ".to_string(), field_name), " = compile_error!(\"REST typed response path could not be resolved against declared 200 body: ".to_string()), from_path.clone()), "\");\n".to_string())
        }
    }
}
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat("let ".to_string(), var_name),
...
match ch.inferred.clone().as_deref().cloned() {
    Some(InferredNode::Resolved { node: tn, .. }) => if use_typed_wire.clone() {
                        match wire_opt.clone() {
    Some(wire_node) => emit_typed_wire_field_assign(field_name.clone(), &from_path, wire_node.clone(), source_indices.clone()),
    None => v2_rt::concat(v2_rt::concat("let ".to_string(), field_name.clone()), " = compile_error!(\"REST typed response: response_200 wire type missing despite typed projection; illegal state\");\n".to_string()),
}
                    } else {
                        emit_json_value_extract(field_name.clone(), &from_path, authored_name_at(source_indices.clone(), &tn))
                    },
...
pub fn emit_plain_response_body(
...
) -> String {
    {
        let is_text = match transport_response_format(transport, source_indices.clone()) {
            Some(fmt) => {
                (authored_name_at(source_indices.clone(), &fmt).as_str()
...
pub fn emit_response_arm(
...
) -> String {
    {
        ...
        let pattern = if (code_str.clone().as_str() == "nonzero".to_string().as_str()) {
            ...
            if ((v2_rt::string_length(&code_str) == 3)
                && (v2_rt::substring(&code_str, 1, 3).as_str() == "xx".to_string().as_str()))
            {
                {
                    let prefix = v2_rt::substring(&code_str, 0, 1);
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(prefix.clone(), "00..=".to_string()),
                            prefix.clone(),
                        ),
                        "99".to_string(),
                    )
            ...
            if use_from_key {
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        ...
                        emit_plain_response_body(op_node, transport, &source_indices),
                    ),
                    " },".to_string(),
                )
            }
        ...
        if ((exit_props.clone().len() as i64) == 0) {
        ...
        } else {
            {
                ...
                let exit_arms = Rc::new({
                    let mut __result = Vec::new();
                    for p in exit_props.clone().iter().cloned() {
                        __result.push(emit_exit_arm(p.clone(), inferred.clone(), &source_indices));
                    }
                    __result
                });
        ...
        if is_success {
            v2_rt::concat(
                v2_rt::concat(
                    ...
                    emit_shell_return(inferred, &source_indices),
                ),
                " },".to_string(),
            )
        } else {
...
) -> String {
    {
        ...
        let cmd_line = if ((argv.clone().len() as i64) > 0) {
            match argv.clone().first().cloned() {
                Some(first_arg) => v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(let_kw, " = std::process::Command::new(".to_string()),
        ...
        if has_stdin.clone() {
            {
                ...
                let all_lines = v2_rt::concat(
                    v2_rt::concat(v2_rt::concat(Rc::new(vec![cmd_line]), arg_lines), env_lines),
                    Rc::new(vec![
                        wd_line,
                        spawn_line,
                        spawn_exec,
...
pub fn emit_shell_argv_element(
    ...
    match (*arg.expr_data.clone()).clone() {
                    ...
                    __result.extend(
                        (*match (*p.clone()).clone() {
                            ...
                            StringPart::Interpolation { expr: e, .. } => {
                                ...
                                let is_opt = (is_optional_typed_expr(e.clone())
                                    || match v2_rt::map_get(&optional_params, name.clone()) {
                                        Some(_) => true,
                                        None => false,
                                    });
                                if is_opt.clone() {
        ...
        ExprData::ExprVar {
            ...
            if is_opt.clone() {
                v2_rt::concat(
                    v2_rt::concat("&".to_string(), var_name.clone()),
                ...
                if (is_product.clone() && ((effective.children.clone().len() as i64) > 1)) {
                    {
                        ...
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(lines, "Ok((".to_string()),
        ...
        } else {
            {
                ...
                let cap_methods = Rc::new({
                    ...
                    for c in cap_children.clone().iter().cloned() {
                        __result.push(emit_capability_method(&c, &shared_types, &env));
                    }
                    __result
                });
        ...
        match (*value.expr_data.clone()).clone() {
            ...
            ExprData::ExprListLit => {
                ...
                for c in value.children.clone().iter().cloned() {
                    if data_value_has_cross_refs(&c) {
                        __found = true;
                        break;
                    }
                }
            ...
            ExprData::ExprRecordLit { parent_enum: _, .. } => {
                ...
                for f in value.children.clone().iter().cloned() {
                    if data_value_has_cross_refs(&field_init_node_value(&f)) {
                        __found = true;
                        break;
                    }
                }
...
) -> Rc<TextFile> {
    {
        ...
        let test_fns = Rc::new({
            ...
            for p in projections.iter().cloned() {
                __result.push(emit_operation_test(&p, (depth.clone() + 1)));
            }
            __result
        });
    ...
    if ((features.clone().len() as i64) > 0) {
        {
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(name, " = { version = \"".to_string()),
                            version,
                        ),
                        "\", features = [".to_string(),
                    ),
        ...
        v2_rt::concat(
            v2_rt::concat(v2_rt::concat(name, " = \"".to_string()), version),
            "\"\n".to_string(),
        )
    }
}
...
pub fn emit_cargo_toml(crate_name: String, has_services: bool) -> Rc<TextFile> {
    {
        let header = v2_rt::concat(
            v2_rt::concat("[package]\nname = \"".to_string(), crate_name),
            "\"\nversion = \"0.1.0\"\nedition = \"2021\"\n".to_string(),
        );
        let workspace = "\n[workspace]\n".to_string();
        ...
        Rc::new(TextFile {
            ...
            content: v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(header, workspace),
                    "\n[dependencies]\n".to_string(),
                ),
...
pub fn resolve_param_default(
    ...
    match param_node_default_value(&param) {
        Some(dv) => match (*dv.expr_data.clone()).clone() {
            ...
            ExprData::ExprVar {
                binding_kind: _, ..
            } => match lookup_item(registry, authored_name_at(source_indices.clone(), &dv)) {
                Some(info) => match info.kind.clone() {
                    ItemKind::DataItem => match Rc::new({
                        let mut __result = Vec::new();
                        for i in module_items.iter().cloned() {
                            if (authored_name_at(source_indices.clone(), &i).as_str()
                                == authored_name_at(source_indices.clone(), &dv).as_str())
                            {
                                __result.push(i);
                            }
                        }
...
pub fn validate_workflow_param_defaults(
    ...
    Rc::new({
        ...
        for wf in workflow_funcs.iter().cloned() {
            __result.extend((*Rc::new({ let mut __result = Vec::new(); for param in wf.params.clone().iter().cloned() { __result.extend((*match param_node_default_value(&param) {
    Some(dv) => {
        ...
        let matching = Rc::new({
            ...
            for m in modules.iter().cloned() {
                if {
                    let mut __found = false;
                    for item in m.items.clone().iter().cloned() {
                        if (authored_name_at(m.type_env.clone().source_indices.clone(), &item)
                            .as_str()
...
) -> Rc<TextFile> {
    {
            ...
            for sn in unique_svc_names.iter().cloned() {
                __result.extend(
                    (*{
                        ...
                        match v2_rt::map_get(&svc_module_map, sn.clone()) {
                            Some(mod_name) => Rc::new(vec![v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat(
                                            v2_rt::concat(
        ...
        let header = v2_rt::concat(
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat("use clap::".to_string(), "{".to_string()),
        ...
        let crate_use = if has_services.clone() {
            v2_rt::concat(
                v2_rt::concat("use ".to_string(), crate_name.clone()),
                "::dry_run::DryRunMode;\n".to_string(),
            )
        } else {
            "".to_string()
        ...
        let mod_uses =
            emit_main_mod_uses(workflow_funcs.clone(), has_pipeline.clone(), &crate_name);
...
pub fn emit_subcommand_enum(
...
) -> String {
    {
        ...
        let variants = Rc::new({
            let mut __result = Vec::new();
            for wf in workflow_funcs.iter().cloned() {
                __result.push(emit_subcommand_variant(&wf, (depth.clone() + 1)));
            }
            __result
        });
...
pub fn emit_subcommand_variant(wf: &Rc<WorkflowFunc>, depth: i64) -> String {
    {
        ...
        let doc_line = v2_rt::concat(
            v2_rt::concat("/// Run the ".to_string(), wf.name.clone()),
            " workflow".to_string(),
        );
        if ((wf.params.clone().len() as i64) == 0) {
            v2_rt::concat(
                v2_rt::concat(v2_rt::concat(doc_line, "\n".to_string()), variant_name),
                ",".to_string(),
            )
        } else {
            {
...
pub fn emit_subcommand_field(
...
) -> String {
    {
        ...
        let field_type =
            emit_cli_param_type_node(&param_node_type_expr(&param), source_indices.clone());
        let default_attr = match v2_rt::map_get(&resolved_defaults, param_name) {
            Some(resolved) => v2_rt::concat(
                v2_rt::concat(
            ...
            None => match param_node_default_value(&param) {
                Some(dv) => match cli_default_literal_value(dv.clone()) {
                    Some(default_value) => v2_rt::concat(
                        v2_rt::concat(
                            "#[arg(long, default_value = \"".to_string(),
                            default_value.clone(),
                        ),
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(v2_rt::concat(default_attr, field_name), ": ".to_string()),
                field_type,
            ),
            ",".to_string(),
        )
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        ...
        if is_optional {
            v2_rt::concat(
                v2_rt::concat(
                    "Option<".to_string(),
                    emit_cli_param_type_node(&with_required_cardinality(&n), source_indices),
                ),
                ">".to_string(),
            )
        } else {
...
pub fn emit_main_fn(
...
) -> String {
    {
        ...
        let match_arms = Rc::new({
            let mut __result = Vec::new();
            for wf in workflow_funcs.iter().cloned() {
                __result.push(emit_main_match_arm(&wf, &has_services));
            }
            __result
        });
        ...
        let result_handling = if has_services.clone() {
            ...
            v2_rt::concat(
                v2_rt::concat("let _result = ".to_string(), match_block),
                ";".to_string(),
            )
        };
...
pub fn emit_main_match_arm(wf: &Rc<WorkflowFunc>, has_services: &bool) -> String {
    {
        ...
        let call_expr = if ((wf.params.clone().len() as i64) == 0) {
            {
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(v2_rt::concat(mod_name, "::".to_string()), fn_name),
                                "(".to_string(),
                            ),
                            service_args,
                        ),
        ...
        if has_services.clone() {
            ...
            v2_rt::concat(
                v2_rt::concat(v2_rt::concat(pattern, " => ".to_string()), call_expr),
                ",".to_string(),
            )
        }
    }
...
pub fn emit_main_service_arg_list(wf: &Rc<WorkflowFunc>, has_services: bool) -> Rc<Vec<String>> {
    {
        ...
        let resource_args = Rc::new({
            ...
            for u in wf.uses.clone().iter().cloned() {
                __result.push(v2_rt::concat(
                    "&".to_string(),
                    authored_name_at(wf.source_indices.clone(), &resource_use_resource(&u)),
                ));
            }
            __result
        });
                ...
                __result.push({
                    ...
                    if has_services.clone() {
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat("&".to_string(), struct_name.clone()),
                                    "::new(".to_string(),
                                ),
                                apply_type_template1(
                                    sharing.clone_value.clone(),
...
pub fn emit_dry_run_module() -> Rc<TextFile> {
    {
        ...
        Rc::new(TextFile {
            path: v2_rt::concat(
                v2_rt::concat(rust_source_root(), "dry_run".to_string()),
                rust_source_ext(),
            ),
            content: content,
        })
