...
pub fn container_alias_targets() -> Rc<HashMap<String, String>> {
    thread_local! {
...
pub fn container_template_algebra(name: &String) -> Option<String> {
    {
        let pascal = if (name.clone().as_str() == "list".to_string().as_str()) {
            "List".to_string()
        } else {
            if (name.clone().as_str() == "set".to_string().as_str()) {
                ...
                if (name.clone().as_str() == "map".to_string().as_str()) {
                    ...
                    if (name.clone().as_str() == "free_monoid".to_string().as_str()) {
                        "FreeMonoid".to_string()
                    } else {
                        if (name.clone().as_str() == "boolean_algebra".to_string().as_str()) {
                            "BooleanAlgebra".to_string()
                        } else {
                            if (name.clone().as_str() == "partial_function".to_string().as_str()) {
...
match v2_rt::map_get(&container_alias_targets(), pascal.clone()) {
    Some(a) => Some(a.clone()),
    None => if (((pascal.clone().as_str() == "FreeMonoid".to_string().as_str()) || (pascal.clone().as_str() == "BooleanAlgebra".to_string().as_str())) || (pascal.clone().as_str() == "PartialFunction".to_string().as_str())) {
            Some(pascal.clone())
        } else {
            None
        },
