...
pub use crate::std_termination::{DescentEvidence, RankingDimension, DescentSource, TerminationProof, ProofEdge, merge_evidence, join_evidence, evidence_rank, promote_to_strict, optional_evidence_meet, map_evidence_merge_at, PositiveDescentAmount};
...
pub fn proof_to_call_pattern(proof: Rc<TerminationProof>) -> Rc<CallPattern> {
    ...
    RankingDimension::ArithmeticValue { .. } => Rc::new(CallPattern::ArithmeticSubtractCall {
