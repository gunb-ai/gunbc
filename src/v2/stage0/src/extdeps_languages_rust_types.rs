...
pub fn rust_atom_realizations() -> Rc<Vec<Rc<TargetAtomRealization>>> {
    thread_local! {
        ...
        value_ctor_template: Some("Symbol(\"{ident}\".to_string())".to_string()),
        default_expr: Some("Symbol(String::new())".to_string()),
        is_copy: Some(false),
        literal_suffix: Some(".to_string()".to_string()),
        ...
        default_expr: Some("false".to_string()),
        is_copy: Some(true),
        literal_suffix: None,
    }), Rc::new(TargetAtomRealization {
