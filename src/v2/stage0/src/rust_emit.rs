...
lazy_static::lazy_static! {
    pub static ref RUST_VALUE_TYPES: Vec<String> = vec!["Int".to_string(), "Bool".to_string(), "Float".to_string()];
}

lazy_static::lazy_static! {
    pub static ref RUST_STRING_TYPES: Vec<String> = vec!["String".to_string(), "Secret".to_string()];
}
