...
pub static RUST_CONTAINER_TEMPLATES: std::sync::LazyLock<std::collections::HashMap<String, String>> = std::sync::LazyLock::new(|| {
    HashMap::from([("list".to_string(), "Vec<{0}>".to_string()), ("set".to_string(), "std::collections::BTreeSet<{0}>".to_string()), ("optional".to_string(), "Option<{0}>".to_string()), ("map".to_string(), "BTreeMap<{0}, {1}>".to_string())])
});
