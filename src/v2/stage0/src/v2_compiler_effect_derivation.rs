...
pub fn re_export_derive_op_effect(operation_name: String, method_str: String, path_str: String) -> Rc<DeriveOpEffectResult> {
    derive_op_effect_from_strings(operation_name, &method_str, path_str)
}
