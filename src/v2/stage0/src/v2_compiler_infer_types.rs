...
make_container_type(&kind_name, instantiate_algebra_type(inner.clone(), &base, &source_indices))
},
...
make_container_type(&kind_name, apply_type_substitution(inner.clone(), &subst, receiver.clone(), &source_indices))
},
