...
pub fn rust_type_is_rc_wrapped(type_name: String) -> bool {
    ((v2_rt::string_length(&type_name) >= 3)
...
pub fn emit_struct_field_from_child(
...
) -> String {
    {
        ...
        let final_ty = if needs_box_wrapping(
            ...
            v2_rt::concat(
                v2_rt::concat("Box<".to_string(), generic_ty.clone()),
                ">".to_string(),
            )
        } else {
