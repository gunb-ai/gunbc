...
pub struct OwnershipProofEntry {
    pub name: String,
    pub proof: Rc<Rc<OwnershipProof>>,
    pub param_names: Rc<Rc<std::collections::BTreeSet<String>>>,
}
...
pub struct RcPatternAnalysis {
    ...
    pub ref_bound_fields: Rc<Rc<Vec<String>>>,
}
...
pub struct WorkflowFunc {
    ...
    pub resolved_defaults: Rc<Rc<HashMap<String, String>>>,
