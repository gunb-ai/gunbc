...
pub fn emit_module_full(
...
) -> Rc<TextFile> {
    {
        ...
        .join(&"\n\n".to_string());
        let __emitprof_us_items = __emitprof_t_items.elapsed().as_micros();
        let __emitprof_nitems = typed_module.items.clone().len();
        ...
        let __emitprof_us_total = __emitprof_t0.elapsed().as_micros();
        eprintln!(
            "EMITPROF idx={} nitems={} total_us={} imports_us={} items_us={} module={}",
            __emitprof_idx,
            __emitprof_nitems,
            __emitprof_us_total,
            __emitprof_us_imp,
