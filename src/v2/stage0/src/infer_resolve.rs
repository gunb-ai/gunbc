...
pub use crate::v2_core::{Node, Field, Param, NodeType, rt_node, InferredNode, is_compiler_error, diagnostic_node, Cardinality, ResourceUse, MatchArm, FieldInit, NamedArg, StringPart, MatchPattern, ExprData, ExprErrorKind, make_expr_node, make_expr_error_node, map_children, make_arg_node, make_arm_node, make_field_init_node, make_text_part_node, make_interp_part_node, make_transport_node, local_transport_node, is_kernel_type, is_transport_kind, TransportKind, leaf_node, with_optional_cardinality, with_required_cardinality, Connective, CollectionKind, no_span};
...
use crate::v2_core::CollectionKind::{NoCollection, ListKind, SetKind, NonEmptyListKind, NonEmptySetKind, MapKind};
use crate::v2_core::StringPart::{Text, Interpolation};
use crate::v2_core::MatchPattern::{Wildcard};
use crate::v2_core::ExprData::{NoExprData, ExprLiteral, ExprError, ExprVar, ExprFieldAccess, ExprCall, ExprMethodCall, ExprMatch, ExprIf, ExprLet, ExprRecordLit, ExprListLit, ExprBinOp, ExprUnaryOp, ExprLambda, ExprStringInterp, ExprBlock, ExprCast, ExprForEach, ExprIndex, ExprSlice, ExprReturn};
use crate::v2_core::ExprErrorKind::{SemanticExprError};
use crate::v2_core::TransportKind::{LocalTransport};
use crate::v2_core::Connective::{Conj, Disj, NoConnective};
pub use crate::infer_types::{rt_type, collection_kind_for_name};
pub use crate::infer_env::{TypeEnv, lookup_type, is_recursive_type};
...
let no_collection = (n.collection_kind.clone() == CollectionKind::NoCollection);
let n = if no_collection.clone() {
                {
                    let ck = collection_kind_for_name(n.name.clone());
let has_ck = (ck.clone() != CollectionKind::NoCollection);
if has_ck.clone() {
                        Rc::new(Node {
    name: n.name.clone(),
    span: n.span.clone(),
...
Rc::new(NodeResolveResult {
    ...
    NodeType::InferVariable { .. } => resolved.clone(),
