...
pub fn builtin_kernel_seed_diagnostics() -> Rc<Vec<Rc<ErrorNode>>> {
    v2_rt::concat(make_map_type(type_variable_node("map_key".to_string()), type_variable_node("map_value".to_string())).diagnostics.clone(), make_container_type(&"List".to_string(), type_variable_node("collection_element".to_string())).diagnostics.clone())
}
