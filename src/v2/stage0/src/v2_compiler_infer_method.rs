...
pub use crate::v2_compiler_infer_types::{make_container_type, make_map_type, missing_kernel_container_profile_type};
...
pub fn map_of_type_variables() -> Rc<Node> {
    match make_map_type(type_variable_node("map_key".to_string()), type_variable_node("map_value".to_string())) {
    Some(n) => n.clone(),
