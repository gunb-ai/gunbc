...
pub use crate::v2_std_core::{Node, ErrorNode, make_span, with_optional_cardinality, unit_type, bool_type, string_type, int_type, InferredNode, Connective, Cardinality, ExprData};
...
pub fn map_of_type_variables() -> Rc<Node> {
    make_map_type(type_variable_node("map_key".to_string()), type_variable_node("map_value".to_string())).ty.clone()
}
...
let set_ty = make_container_type(&"Set".to_string(), type_variable_node("set_elem".to_string())).ty.clone();
