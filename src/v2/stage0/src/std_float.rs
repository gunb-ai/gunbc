...
pub use crate::std_algebra::{Field};
pub use crate::std_bit::{Word32, Word64};

pub type Float32 = Rc<Field>;

pub type Float64 = Rc<Field>;

pub type Float = field<Rc<Word64>>;
