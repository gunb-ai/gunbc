...
let has_structs = { let mut __found = false; for item in items.clone().iter().cloned() { if ((item.connective.clone() == Connective::Conj) && (item.transport.clone() == None)) { __found = true; break; } } __found };
let has_enums = { let mut __found = false; for item in items.clone().iter().cloned() { if ((item.connective.clone() == Connective::Disj) && (item.transport.clone() == None)) { __found = true; break; } } __found };
...
if (n.clone().as_str() == "none".to_string().as_str()) {
            ...
            if ((n.clone().as_str() == "true".to_string().as_str()) || (n.clone().as_str() == "false".to_string().as_str())) {
                ...
                {
                    let ident = emit_ident(n.clone(), RenderTarget::Python);
