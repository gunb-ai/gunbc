...
use crate::v2_compiler_languages::VisibilitySpec::{CaseVisibility, KeywordVisibility};
...
pub struct BlockEmitState {
    pub text: Rc<compile_error!("UNRESOLVED_CompilerError")>,
...
pub struct TcoFrame {
    ...
    pub scope: Rc<compile_error!("UNRESOLVED_CompilerError")>,
    pub depth: compile_error!("UNRESOLVED_CompilerError"),
}
...
pub struct TestProjection {
    ...
    pub service_name: compile_error!("UNRESOLVED_CompilerError"),
    ...
    pub mock_field_inits: Rc<compile_error!("UNRESOLVED_CompilerError")>,
...
pub fn extract_test_projections(typed: Rc<ResolvedGraph>) -> List<TestProjection> {
    Rc::new({
...
pub struct InterpPart {
    pub format_segment: compile_error!("UNRESOLVED_CompilerError"),
    pub arg_expr: compile_error!("UNRESOLVED_CompilerError"),
}
        ...
        match (*expr.expr_data.clone()).clone() {
            ...
            ExprData::ExprFieldAccess { summary: _, .. } => {
                ...
                if is_typed_service_call_receiver(expr.clone(), source_indices.clone()) {
                ...
                } else {
                    {
                        ...
                        let field_str = v2_rt::concat(
                            v2_rt::concat(base_call, ".".to_string()),
                            emit_ident(f.clone(), target.clone()),
                        );
            ...
            ExprData::ExprListLit => match target.clone() {
                ...
                _ => {
                    ...
                    v2_rt::concat(
                        v2_rt::concat("[".to_string(), el_strs.join(&", ".to_string())),
                        "]".to_string(),
                    )
                }
            },
            ExprData::ExprRecordLit { parent_enum: _, .. } => match target.clone() {
                ...
                _ => {
                    ...
                    v2_rt::concat(
                        v2_rt::concat("{".to_string(), field_strs.join(&", ".to_string())),
                        "}".to_string(),
                    )
                }
            },
...
pub fn empty_emit_scope() -> Rc<InferScope> {
    Rc::new(InferScope {
        ...
        service_registry: v2_rt::rc_empty_map::<String, List<OpEntry>>(),
...
pub fn lookup_item(registry: Map<String, ItemInfo>, name: String) -> Option<Rc<ItemInfo>> {
...
pub fn order_typed_call_args(args: List<Node>, func: String, scope: Rc<InferScope>) -> List<Node> {
    {
        let has_unnamed = {
            let mut __found = false;
...
pub fn unique_strings(items: List<String>) -> List<String> {
    {
...
pub fn emit_data_value_json(value: Rc<Node>, source_indices: Map<String, NewlineIndex>) -> String {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
...
pub fn to_string_helper(mut value: i64, mut acc: List<String>) -> List<String> {
    loop {
        if (value.clone() == 0) {
            break acc;
        } else {
...
pub fn apply_named_template(template: String, bindings: Map<String, String>) -> String {
...
pub fn apply_escape_pairs(s: String, pairs: List<EscapePair>) -> String {
    pairs
        .iter()
        .cloned()
...
pub fn emit_string_literal(s: String, suffix: String) -> String {
    v2_rt::concat(
        v2_rt::concat(
            v2_rt::concat("\"".to_string(), escape_string_literal_body(s)),
            "\"".to_string(),
        ),
        suffix,
    )
    ...
    if (kind.clone().as_str() == "optional".to_string().as_str()) {
        ...
        match coerce_container_template(target.clone(), kind.clone()) {
            ...
            None => {
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(kind.clone(), spec.type_arg_open.clone()),
                        inner,
                    ),
...
pub fn emit_map_type(key_type: String, val_type: String, target: RenderTarget) -> String {
    match coerce_container_template(target, "map".to_string()) {
        ...
        None => v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat("Map<".to_string(), key_type),
                    ", ".to_string(),
                ),
                val_type,
            ),
...
pub fn emit_node_type(
    ...
    render_node_type(n, target, v2_rt::rc_empty_set::<String>(), source_indices)
}

pub fn named_type_vars_in_inferred(inferred: Option<Rc<InferredNode>>) -> List<String> {
...
pub fn named_type_vars_in_node(n: Rc<Node>) -> List<String> {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        ...
        {
            {
                ...
                let err_str = apply_type_template1(
                    ...
                    v2_rt::concat("UNRESOLVED_".to_string(), label),
                );
                return err_str;
            }
        }
        ...
        if is_arrow {
            {
                ...
                let result = match spec.callable_type_template.clone() {
                    Some(t) => v2_rt::replace(
                        v2_rt::replace(t.clone(), "{params}".to_string(), param_str),
                        "{return}".to_string(),
                        ret_str.clone(),
                    ),
                    None => {
                        if (ret_str.clone().as_str() == "".to_string().as_str()) {
                            {
                                let void_template = v2_rt::replace(
                                    repr.template.clone(),
                                    v2_rt::concat(
...
pub fn render_tuple_parts(parts: List<String>, target: RenderTarget) -> String {
    {
...
pub fn is_type_alias_return_node(n: Rc<Node>, source_indices: Map<String, NewlineIndex>) -> bool {
...
pub fn service_has_shell(fallback_transport: Rc<Node>, op_children: List<Node>) -> bool {
    {
...
pub struct ServiceFieldSet {
    pub has_rest: compile_error!("UNRESOLVED_CompilerError"),
    pub has_shell: compile_error!("UNRESOLVED_CompilerError"),
    pub has_file: compile_error!("UNRESOLVED_CompilerError"),
    pub has_auth: compile_error!("UNRESOLVED_CompilerError"),
}
...
pub fn service_field_decls(fs: ServiceFieldSet, t: Rc<ServiceFieldTemplates>) -> List<String> {
    {
...
pub fn service_field_ctors(fs: ServiceFieldSet, t: Rc<ServiceFieldTemplates>) -> List<String> {
    {
        let result = Rc::new(vec![]);
        let result = if fs.has_rest.clone() {
...
pub fn emit_unified_transport_dispatch(
    ...
    depth: i64,
    target: RenderTarget,
    render_rest: impl Fn(String, Rc<Node>, i64, Map<String, NewlineIndex>) -> String + Clone,
    render_shell: impl Fn(String, Rc<Node>, i64, Map<String, NewlineIndex>) -> String + Clone,
...
pub fn emit_unified_operation_method(
    ...
    env: Rc<TypeEnv>,
    render_transport_body: impl Fn(Rc<Node>, String, Map<String, NewlineIndex>, i64) -> String + Clone,
) -> String {
    {
        let spec = language_spec(target.clone());
        ...
        let all_params = if (sp.clone().as_str() == "".to_string().as_str()) {
            ...
            if (params_str.clone().as_str() == "".to_string().as_str()) {
                ...
                v2_rt::concat(
                    v2_rt::concat(sp.clone(), ", ".to_string()),
                    params_str.clone(),
                )
            }
        };
        ...
        if spec.block_syntax.clone().significant_whitespace.clone() {
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(sig, spec.block_syntax.clone().block_open.clone()),
...
pub fn emit_unified_service_def(
    ...
    registry: Map<String, ItemInfo>,
    env: Rc<TypeEnv>,
    render_service_fields: impl Fn(String, Rc<Node>, List<Node>, Map<String, NewlineIndex>) -> String
        + Clone,
    render_transport_body: impl Fn(Rc<Node>, String, Map<String, NewlineIndex>, i64) -> String + Clone,
) -> String {
    {
...
pub fn is_type_alias_item(item: Rc<Node>, source_indices: Map<String, NewlineIndex>) -> bool {
    (is_bare_leaf_item(item.clone())
        && is_type_alias_return_node(resolved_type(item.clone()), source_indices))
}

pub fn is_type_decl_item(item: Rc<Node>, source_indices: Map<String, NewlineIndex>) -> bool {
    ((is_bare_leaf_item(item.clone())
        && !is_type_alias_return_node(resolved_type(item.clone()), source_indices))
...
pub fn block_stmts_init(stmts: List<Node>) -> List<Node> {
...
pub fn tco_reassign_core(
...
) -> List<String> {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(temp_lets, assigns),
            Rc::new(vec![v2_rt::concat(line_prefix.clone(), continue_str)]),
        )
    }
}
...
pub fn shared_tco_body(inner: String, depth: i64, spec: Rc<LanguageSpec>) -> String {
    {
        ...
        if syntax.significant_whitespace.clone() {
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(tco.loop_keyword.clone(), syntax.block_open.clone()),
                    make_indent((depth + 1)),
                ),
                inner,
            )
...
pub fn shared_tco_default_return(
...
) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(spec.tco.clone().break_return.clone(), " ".to_string()),
            val_str,
        )
    }
}
...
pub fn shared_tco_non_self_call(
    ...
    target: RenderTarget,
    spec: Rc<LanguageSpec>,
    recurse_call: impl Fn(String, List<Node>, Rc<InferScope>, i64) -> String + Clone,
) -> String {
    match (*frame.expr.clone().expr_data.clone()).clone() {
        ExprData::ExprCall { .. } => {
...
pub fn shared_tco_block(
    ...
    target: RenderTarget,
    spec: Rc<LanguageSpec>,
    emit_init_stmts: impl Fn(List<Node>, Rc<InferScope>, i64) -> Rc<BlockEmitState> + Clone,
    recurse_tco: impl Fn(Rc<Node>, Rc<InferScope>, i64) -> String + Clone,
) -> String {
    match (*frame.expr.clone().expr_data.clone()).clone() {
        ExprData::ExprBlock => {
...
pub fn unified_tco_recurse(
    ...
    render_init_stmts: impl Fn(List<Node>, Rc<InferScope>, i64) -> Rc<BlockEmitState> + Clone,
) -> String {
    ...
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        ...
        match (*body.expr_data.clone()).clone() {
            ExprData::ExprLet => {
                ...
                let let_line =
                    v2_rt::concat(prefix, emit_let_binding(n.clone(), val_str, target.clone()));
                let next_scope = extend_scope(
                    scope.clone(),
                    n.clone(),
                    resolved_type(v.clone()),
...
pub fn apply_bridge_method_overrides(name: String, overrides: Map<String, String>) -> String {
...
pub fn emit_lambda_params(param_names: List<String>, target: RenderTarget) -> String {
    {
        let spec = language_spec(target.clone());
        let param_strs = Rc::new({
            let mut __result = Vec::new();
...
pub fn emit_list_lit_expr(element_strs: List<String>, target: RenderTarget) -> String {
    {
        let spec = language_spec(target);
...
pub fn extract_string_interp_parts(expr: Rc<Node>) -> List<StringPart> {
    Rc::new({
        let mut __result = Vec::new();
        for child in expr.children.clone().iter().cloned() {
            __result.push(match (*child.expr_data.clone()).clone() {
            ...
            && (src_ty.clone().as_str() == ty_str.clone().as_str()))
        {
            ...
            if can_cast(target.clone(), src_ty.clone(), ty_str.clone()) {
                ...
                emit_error_expr(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat("unsupported cast from ".to_string(), src_ty.clone()),
                            " to ".to_string(),
                        ),
                        ty_str.clone(),
                    ),
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(fes.prefix.clone(), var_str),
                                fes.separator.clone(),
                            ),
                            coll_str,
                        ),
                    ...
                    wrap_result(v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat("(".to_string(), left_str),
                                        " ".to_string(),
                                    ),
                                    op_str,
                                ),
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat("(".to_string(), then_str),
                                        ") if (".to_string(),
                                    ),
                                    cond_str,
                                ),
...
pub fn emit_typed_block_join(
    ...
    scope: Rc<InferScope>,
    depth: i64,
    emit_block_stmts: impl Fn(List<Node>, Rc<InferScope>, i64) -> Rc<BlockEmitState> + Clone,
) -> String {
    {
...
pub fn method_template_emit_for_target(target: RenderTarget) -> Map<String, String> {
    match target {
                ...
                let segments = Rc::new({
                    ...
                    for p in parts.clone().iter().cloned() {
                        __result.push(match (*p.clone()).clone() {
                            ...
                            StringPart::Interpolation { expr: e, .. } => v2_rt::concat(
                                v2_rt::concat("{".to_string(), recurse(e.clone())),
                                "}".to_string(),
                            ),
                        });
                    }
            ...
            None => {
                if ((fields.clone().len() as i64) == 0) {
                ...
                } else {
                    {
                        ...
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(rls.anon_prefix.clone(), fields_str),
                                "\n".to_string(),
                            ),
            ...
            Some(tn) => {
                if ((fields.clone().len() as i64) == 0) {
                ...
                } else {
                    {
                        ...
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(tn.clone(), rls.named_open.clone()),
                                fields_str,
                            ),
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    v2_rt::concat(
                                        v2_rt::concat(spec.async_call_prefix.clone(), var_name),
                                        ".".to_string(),
                                    ),
            ...
            Some(vps) => {
                if ((field_bindings.clone().len() as i64) == 0) {
                ...
                } else {
                    {
                        ...
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(name, vps.open.clone()),
...
pub fn emit_match_arm_line(
...
) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(v2_rt::concat(make_indent(case_depth), case_kw), guard_str),
                    ":\n".to_string(),
                ),
        ...
        match summary {
            Some(fs) => match fs.access_style.clone() {
                ...
                FieldAccessStyle::TupleSecond => {
                    v2_rt::concat(base_str, ts.second_accessor.clone())
                }
                _ => v2_rt::concat(
                    v2_rt::concat(base_str, ".".to_string()),
...
pub fn seed_bindings(key: String, value: String) -> Map<String, String> {
