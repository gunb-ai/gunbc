...
pub use crate::std_types::{is_container_type, container_template_algebra};
...
pub use crate::generated_method_template_projection::{rust_method_template_emit, python_method_template_emit, go_method_template_emit};
...
pub fn render_node_type(n: &Rc<Node>, target: &RenderTarget, shared_types: &Rc<std::collections::BTreeSet<String>>, source_indices: &Rc<HashMap<String, Rc<NewlineIndex>>>) -> String {
    stacker::maybe_grow(512 * 1024, 2 * 1024 * 1024, || {
        {
...
pub fn method_template_emit_for_target(target: RenderTarget) -> Option<Rc<HashMap<String, String>>> {
    match target {
