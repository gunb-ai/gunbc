...
let is_zero_param_callable = n.inferred.is_some() && n.connective.is_none() && n.children.is_empty() && n.collection_kind.is_none() && n.params.is_empty();
if (((n.params.clone().len() as i64) > 0) || is_zero_param_callable) {
                {
