...
pub use crate::v2_compiler_ownership::{analyze_ownership, OwnershipDecision, OwnershipProof};
...
pub use crate::v2_std_core::{
    arg_name, arg_value, arm_body, arm_guard, arm_pattern, build_newline_index,
    diagnostic_to_message, diagnostic_to_span, expr_call_func, expr_method_name, expr_var_name,
    field_access_field, field_binding_name, field_binding_pattern, field_init_node_name,
    field_init_node_value, field_node_cardinality, field_node_default_value, field_node_from_key,
    field_node_name, field_node_span, field_node_type_expr, foreach_variable, import_is_all,
    import_specific_names, is_error_diagnostic, is_import_node, lambda_param_names,
    let_binding_name, make_error_node, make_named_expr_node, module_imports, module_items, no_span,
    param_node_default_value, param_node_name, param_node_span, param_node_type_expr,
        ...
        for proof in proofs.clone().iter().cloned() {
            __result.extend({
                ...
                for decision in proof.decisions.clone().iter().cloned() {
                    __result.extend(match (*decision.clone()).clone() {
...
pub fn json_list(items: Vec<String>) -> String {
    v2_rt::concat(
        v2_rt::concat("[".to_string(), items.clone().join(&", ".to_string())),
        "]".to_string(),
    )
}
...
pub fn serialize_span(span: Rc<SourceSpan>) -> String {
    v2_rt::concat(
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat("{\"start\": ".to_string(), (span.start.clone()).to_string()),
                ", \"end\": ".to_string(),
            ),
        ...
        let names_json = if import_is_all(imp.clone()) {
            ...
            v2_rt::concat(
                v2_rt::concat(
                    ...
                    json_list({
                        let mut __result = Vec::new();
                        for v in import_specific_names(imp.clone()).iter().cloned() {
...
pub fn serialize_literal(value: Rc<LiteralValue>) -> String {
    match (*value.clone()).clone() {
        LiteralValue::LitStr { value: inner, .. } => v2_rt::concat(
            v2_rt::concat(
        ...
        LiteralValue::LitInt { value: inner, .. } => v2_rt::concat(
            v2_rt::concat(
        ...
        LiteralValue::LitFloat { value: inner, .. } => v2_rt::concat(
            v2_rt::concat(
        ...
        LiteralValue::LitBool { value: inner, .. } => v2_rt::concat(
            v2_rt::concat(
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    ...
                    json_quote(field_binding_name(binding.clone())),
                ),
                ", \"binding\": ".to_string(),
            ),
            serialize_match_pattern(field_binding_pattern(binding.clone())),
        ),
        "}".to_string(),
    )
}
...
pub fn serialize_match_pattern(pattern: Rc<MatchPattern>) -> String {
    match (*pattern.clone()).clone() {
        ...
        MatchPattern::LitPattern { value: inner, .. } => v2_rt::concat(
            v2_rt::concat(
            ...
            v2_rt::concat(
                ...
                json_list({
                    ...
                    for fb in field_bindings.clone().iter().cloned() {
                        __result.push(serialize_field_binding(fb.clone()));
                    }
                    __result
                }),
            ),
    ...
    v2_rt::concat(
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    "{\"name\": ".to_string(),
                    json_optional_string(arg_name(arg.clone())),
                ),
                ", \"value\": ".to_string(),
            ),
            serialize_node(arg_value(arg.clone())),
        ),
        "}".to_string(),
    )
}
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            "{\"pattern\": ".to_string(),
                            serialize_match_pattern(arm_pattern(arm.clone())),
                        ),
                        ", \"guard\": ".to_string(),
                    ),
                    json_optional_node(arm_guard(arm.clone())),
                ),
                ", \"body\": ".to_string(),
            ),
            serialize_node(arm_body(arm.clone())),
        ),
        "}".to_string(),
    )
}
    ...
    v2_rt::concat(
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    "{\"name\": ".to_string(),
                    json_quote(field_init_node_name(field_init.clone())),
                ),
                ", \"value\": ".to_string(),
            ),
            serialize_node(field_init_node_value(field_init.clone())),
        ),
        "}".to_string(),
    )
}
...
pub fn serialize_string_part(part: Rc<StringPart>) -> String {
    match (*part.clone()).clone() {
        ...
        StringPart::Interpolation { expr: inner, .. } => v2_rt::concat(
            v2_rt::concat(
    ...
    match value.clone() {
        Some(inner) => v2_rt::concat(
            v2_rt::concat(
                ...
                json_list({
                    let mut __result = Vec::new();
                    for p in inner.param_types.clone().iter().cloned() {
                        __result.push(serialize_node(p.clone()));
                    }
                    __result
                }),
            ),
    ...
    match value.clone().as_deref().cloned() {
        ...
        Some(MethodSemantics::AlgebraMethodSemantics {
            ...
            v2_rt::concat(
                ...
                json_optional_node(fold_accumulator_type.clone()),
            ),
            "}".to_string(),
        ),
            ...
            v2_rt::concat(
                ...
                json_list({
                    ...
                    for p in op_params.clone().iter().cloned() {
                        __result.push(serialize_param(p.clone()));
                    }
                    __result
                }),
            ),
...
pub fn serialize_expr_data(expr_node: Rc<Node>) -> String {
    {
        ...
        match (*expr_node.expr_data.clone()).clone() {
                    ...
                    v2_rt::concat(
                        ...
                        json_list({
                            ...
                            for c in ch.clone().iter().cloned() {
                                __result.push(serialize_node(c.clone()));
                            }
                            __result
                        }),
                    ),
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                ...
                                serialize_method_semantics(method_semantics.clone()),
                            ),
                            ", \"children\": ".to_string(),
                        ),
                        json_list({
            ...
            ExprData::ExprBinOp { op: op, .. } => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                ...
                                serialize_lambda_semantics(semantics.clone()),
                            ),
                            ", \"children\": ".to_string(),
                        ),
                        json_list({
            ...
            ExprData::ExprLet => {
                let name = let_binding_name(expr_node.clone());
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
            ...
            ExprData::ExprMatch => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            ExprData::ExprListLit => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            ExprData::ExprStringInterp => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            ExprData::ExprBlock => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            ExprData::ExprCast => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            ExprData::ExprIndex => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            ExprData::ExprSlice => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            "{\"name\": ".to_string(),
                            json_quote(resource_use_name(resource_use.clone())),
                        ),
                        ", \"resource\": ".to_string(),
                    ),
                    serialize_node(resource_use_resource(resource_use.clone())),
                ),
                ", \"span\": ".to_string(),
            ),
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                                    ...
                                    v2_rt::concat(
                                        v2_rt::concat(
                                            v2_rt::concat(
                                                v2_rt::concat(
                                                    "{\"name\": ".to_string(),
                                                    json_quote(field_node_name(field.clone())),
                                                ),
                                                ", \"type_expr\": ".to_string(),
                                            ),
                                            serialize_node(field_node_type_expr(field.clone())),
                                        ),
                            ...
                            json_optional_node(field_node_default_value(field.clone())),
                        ),
                        ", \"from_key\": ".to_string(),
                    ),
                    json_optional_string(field_node_from_key(field.clone())),
                ),
                ", \"span\": ".to_string(),
            ),
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                v2_rt::concat(
                                    "{\"name\": ".to_string(),
                                    json_quote(param_node_name(param.clone())),
                                ),
                                ", \"type_expr\": ".to_string(),
                            ),
                            serialize_node(param_node_type_expr(param.clone())),
                        ),
                        ", \"default_value\": ".to_string(),
                    ),
                    json_optional_node(param_node_default_value(param.clone())),
                ),
                ", \"span\": ".to_string(),
            ),
    ...
    v2_rt::concat(
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat("{\"name\": ".to_string(), json_quote(module.name.clone())),
                        ", \"imports\": ".to_string(),
                    ),
                    json_list({
                        let mut __result = Vec::new();
                        for imp in module_imports(module.clone()).iter().cloned() {
                            __result.push(serialize_import_node(imp.clone()));
                        }
                        __result
                    }),
                ),
            ...
            serialize_span(module.span.clone()),
        ),
        "}".to_string(),
    )
}
...
pub fn serialize_typed_module(module: Rc<TypedModule>) -> String {
    v2_rt::concat(
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            "{\"module\": ".to_string(),
                            serialize_module(module.module.clone()),
                        ),
                        ", \"items\": ".to_string(),
                    ),
                    json_list({
                        ...
                        for item in module.items.clone().iter().cloned() {
                            __result.push(serialize_node(item.clone()));
                        }
                        __result
                    }),
                ),
            ...
            json_list({
                let mut __result = Vec::new();
                for k in v2_rt::map_keys(&module.item_registry.clone())
                    .iter()
                    .cloned()
                {
...
pub fn emit_dag_artifact(typed: Rc<ResolvedGraph>) -> Rc<EmitResult> {
    {
        let modules_json = {
            let mut __result = Vec::new();
            for m in typed.modules.clone().iter().cloned() {
                __result.push(serialize_typed_module(m.clone()));
            }
            __result
        }
        .join(&", ".to_string());
        ...
        let item_registry_json = {
            let mut __result = Vec::new();
            for k in v2_rt::map_keys(&typed.item_registry.clone())
                .iter()
                .cloned()
            {
                __result.push(json_quote(k.clone()));
...
pub fn boundary_ref_error(names: Vec<String>, ref_name: String) -> Vec<Rc<ErrorNode>> {
    if {
        ...
        vec![compile_bundle_error(v2_rt::concat(
            v2_rt::concat(
...
pub fn collect_diagnostics(parse_results: Vec<Rc<ParseResult>>) -> Vec<Rc<ErrorNode>> {
    parse_results
        ...
        .iter()
        .cloned()
        .fold(vec![], |acc: _, pr: Rc<ParseResult>| {
            match pr.error.clone() {
...
pub fn front_end_sources(sources: Vec<Rc<SourceFile>>) -> Rc<FrontendResult> {
    {
        let tokenized = {
            ...
            for s in sources.clone().iter().cloned() {
                __result.push(tokenize(s.content.clone(), s.path.clone()));
            }
            __result
        };
        let parse_results = {
            let mut __result = Vec::new();
            for t in tokenized.clone().iter().cloned() {
                __result.push(parse(t.clone()));
            }
            __result
        };
...
pub fn compile_sources(sources: Vec<Rc<SourceFile>>, target: RenderTarget) -> Rc<PipelineResult> {
    {
        ...
        let newline_indices: Vec<Rc<NewlineIndex>> = {
            let mut __result = Vec::new();
            for s in sources.clone().iter().cloned() {
                __result.push(build_newline_index(s.path.clone(), s.content.clone()));
            }
            __result
        };
        ...
        match frontend.graph.clone() {
            ...
            Some(graph) => {
                ...
                let resolve_errors = {
                    let mut __result = Vec::new();
                    for d in graph_diags.clone().iter().cloned() {
                ...
                let source_indices = newline_indices.clone().iter().cloned().fold(
                    <HashMap<String, Rc<NewlineIndex>>>::new(),
                    |acc: _, index: Rc<NewlineIndex>| {
                        v2_rt::map_insert(acc.clone(), index.file.clone(), index.clone())
                    },
                );
                ...
                let artifact_plan = default_artifact_plan(
                    {
                        let mut __result = Vec::new();
                        for m in typed.modules.clone().iter().cloned() {
                            __result.push(m.module.clone().name.clone());
                        }
                        __result
                    },
                    target.clone(),
