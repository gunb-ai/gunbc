...
use crate::v2_std_core::Connective::{Arrow, NoConnective};
                ...
                (*Rc::new({
                    ...
                    .cloned()
                    {
                        __result.push(analyze_ownership(
                            authored_name_at(m.type_env.clone().source_indices.clone(), &item),
                            item.params.clone(),
...
pub fn json_optional_inferred_node(
                    ...
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                ...
                                json_quote(authored_name_at(source_indices.clone(), &imp)),
                            ),
                            ", \"names\": ".to_string(),
                        ),
                        names_json,
            ...
            v2_rt::concat(
                ...
                json_list(Rc::new({
                    ...
                    for fb in field_bindings.clone().iter().cloned() {
                        __result.push(serialize_field_binding(&fb, &source_indices));
                    }
                    __result
                })),
            ),
...
pub fn serialize_named_arg(
    ...
    v2_rt::concat(
        v2_rt::concat(
            ...
            serialize_node(&arg_value(&arg), &source_indices),
        ),
        "}".to_string(),
    )
}
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    ...
                    json_optional_node(arm_guard(&arm), source_indices.clone()),
                ),
                ", \"body\": ".to_string(),
            ),
            serialize_node(&arm_body(&arm), &source_indices),
        ),
        "}".to_string(),
    )
}
...
pub fn serialize_field_init(
    ...
    v2_rt::concat(
        v2_rt::concat(
            ...
            serialize_node(&field_init_node_value(&field_init), &source_indices),
        ),
        "}".to_string(),
    )
}
    ...
    match (*part).clone() {
        ...
        StringPart::Interpolation { expr: inner, .. } => v2_rt::concat(
            v2_rt::concat(
                ...
                serialize_node(&inner, &source_indices),
            ),
            "}".to_string(),
        ),
    }
        ...
        Some(MethodSemantics::AlgebraMethodSemantics {
            ...
            v2_rt::concat(
                v2_rt::concat(
                    ...
                    json_optional_node(fold_accumulator_type.clone(), source_indices.clone()),
                ),
                "}".to_string(),
            )
        }
            ...
            v2_rt::concat(
                ...
                json_list(Rc::new({
                    ...
                    for p in op_params.clone().iter().cloned() {
                        __result.push(serialize_param(&p, &source_indices));
                    }
                    __result
                })),
            ),
...
pub fn serialize_sub_value_relation(rel: Rc<SubValueRelation>) -> String {
    match (*rel).clone() {
        ...
        SubValueRelation::IteratedSubValue { field: f, .. } => v2_rt::concat(
            v2_rt::concat(
...
pub fn serialize_expr_data(
...
) -> String {
    {
        ...
        match (*expr_node.expr_data.clone()).clone() {
            ...
            ExprData::ExprError { kind, message, .. } => v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                    ...
                    v2_rt::concat(
                        ...
                        json_list(Rc::new({
                            ...
                            for c in ch.iter().cloned() {
                                __result.push(serialize_node(&c, &source_indices));
                            }
                            __result
                        })),
                    ),
...
pub fn serialize_inferred_node(
    ...
    match (*inferred).clone() {
        ...
        InferredNode::CompilerError { message, span, .. } => v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    ...
                    serialize_node(&resource_use_resource(&resource_use), &source_indices),
                ),
                ", \"span\": ".to_string(),
            ),
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            ...
                            json_optional_node(
                                field_node_default_value(&field),
                                source_indices.clone(),
                            ),
                        ),
                        ", \"from_key\": ".to_string(),
                ...
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            ...
                            serialize_node(&param_node_type_expr(&param), &source_indices),
                        ),
                        ", \"default_value\": ".to_string(),
                    ),
                    json_optional_node(param_node_default_value(&param), source_indices.clone()),
                ),
                ", \"span\": ".to_string(),
            ),
            ...
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            "{\"name\": ".to_string(),
                            json_quote(authored_name_at(source_indices.clone(), &module)),
                        ),
                        ", \"imports\": ".to_string(),
                    ),
                    json_list(Rc::new({
                        ...
                        for imp in module_imports(module.clone()).iter().cloned() {
                            __result.push(serialize_import_node(&imp, &source_indices));
                        }
                        __result
                    })),
                ),
...
pub fn serialize_typed_module(module: &Rc<TypedModule>) -> String {
    {
        ...
        v2_rt::concat(
            v2_rt::concat(
                v2_rt::concat(
                    v2_rt::concat(
                        v2_rt::concat(
                            v2_rt::concat(
                                "{\"module\": ".to_string(),
                                serialize_module(&module.module.clone(), &si),
                            ),
                            ", \"items\": ".to_string(),
                        ),
                        json_list(Rc::new({
                            ...
                            for item in module.items.clone().iter().cloned() {
                                __result.push(serialize_node(&item, &si));
                            }
                            __result
                        })),
                    ),
                ...
                json_list(Rc::new({
                    let mut __result = Vec::new();
                    for k in Rc::new(v2_rt::map_keys(&module.item_registry.clone()))
                        .iter()
                        .cloned()
                    {
...
pub fn emit_dag_artifact(typed: &Rc<ResolvedGraph>) -> Rc<EmitResult> {
    {
        let modules_json = Rc::new({
            let mut __result = Vec::new();
            for m in typed.modules.clone().iter().cloned() {
                __result.push(serialize_typed_module(&m));
            }
            __result
        })
        .join(&", ".to_string());
        let diagnostics_json = Rc::new({
            ...
            for d in typed.diagnostics.clone().iter().cloned() {
                __result.push(serialize_diagnostic(&d));
            }
            __result
        })
        .join(&", ".to_string());
        let item_registry_json = Rc::new({
            let mut __result = Vec::new();
            for k in Rc::new(v2_rt::map_keys(&typed.item_registry.clone()))
                .iter()
                .cloned()
            {
                __result.push(json_quote(k.clone()));
...
pub fn boundary_ref_error(names: Rc<Vec<String>>, ref_name: &String) -> Rc<Vec<Rc<ErrorNode>>> {
    if {
        ...
        Rc::new(vec![compile_bundle_error(v2_rt::concat(
            v2_rt::concat(
...
pub fn compile_sources(
    ...
    crate::compile_pipeline_fold::compile_sources_via_fold(sources, target)
}

// Legacy inline pipeline removed — authority is compile_pipeline_fold (mirrors compile.dag fold).
...
pub fn compile_to_resolved(sources: Rc<Vec<Rc<SourceFile>>>) -> Rc<ResolvedPipelineResult> {
    crate::compile_pipeline_fold::compile_to_resolved_via_fold(sources)
}
