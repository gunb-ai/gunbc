...
pub use crate::v2_compiler_emit::{
    ...
    apply_type_template3, compute_service_fields, effective_operation_transport,
    ...
    empty_emit_scope, escape_go_interp_text, extract_string_interp_parts, extract_test_projections,
    has_nested_records_node, is_data_def_item, is_function_item, is_null_coalesce,
    is_resource_def_item, is_service_def_item, is_service_item, is_tco_eligible,
    is_type_alias_item, is_type_alias_return_node, is_type_decl_item, is_type_def_item,
    language_spec, lookup_item, module_emit_scope, order_typed_call_args, scope_after_expr,
    seed_bindings, service_fallback_transport, service_field_decls, test_file_path,
    test_function_name, to_string, to_string_helper, typed_named_arg_matches, unique_strings,
};
pub use crate::v2_compiler_emit::{
