...
emit_typed_if_shared(cond_str, then_branch, else_branch, depth.clone(), RenderTarget::Go, |node, d| emit_go_typed_expr(node.clone(), registry.clone(), scope.clone(), d.clone(), 1024))
}
}
