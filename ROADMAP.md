...
| Bootstrap emitted Rust (B) | 37 errors | 0 | Down from 8658→419→367→37. Remaining: Option comparisons (6), String/&str match (3), BinOp/LiteralKind cascade (3), type inference (5), Rc edge cases (8), misc (12) |
