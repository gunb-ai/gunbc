...
**Acceptance:** `resolved_type` accessor deleted. Consumers
pattern-match on boundary-specific coproduct carriers directly. No
bridge accessors, no error branches on impossible states.
