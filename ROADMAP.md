...
| P4.2 | Shared emit fold + target adapters | Planned | Highest-risk refactor. **Prereqs: P1.4, P1.9, P1.21 completed; P4.1/P4.1a complete** — otherwise shared emit fossilizes current Optional/Error compatibility shims into the shared layer. See P4.2 design below. |
