...
- [ ] **compute fabric connector migration** — relocate ~50 removed vocabulary symbols to their single-authority homes before #5889 can merge [tracking sheet](docs/plans/compute-fabric-connector-migration.md)
