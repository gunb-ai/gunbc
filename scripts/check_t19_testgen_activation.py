...
def main() -> None:
    ...
    _require_substrings(
        ...
        (
            ...
            "fn algebra_law_manual_claim_anchor(anchor: ManualAnchorKey) -> Outcome<ClaimAnchorKey>",
            "t19_algebra_law_anchor_mismatch",
            "ManualNatAddLeftIdentity => Accepted { value: manual_claim_anchor(anchor: anchor), diagnostics: None }",
            "match algebra_law_manual_claim_anchor(anchor: anchor)",
            "fn algebra_law_claim_term(subject: AlgebraLawSubject, expression: Node) -> Node",
            "lhs: algebra_law_claim_term(subject: subject, expression: lhs)",
            "rhs: algebra_law_claim_term(subject: subject, expression: rhs)",
