...
[[ "$falsification_status" -ne 0 ]] && grep -qE 'TS7009|construct' <<<"$falsification_stderr" && falsification_pass=true
...
export V4_TS_R3_FALSIFICATION_STDERR="$falsification_stderr"
...
stderr = os.environ.get("V4_TS_R3_FALSIFICATION_STDERR", "")
print(
    json.dumps(
        {
