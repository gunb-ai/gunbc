...
<<<<<<< HEAD
#                         Ratchet floor for active exemption entries (default 81;
=======
#                         Ratchet floor for active exemption entries (default 78;
>>>>>>> origin/main
...
<<<<<<< HEAD
max_exemptions=${TEST_TIMEOUT_MAX_EXEMPTIONS:-81}
=======
max_exemptions=${TEST_TIMEOUT_MAX_EXEMPTIONS:-78}
>>>>>>> origin/main
