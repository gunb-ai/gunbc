...
Scoped claim_batch completed successfully on the patched .dag: branch_read_survives_larger_projection_path, projected_before_consumed_stays_movable, whole_read_then_consume_stays_non_movable all PASS, each reports 0 ms evaluation (500 ms ceiling). The log is b-ownership-claims.log. This interpreter execution proves the root join controls, not regenerated native closure or fixed point. optional-root-latest.patch remains byte-identical to b45aa8092e8 (22fa685a278517a97624a21f9c1b08479518df4ef668402d65658969722117c9).
