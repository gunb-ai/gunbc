...
| `v1.compiler.infer.classify_field_recursion` | Syntax-only analysis retained by ruling msg_1fb0b46d: unresolved authored fields enter via collect_fields_inductive; output is RecursionShape/element spelling, no type evidence. Divergence; next carrier split places it on syntax by construction. |
