...
const ALLOWED_PASSTHROUGH_CALLABLES: &[&str] = &[
    ...
    "config.clippy_policy::render_exceptions_list",
    "config.clippy_policy::render_method_entry",
    "config.clippy_policy::render_method_group",
    "config.clippy_policy::render_type_entry",
    "config.clippy_policy::render_type_group",
