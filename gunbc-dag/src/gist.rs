...
//! Snapshot is backed by `dsl/tools/gist_snapshot.dag`.
//! Diff/recent are backed by dedicated modules (`gist_diff.dag`, `gist_recent.dag`).
...
#[gunbc_tool_registry_macros::tool_target(
    ...
    entrypoints = r#"[{"port_name":"repo_path","type_id":"String","short":"r","default":".","help":"Repository path to scan","make_var":"REPO"},{"port_name":"since","type_id":"String","short":"s","default":"3.days.ago","help":"Time window for recent commits","make_var":"SINCE"},{"port_name":"extensions","type_id":"String","cardinality":"ZERO_OR_MORE","short":"e","help":"File extensions to include (can be repeated)","make_var":"EXT"},{"port_name":"public","type_id":"Bool","short":"p","help":"Make gist public"}]"#,
    dsl_module = "gist_recent",
    has_invocation,
    returns_result
)]
