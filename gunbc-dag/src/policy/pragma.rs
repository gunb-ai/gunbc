...
const DISALLOWED_METHODS_ALLOWLIST: &[DisallowedMethodsAllowEntry] = &[
    ...
    DisallowedMethodsAllowEntry {
        path: "gunbc-dag/src/bin/testgen.rs",
        count: 1,
        scope: AllowScope::Function,
        rationale: "testgen entrypoint uses I/O boundary helpers",
    },
    DisallowedMethodsAllowEntry {
...
pub fn render_disallowed_methods_allowlist() -> String {
    ...
    output.push_str("# Generated by gunbc-pragma\n");
    output.push_str("# DO NOT EDIT - regenerate with: ");
    output.push_str(PRAGMA_REGENERATE_CMD);
    output.push_str("\n");
