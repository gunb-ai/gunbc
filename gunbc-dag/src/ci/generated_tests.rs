...
// 
// Determinism obligations: 21 pure nodes.
...
// - 'clippy_lint': same inputs → same outputs
...
// - 'prepare_verify_check': same inputs → same outputs
// - 'parse_verify_check': same inputs → same outputs
...
fn test_transport_interception() {
    ...
    assert!(result.boundary_nodes.iter().any(|n| n == "execute_verify_check"), "transport executor 'execute_verify_check' should be in intercepted list");
}
...
// 28 node contract compliance obligations.
...
// - 'prepare_verify_check': valid inputs → valid outputs
// - 'execute_verify_check': valid inputs → valid outputs
// - 'parse_verify_check': valid inputs → valid outputs
...
/// Cardinality coverage: execute_verify_check.skip_reason with 0 element(s) (cardinality: 0..1).
/// 
...
/// Cardinality coverage: execute_verify_check.skip_reason with 1 element(s) (cardinality: 0..1).
/// 
...
/// Optional input: parse_codegen_result.response (cardinality: 0..1).
/// 
...
fn test_optional_missing_parse_codegen_result_response() {
    ...
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_codegen_result", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_codegen_result.response missing should not error");
}
...
fn test_optional_wrong_type_parse_codegen_result_response() {
    ...
    inputs.insert("skip".to_string(), Value::Bool(false));
    let result = gunbc_exec::execute_single_node(&dag, "parse_codegen_result", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_codegen_result.response wrong type should error");
}

/// Optional input: parse_testgen.response (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_testgen_response() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_testgen", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_testgen.response missing should not error");
}
...
fn test_optional_wrong_type_parse_testgen_response() {
    ...
    inputs.insert("response".to_string(), Value::Str("<WRONG>".to_string()));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let result = gunbc_exec::execute_single_node(&dag, "parse_testgen", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_testgen.response wrong type should error");
}

/// Optional input: parse_testgen.skip_reason (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_testgen_skip_reason() {
    ...
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_testgen", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_testgen.skip_reason missing should not error");
}
...
fn test_optional_wrong_type_parse_testgen_skip_reason() {
    ...
    inputs.insert("response".to_string(), Value::Response(gunbc_ir::transport::TransportResponse::Shell(gunbc_ir::transport::ShellResponse { exit_code: 0, stdout: "Generated tests".to_string(), stderr: "".to_string() })));
    inputs.insert("skip".to_string(), Value::Bool(false));
    inputs.insert("skip_reason".to_string(), Value::Int(1));
    let result = gunbc_exec::execute_single_node(&dag, "parse_testgen", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_testgen.skip_reason wrong type should error");
}

/// Optional input: parse_build.response (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_build_response() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_build", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_build.response missing should not error");
}
...
fn test_optional_wrong_type_parse_build_response() {
    ...
    inputs.insert("response".to_string(), Value::Str("<WRONG>".to_string()));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let result = gunbc_exec::execute_single_node(&dag, "parse_build", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_build.response wrong type should error");
}

/// Optional input: parse_build.skip_reason (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_build_skip_reason() {
    ...
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_build", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_build.skip_reason missing should not error");
}
...
fn test_optional_wrong_type_parse_build_skip_reason() {
    ...
    inputs.insert("skip_reason".to_string(), Value::Int(1));
    let result = gunbc_exec::execute_single_node(&dag, "parse_build", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_build.skip_reason wrong type should error");
}

/// Optional input: parse_test.response (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_test_response() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_test", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_test.response missing should not error");
}
...
fn test_optional_wrong_type_parse_test_response() {
    ...
    inputs.insert("response".to_string(), Value::Str("<WRONG>".to_string()));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let result = gunbc_exec::execute_single_node(&dag, "parse_test", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_test.response wrong type should error");
}

/// Optional input: parse_test.skip_reason (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
...
test result: ok. 42 passed".to_string(), stderr: "".to_string() })));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_test", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_test.skip_reason missing should not error");
}
...
test result: ok. 42 passed".to_string(), stderr: "".to_string() })));
    ...
    inputs.insert("skip_reason".to_string(), Value::Int(1));
    let result = gunbc_exec::execute_single_node(&dag, "parse_test", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_test.skip_reason wrong type should error");
}

/// Optional input: parse_clippy_lint.success (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_clippy_lint_success() {
    ...
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_clippy_lint.success missing should not error");
}
...
fn test_optional_wrong_type_parse_clippy_lint_success() {
    ...
    inputs.insert("stderr".to_string(), Value::Str("".to_string()));
    inputs.insert("stdout".to_string(), Value::Str("Checking gunbc".to_string()));
    inputs.insert("success".to_string(), Value::Str("<WRONG>".to_string()));
    let result = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_clippy_lint.success wrong type should error");
}

/// Optional input: parse_clippy_lint.stdout (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_clippy_lint_stdout() {
    ...
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_clippy_lint.stdout missing should not error");
}
...
fn test_optional_wrong_type_parse_clippy_lint_stdout() {
    ...
    inputs.insert("skip".to_string(), Value::Bool(false));
    inputs.insert("stderr".to_string(), Value::Str("".to_string()));
    inputs.insert("stdout".to_string(), Value::Int(1));
    inputs.insert("success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_clippy_lint.stdout wrong type should error");
}

/// Optional input: parse_clippy_lint.stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_clippy_lint_stderr() {
    ...
    inputs.insert("stdout".to_string(), Value::Str("Checking gunbc".to_string()));
    inputs.insert("success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_clippy_lint.stderr missing should not error");
}
...
fn test_optional_wrong_type_parse_clippy_lint_stderr() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("skip".to_string(), Value::Bool(false));
    inputs.insert("stderr".to_string(), Value::Int(1));
    inputs.insert("stdout".to_string(), Value::Str("Checking gunbc".to_string()));
    inputs.insert("success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_clippy_lint.stderr wrong type should error");
}

/// Optional input: parse_clippy_lint.skip_reason (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_clippy_lint_skip_reason() {
    ...
    inputs.insert("stdout".to_string(), Value::Str("Checking gunbc".to_string()));
    inputs.insert("success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_clippy_lint.skip_reason missing should not error");
}
...
fn test_optional_wrong_type_parse_clippy_lint_skip_reason() {
    ...
    inputs.insert("success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "parse_clippy_lint", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_clippy_lint.skip_reason wrong type should error");
}

/// Optional input: parse_guardrail_check.response (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_guardrail_check_response() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_guardrail_check", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_guardrail_check.response missing should not error");
}
...
fn test_optional_wrong_type_parse_guardrail_check_response() {
    ...
    inputs.insert("response".to_string(), Value::Str("<WRONG>".to_string()));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let result = gunbc_exec::execute_single_node(&dag, "parse_guardrail_check", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_guardrail_check.response wrong type should error");
}

/// Optional input: parse_guardrail_check.skip_reason (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_guardrail_check_skip_reason() {
    ...
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_guardrail_check", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_guardrail_check.skip_reason missing should not error");
}
...
fn test_optional_wrong_type_parse_guardrail_check_skip_reason() {
    ...
    inputs.insert("skip_reason".to_string(), Value::Int(1));
    let result = gunbc_exec::execute_single_node(&dag, "parse_guardrail_check", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_guardrail_check.skip_reason wrong type should error");
}

/// Optional input: parse_verify_check.response (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_verify_check_response() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_verify_check", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_verify_check.response missing should not error");
}
...
fn test_optional_wrong_type_parse_verify_check_response() {
    ...
    inputs.insert("response".to_string(), Value::Str("<WRONG>".to_string()));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let result = gunbc_exec::execute_single_node(&dag, "parse_verify_check", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_verify_check.response wrong type should error");
}

/// Optional input: parse_verify_check.skip_reason (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_parse_verify_check_skip_reason() {
    ...
    inputs.insert("skip".to_string(), Value::Bool(false));
    let _outputs = gunbc_exec::execute_single_node(&dag, "parse_verify_check", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input parse_verify_check.skip_reason missing should not error");
}
...
fn test_optional_wrong_type_parse_verify_check_skip_reason() {
    ...
    inputs.insert("skip_reason".to_string(), Value::Int(1));
    let result = gunbc_exec::execute_single_node(&dag, "parse_verify_check", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input parse_verify_check.skip_reason wrong type should error");
}

/// Optional input: report.build_stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_build_stderr() {
    ...
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.build_stderr missing should not error");
}
...
fn test_optional_wrong_type_report_build_stderr() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.build_stderr wrong type should error");
}

/// Optional input: report.testgen_stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_testgen_stderr() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.testgen_stderr missing should not error");
}
...
fn test_optional_wrong_type_report_testgen_stderr() {
    ...
    inputs.insert("lint_success".to_string(), Value::Bool(true));
    inputs.insert("test_success".to_string(), Value::Bool(true));
    inputs.insert("testgen_stderr".to_string(), Value::Int(1));
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.testgen_stderr wrong type should error");
}

/// Optional input: report.test_stdout (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_test_stdout() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.test_stdout missing should not error");
}
...
fn test_optional_wrong_type_report_test_stdout() {
    ...
    inputs.insert("guardrail_success".to_string(), Value::Bool(true));
    inputs.insert("lint_success".to_string(), Value::Bool(true));
    inputs.insert("test_stdout".to_string(), Value::Int(1));
    inputs.insert("test_success".to_string(), Value::Bool(true));
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.test_stdout wrong type should error");
}

/// Optional input: report.test_stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_test_stderr() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.test_stderr missing should not error");
}
...
fn test_optional_wrong_type_report_test_stderr() {
    ...
    inputs.insert("guardrail_success".to_string(), Value::Bool(true));
    inputs.insert("lint_success".to_string(), Value::Bool(true));
    inputs.insert("test_stderr".to_string(), Value::Int(1));
    inputs.insert("test_success".to_string(), Value::Bool(true));
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.test_stderr wrong type should error");
}

/// Optional input: report.lint_stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_lint_stderr() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.lint_stderr missing should not error");
}
...
fn test_optional_wrong_type_report_lint_stderr() {
    ...
    inputs.insert("build_success".to_string(), Value::Bool(true));
    inputs.insert("guardrail_success".to_string(), Value::Bool(true));
    inputs.insert("lint_stderr".to_string(), Value::Int(1));
    inputs.insert("lint_success".to_string(), Value::Bool(true));
    inputs.insert("test_success".to_string(), Value::Bool(true));
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.lint_stderr wrong type should error");
}

/// Optional input: report.guardrail_stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_guardrail_stderr() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.guardrail_stderr missing should not error");
}
...
fn test_optional_wrong_type_report_guardrail_stderr() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("build_success".to_string(), Value::Bool(true));
    inputs.insert("guardrail_stderr".to_string(), Value::Int(1));
    inputs.insert("guardrail_success".to_string(), Value::Bool(true));
    inputs.insert("lint_success".to_string(), Value::Bool(true));
    inputs.insert("test_success".to_string(), Value::Bool(true));
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.guardrail_stderr wrong type should error");
}

/// Optional input: report.verify_stderr (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_report_verify_stderr() {
    ...
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let _outputs = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input report.verify_stderr missing should not error");
}
...
fn test_optional_wrong_type_report_verify_stderr() {
    ...
    inputs.insert("test_success".to_string(), Value::Bool(true));
    inputs.insert("testgen_success".to_string(), Value::Bool(true));
    inputs.insert("verify_stderr".to_string(), Value::Int(1));
    inputs.insert("verify_success".to_string(), Value::Bool(true));
    let result = gunbc_exec::execute_single_node(&dag, "report", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input report.verify_stderr wrong type should error");
}
...
// 9 single-failure scenarios (one per transport executor).
...
fn test_scenario_all_succeed() {
    ...
    let entry = log.get("execute_verify_check").expect("'execute_verify_check' should be in log");
    assert!(entry.was_intercepted, "'execute_verify_check' should be intercepted in DryRun");
}
...
/// Single failure: 'execute_verify_check' transport fails.
/// 
/// Proves: failure propagation semantics are consistent.
#[test]
fn test_scenario_execute_verify_check_fails() {
    ...
    mocks.set_value("execute_verify_check", "response", Value::Str("<TRANSPORT_FAILURE>".to_string()));
    // Execution may succeed or fail depending on graph semantics;
    // the key property is that it doesn't crash/hang.
    let _result = execute_with_mode(&dag, ExecutionMode::DryRun(mocks));
}
...
/// Skip propagation: 'execute_verify_check' returns Skipped → downstream handles it.
/// 
/// Proves: when a transport's output is Skipped, downstream nodes
/// either skip themselves (guarded) or process the Skipped value
/// without crashing.
...
fn test_skip_propagation_execute_verify_check() {
    ...
    mocks.set_value("execute_verify_check", "skip", Value::Skipped);
    mocks.set_value("execute_verify_check", "skip_reason", Value::Skipped);
    let log = execute_with_mode(&dag, ExecutionMode::DryRun(mocks)).expect("skip propagation should not crash or hang");
    assert!(log.get("parse_verify_check").is_some(), "downstream 'parse_verify_check' should still appear in log");
    assert!(log.get("parse_verify_check").is_some(), "downstream 'parse_verify_check' should still appear in log");
}
...
/// Node example: prepare_verify_check - Verify prepare emits skip flag
/// 
...
fn test_example_prepare_verify_check_verify_prepare_emits_skip_flag() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("prep_success".to_string(), Value::Bool(true));
    let outputs = gunbc_exec::execute_single_node(&dag, "prepare_verify_check", inputs, gunbc_exec::ExecutionMode::Real).expect("node 'prepare_verify_check' should execute successfully");
...
/// Node example: parse_verify_check - Verify check success → verify_success true
/// 
...
fn test_example_parse_verify_check_verify_check_success_verify_success_true() {
    ...
    inputs.insert("response".to_string(), Value::Response(gunbc_ir::transport::TransportResponse::Shell(gunbc_ir::transport::ShellResponse { exit_code: 0, stdout: "All checks passed".to_string(), stderr: "".to_string() })));
    inputs.insert("skip".to_string(), Value::Bool(false));
    let outputs = gunbc_exec::execute_single_node(&dag, "parse_verify_check", inputs, gunbc_exec::ExecutionMode::Real).expect("node 'parse_verify_check' should execute successfully");

    // Check output port 'verify_success'
    let output_verify_success = outputs.get("verify_success").expect("output port 'verify_success' should exist");
    assert_eq!(*output_verify_success, Value::Bool(true), "expected exact value");
}
