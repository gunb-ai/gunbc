...
/// Optional input: generate_makefile.crate_names (cardinality: 0..*).
/// 
...
fn test_optional_wrong_type_generate_makefile_crate_names() {
    ...
    let result = gunbc_exec::execute_single_node(&dag, "generate_makefile", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input generate_makefile.crate_names wrong type should error");
}

/// Optional input: compare_makefile_content.check_mode (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_compare_makefile_content_check_mode() {
    ...
    let _outputs = gunbc_exec::execute_single_node(&dag, "compare_makefile_content", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input compare_makefile_content.check_mode missing should not error");
}
...
fn test_optional_wrong_type_compare_makefile_content_check_mode() {
    ...
    inputs.insert("expected_content".to_string(), Value::Str("<MOCK>".to_string()));
    inputs.insert("response".to_string(), Value::Response(gunbc_ir::transport::TransportResponse::Shell(gunbc_ir::transport::ShellResponse { exit_code: 0, stdout: "<MOCK>".to_string(), stderr: "".to_string() })));
    let result = gunbc_exec::execute_single_node(&dag, "compare_makefile_content", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input compare_makefile_content.check_mode wrong type should error");
}

/// Optional input: generate_gitignore.crate_names (cardinality: 0..*).
/// 
/// Proves: missing optional input does not crash.
#[test]
...
fn test_optional_wrong_type_generate_gitignore_crate_names() {
    ...
    let mut inputs = std::collections::HashMap::new();
    inputs.insert("crate_names".to_string(), Value::Int(1));
    let result = gunbc_exec::execute_single_node(&dag, "generate_gitignore", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input generate_gitignore.crate_names wrong type should error");
}

/// Optional input: compare_gitignore_content.check_mode (cardinality: 0..1).
/// 
/// Proves: missing optional input does not crash.
#[test]
fn test_optional_missing_compare_gitignore_content_check_mode() {
    ...
    inputs.insert("expected_content".to_string(), Value::Str("<MOCK>".to_string()));
    inputs.insert("response".to_string(), Value::Response(gunbc_ir::transport::TransportResponse::Shell(gunbc_ir::transport::ShellResponse { exit_code: 0, stdout: "<MOCK>".to_string(), stderr: "".to_string() })));
    let _outputs = gunbc_exec::execute_single_node(&dag, "compare_gitignore_content", inputs, gunbc_exec::ExecutionMode::Real).expect("optional input compare_gitignore_content.check_mode missing should not error");
}
...
fn test_optional_wrong_type_compare_gitignore_content_check_mode() {
    ...
    inputs.insert("expected_content".to_string(), Value::Str("<MOCK>".to_string()));
    inputs.insert("response".to_string(), Value::Response(gunbc_ir::transport::TransportResponse::Shell(gunbc_ir::transport::ShellResponse { exit_code: 0, stdout: "<MOCK>".to_string(), stderr: "".to_string() })));
    let result = gunbc_exec::execute_single_node(&dag, "compare_gitignore_content", inputs, gunbc_exec::ExecutionMode::Real);
    assert!(result.is_err(), "optional input compare_gitignore_content.check_mode wrong type should error");
}
...
fn test_example_generate_gitignore_generates_gitignore_content_from_build_config() {
    ...
    assert!(output_gitignore_content.as_str().map(|s| s.contains("Generated by gunbc-bootstrap")).unwrap_or(false), "expected to contain 'Generated by gunbc-bootstrap', got: {:?}", output_gitignore_content);
}
