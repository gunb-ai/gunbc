...
pub fn pragma_mock_spec() -> MockSpec {
    ...
    extract_mock_requirements(&dag, "pragma")
        ...
        .input_mock("prepare_clippy_write", "path", Value::Str("clippy.toml".into()))
        .input_mock("prepare_allowlist_write", "path", Value::Str("tools/disallowed-methods-allowlist.txt".into()))
        .input_mock("prepare_policy_write", "path", Value::Str("tools/pragma-lint-policy.txt".into()))
