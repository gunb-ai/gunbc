...
pub fn dag_syntax_spec() -> Rc<SyntaxSpec> {
    serde_json::from_value(serde_json::json!({"item_forms": "dag_item_forms", "operators": "dag_operators", "keyword_literals": "dag_keyword_literals", "keyword_set": "dag_keyword_set"}))
        .expect("valid data definition")
}
