...
pub fn rt_scanner_ops() -> String {
    v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat(v2_rt::concat("pub fn scan_while(s: &str, start: i64, pred: impl Fn(String) -> bool) -> i64 {\n".to_string(), "    let s = s.as_str();\n".to_string()), "    let start = start.max(0) as usize;\n".to_string()), "    if s.is_ascii() {\n".to_string()), "        let bytes = s.as_bytes();\n".to_string()), "        let mut pos = start.min(bytes.len());\n".to_string()), "        while pos < bytes.len() && pred(String::from(bytes[pos] as char)) { pos += 1; }\n".to_string()), "        return pos as i64;\n".to_string()), "    }\n".to_string()), "    let char_len = s.chars().count();\n".to_string()), "    let start = start.min(char_len);\n".to_string()), "    let mut pos = start;\n".to_string()), "    for ch in s.chars().skip(start) {\n".to_string()), "        if pred(ch.to_string()) { pos += 1; } else { break; }\n".to_string()), "    }\n".to_string()), "    pos as i64\n".to_string()), "}\n\n".to_string()), "pub fn skip_horizontal_ws(s: &str, start: i64) -> i64 {\n".to_string()), "    let s = s.as_str();\n".to_string()), "    let start = start.max(0) as usize;\n".to_string()), "    if s.is_ascii() {\n".to_string()), "        let bytes = s.as_bytes();\n".to_string()), "        let mut pos = start.min(bytes.len());\n".to_string()), "        while pos < bytes.len() && (bytes[pos] == b' ' || bytes[pos] == b'\\t') { pos += 1; }\n".to_string()), "        return pos as i64;\n".to_string()), "    }\n".to_string()), "    let char_len = s.chars().count();\n".to_string()), "    let start = start.min(char_len);\n".to_string()), "    let mut pos = start;\n".to_string()), "    for ch in s.chars().skip(start) {\n".to_string()), "        if ch == ' ' || ch == '\\t' { pos += 1; } else { break; }\n".to_string()), "    }\n".to_string()), "    pos as i64\n".to_string()), "}\n\n".to_string()), "pub fn scan_to_eol(s: &str, start: i64) -> i64 {\n".to_string()), "    let s = s.as_str();\n".to_string()), "    let start = start.max(0) as usize;\n".to_string()), "    if s.is_ascii() {\n".to_string()), "        let bytes = s.as_bytes();\n".to_string()), "        let start = start.min(bytes.len());\n".to_string()), "        for i in start..bytes.len() { if bytes[i] == b'\\n' { return i as i64; } }\n".to_string()), "        return bytes.len() as i64;\n".to_string()), "    }\n".to_string()), "    let char_len = s.chars().count();\n".to_string()), "    let start = start.min(char_len);\n".to_string()), "    let mut pos = start;\n".to_string()), "    for ch in s.chars().skip(start) {\n".to_string()), "        if ch == '\\n' { return pos as i64; }\n".to_string()), "        pos += 1;\n".to_string()), "    }\n".to_string()), "    pos as i64\n".to_string()), "}\n\n".to_string()), "pub fn scan_string_end(s: &str, start: i64) -> i64 {\n".to_string()), "    let s = s.as_str();\n".to_string()), "    let start = start.max(0) as usize;\n".to_string()), "    if s.is_ascii() {\n".to_string()), "        let bytes = s.as_bytes();\n".to_string()), "        let mut pos = start.min(bytes.len());\n".to_string()), "        while pos < bytes.len() {\n".to_string()), "            if bytes[pos] == b'\\\\' { pos += 2; }\n".to_string()), "            else if bytes[pos] == b'\\\"' { return (pos + 1) as i64; }\n".to_string()), "            else { pos += 1; }\n".to_string()), "        }\n".to_string()), "        return bytes.len() as i64;\n".to_string()), "    }\n".to_string()), "    let char_len = s.chars().count();\n".to_string()), "    let start = start.min(char_len);\n".to_string()), "    let mut pos = start;\n".to_string()), "    let mut escaped = false;\n".to_string()), "    for ch in s.chars().skip(start) {\n".to_string()), "        if escaped {\n".to_string()), "            escaped = false;\n".to_string()), "            pos += 1;\n".to_string()), "        } else if ch == '\\\\' {\n".to_string()), "            escaped = true;\n".to_string()), "            pos += 1;\n".to_string()), "        } else if ch == '\\\"' {\n".to_string()), "            return (pos + 1) as i64;\n".to_string()), "        } else {\n".to_string()), "            pos += 1;\n".to_string()), "        }\n".to_string()), "    }\n".to_string()), "    pos as i64\n".to_string()), "}\n\n".to_string())
}
