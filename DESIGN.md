...
- **An Optional actual flowing into a parameter declared non-optional, at the call seam, in BOTH the interpreter and the Rust emission arm** — declared 2026-09-01
...
- `mutation_applied_to_the_wrong_artifact_of_a_generated_pair`
