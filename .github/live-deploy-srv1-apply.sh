...
# Wave C envelope: typed deploy-access gate runs before this HostReconciler artifact; roster sudoers install precedes mutation.
...
sudo -n install -d -m 0755 -o briansrls -g briansrls /opt/gunbc/attempt-state
