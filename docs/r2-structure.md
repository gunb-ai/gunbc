...
1. **R1 close** — **R1 Closure Manager** declares R1 closed when **release acceptance** and **lane receipts** per `ROADMAP.md §"Release R1 Program"` are satisfied. Closure record: [`docs/briefs/r1-closure-manager.md`](briefs/r1-closure-manager.md) (formal completion section — **PR #1160** pending).
