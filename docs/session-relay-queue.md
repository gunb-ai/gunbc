...
|:---|:---|:---|:---|:---|
| `7c53b24f910a8212434d8aa666fbd0ded08a0ea9` | 2026-04-19T08:25:10 | 0 | Clean SG-1 cutover; `tokenize.rs` exposes only generated tokenizer; `sg1_tokenize_authority_test` = consumer + freshness proof. | `codex` · `gpt-5.4` |
...
**Indexed automated rounds:** **ChatGPT** — all **complete** (three parent SHAs in the table above). **Codex** — `7c53b24f…` posted, **0** blocking. Other **open** items on #556 sit outside these markers — e.g. the **human** blocking brief, more reviews/threads, **Checks** — see [PR #556](https://github.com/gunb-ai/gunbc/pull/556) (“+N queued” in dashboards is usually that wider queue).
