...
**Indexed automated rounds:** **ChatGPT** (per-diff) — **three** parent SHAs **complete** + **`e529d136…` pending** (stub @ 2026-04-19T08:31:37Z — refresh [PR #556](https://github.com/gunb-ai/gunbc/pull/556) for `status:complete`). **ChatGPT meta-review** — `3fc44f8456a992d001ccbc6b21cb2bd53afb35a9` **complete** @ 2026-04-19T08:31:06Z (**SHIP_WITH_DEBT**). **Codex** — **two** reviews (`7c53b24f…`, `37c3d25f…`), **0** blocking each. A “+1 queued” count may be this **pending** ChatGPT round, the **human** brief, or **Checks** — **dedupe** duplicate bot posts first. **Dedupe by parent SHA and marker kind** (`chatgpt-review` vs `chatgpt-meta-review` vs `codex-review`; same SHA may appear under **both** ChatGPT and Codex).
