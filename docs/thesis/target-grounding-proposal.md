...
reference this doc as the concrete path for `docs/single-emitter-design.md`'s
...
- **[INVARIANTS.md](../../INVARIANTS.md)**
  ...
  `InhabitantDecl` are scaffolds under this rule; `docs/single-emitter-design.md`
  provides their dissolution path.
- **[INVARIANTS.md §Verifiability Invariant](../../INVARIANTS.md#verifiability-invariant)**
  — adjacent on L4 verification; notes the weather.dag PoC and
  the witness-generation gap.

## What this proposal does NOT restate

These are already authoritatively covered in `docs/single-emitter-design.md`
...
Reading this proposal without reading `docs/single-emitter-design.md`
...
`docs/single-emitter-design.md` calls "Algebra Homomorphism, Not Lookup
Tables" — here with concrete examples, layer partition, and work
estimate.

**Shape of the change (concrete form of `docs/single-emitter-design.md`'s §"What dissolves"):**
...
examples walk against (per `docs/single-emitter-design.md`'s "current
state" framing):
...
This section refines `docs/single-emitter-design.md`'s claim that
...
- **(C) Algebra-satisfaction certification does NOT go away.**
  ...
  per [INVARIANTS.md §Verifiability Invariant](../../INVARIANTS.md#verifiability-invariant) and the
