...
| **Grounding completeness — Rust target primitives structurally modeled** | R2 | T-Ground-Rust XL | R2 amendment 2026-04-28 (folds Rust XL into R2 scope) | 🟡 in flight (Pilot ✓; Engine in PR #989; Rust dispatch pending) |
