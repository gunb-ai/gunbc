...
The thesis pins both substrates down together because the
epistemic chain rests on them, and substrate decisions need a
single authoritative statement to measure against.
...
rounds and never hit a stop signal; the five-behavior claim is the
