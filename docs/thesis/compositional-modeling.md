...
**Impossible-bugs inventory.** Draft-only R1 audit scaffolding lives
in `docs/briefs/r1-impossible-bugs-inventory.md`; do not convert
it into story prose until sibling managers confirm their `[live]`
sets.
