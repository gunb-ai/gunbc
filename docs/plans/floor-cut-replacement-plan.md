...
3. regen self-host fixed point — **this item's disposition is NOT carried here.** The executing lane records it on `gunbc.witness_floor_workflow`, and that carrier is the authority; this plan names it and asserts nothing about its contents, because summarizing an authority is how a citation becomes a second copy of it (§3).
