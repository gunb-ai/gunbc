...
- **Strike it in place, with the reason**, only when the correction is *illegible without it* — e.g. §5.E's three original bullets, where "refuted by execution" means nothing unless you can see what was refuted.
