...
> Population for that recurrence, stated as a denominator: the census carries **180 data rows** across its tables, of which **41** already carry a closed marker (LANDED / DELETED / RETIRED / dissolved / MIGRATED / EXTINCT), leaving **~139 rows asserting live state**, none of them re-verified here.
>
