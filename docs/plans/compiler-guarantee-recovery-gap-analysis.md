...
10. **Unenrolled floor measurements** (opened 2026-08-01 by codex review 46306, which caught
   ...
   **DISCHARGED 2026-08-22, and by SIX classes rather than the four this item names.** The
   enrolment landed as `dag/test/claim/guarantee_floor_class_probe_witness_test.dag` over six
   ...
   measurement nothing re-runs. **What the discharge does NOT claim.** Four of the six are
   ...
   zero is never the harness failing to reach the judgment. **Still open beside this:** item 9
