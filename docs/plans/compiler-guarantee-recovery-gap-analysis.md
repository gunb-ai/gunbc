...
10. **Unenrolled floor measurements** (opened 2026-08-01 by codex review 46306, which caught
   ...
   **What this does NOT claim.** Four of the five are
   ...
   zero is never the harness failing to reach the judgment. **Still open beside this:** the enrolment itself, on §11 item 23's trigger; item 9
...
23. **The guarantee-probe corpus is DISCOVERED AND DECLINED: five carriers, 100 identities, and
