...
crux — intent-linearity as the enforceable shadow of §1's limit, held against §1/§2/§7 for operator
review — is drafted in [intent-linearity design draft](intent-linearity-design-draft.md).
