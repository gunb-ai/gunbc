...
| **nat** | 1 (`Nat`: `= CommutativeSemiring<Magnitude>` vs `= Zero \| Succ`) | same concept, divergent **model** | **LIVE — 138 floor entries** (946 scanned; was 4 @ 351, 2026-06-23) | grounding (#5428 numeric tower; escalated smart-ant-466) | cant-unify-yet, has path; BLOCKED + LAST · census nat-grounding-unification-design.md |
