...
2. **M2 go/no-go criterion — DISCHARGED:** #7129 landed after the trigger fired. Remaining decisions belong to the outer-ring and resident-accounting follow-ups, not to whether M2 should start. (The earlier "floor still censored at 15 GiB" wording was wrong — the governor pins the peak at the line whether or not M1 succeeds.)
