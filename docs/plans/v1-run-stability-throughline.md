...
> **Dispatch J measurement (2026-08-01):** real `claim_executor` floor path with M2 armed at whole-corpus scale — handback **(a)** bounded comfortably; named follow-ups do not rank for capacity → [m2-floor-retention-measurement-receipt.md](m2-floor-retention-measurement-receipt.md).
