...
2. **Body-derived demand (session approximation of DependencyDemand)** — capitalized dotted operation references in the visible body (`shell.Exec.RunArgv`, `Filesystem.Read`, `gcp.SecretManager.AccessVersion`, …), plus `file_compare_and_set` (Filesystem) and `clock_now_probed_at` (Clock); plus calls to other declarations that themselves author a `uses` of the same normalized resource (`Network` = `std.resources.Network`).
...
| `dag/gunbc/auth/access_token_source.dag` | `ensure_access_token` | `net` | `Network` | ops shell.GCloud.AuthPrintAccessToken, shell.Env.Get |
...
| `dag/gunbc/auth/patterns.dag` | `github_oidc` | `net` | `std.resources.Network` | ops shell.Env.Get, shell.Env.Get, github.OIDC.GetToken |
...
| `dag/gunbc/container/registry_image_config.dag` | `read_docker_hub_image_config_at_digest` | `net` | `Network` | ops shell.Mktemp.Dir, Filesystem.WriteOwnerOnly, shell.Remove.RecursiveForce, shell.Remove.RecursiveForce, shell.Remove.RecursiveForce; other-demand Filesystem |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `observe_operator_local_run_binding` | `net` | `Network` | ops git.Inspect.HeadCommit, clock_now_probed_at; other-demand Clock |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_operator_cli_dispatch` | `net` | `Network` | ops git.Core.CurrentBranch; callees fleet_converge_local_apply_wet, observe_host_short_wet, fleet_converge_local_plan_wet |
| `dag/gunbc/fleet/printer_job_start.dag` | `acquire_pinned_ca_bundle` | `net` | `Network` | ops shell.Mktemp.Dir; callees run_shell_command_capture |
| `dag/gunbc/fleet/printer_job_start.dag` | `publish_start_with_credential` | `net` | `Network` | ops shell.Remove.RecursiveForce, shell.Remove.RecursiveForce, shell.Remove.RecursiveForce; callees run_shell_command_capture, acquire_pinned_ca_bundle |
| `dag/gunbc/fleet/printer_project_delivery.dag` | `deliver_project_to_printer` | `net` | `Network` | ops shell.Remove.FileForce, shell.Remove.FileForce; callees run_shell_command_capture, fetch_secret_ref_credential |
| `dag/gunbc/host/host_reset_return_run.dag` | `host_is_reachable` | `net` | `std.resources.Network` | ops ssh.Session.Reachability |
| `dag/gunbc/host/host_reset_return_run.dag` | `observer_self_corroboration` | `net` | `std.resources.Network` | ops os.Hostname.ReadShort |
| `dag/gunbc/host/host_reset_return_run.dag` | `host_reset_return_dispatch_admission_wet` | `net` | `std.resources.Network` | ops shell.Env.Get, shell.Env.Get |
| `dag/gunbc/host/host_reset_return_run.dag` | `host_reset_return_wet` | `net` | `std.resources.Network` | ops shell.Env.Get, shell.Env.Get; callees host_reset_return_preflight_exit, host_reset_return_attempt, host_reset_return_exit, host_reset_return_converge_route_read |
| `dag/gunbc/machine_intake/boot_image_fetch.dag` | `publish_verified_boot_image` | `net` | `std.resources.Network` | ops shell.Move.File; callees confirm_published_boot_image |
| `dag/gunbc/machine_intake/megarac_media_attach.dag` | `megarac_attach_remote_image` | `net` | `std.resources.Network` | ops megarac.Media.OpenSession; callees megarac_release_unreadable_session, megarac_attach_then_release |
...
| `dag/gunbc/tools/bmc_first_contact.dag` | `bmc_first_contact` | `net` | `std.resources.Network` | ops shell.Env.Get, redfish.Http.GetSystem |
...
| `dag/gunbc/tools/bmc_onboard.dag` | `bmc_store_and_rotate` | `net` | `Network` | ops gcp.SecretManager.AddVersion, gcp.SecretManager.AccessVersion; callees bmc_rotate_credential, ensure_access_token |
...
| `dag/gunbc/tools/bmc_onboard.dag` | `bmc_converge_credential` | `net` | `Network` | ops redfish.Http.GetServiceRoot; callees bmc_probe_credential_phase, bmc_store_and_rotate |
| `dag/gunbc/tools/bmc_read_telemetry.dag` | `bmc_read_telemetry` | `net` | `std.resources.Network` | ops shell.Env.Get, shell.Env.Get, redfish.Http.GetSystem, redfish.Http.GetChassisSensors |
...
| `dag/gunbc/auth/secret_ref_credential.dag` | `fetch_secret_ref_credential` | `net` | `Network` | callees ensure_access_token, fetch_secret_ref_credential_with_token |
...
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `observe_fleet_converge_request_wet` | `net` | `Network` | callees observe_timer_members_wet, observe_cap_members_wet, observe_slot_retirement_evidence_wet, observe_runner_slot_members_with_provenance_wet, observe_runner_unit_standings_wet |
...
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_allocation_store_plan_wet` | `net` | `Network` | callees observe_generation_store_wet, write_fleet_converge_plan_artifact_wet, observe_host_short_wet |
...
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_plan_scoped_bound_wet` | `net` | `Network` | ops Filesystem.Write, Filesystem.Write, Filesystem.Write, Filesystem.Write, Filesystem.Write; callees observe_fleet_converge_request_wet, observe_host_short_wet, observe_generation_store_wet, run_shell_commands; other-demand Filesystem |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_apply_wet` | `net` | `Network` | callees fleet_converge_apply_bound_wet |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_apply_bound_wet` | `net` | `Network` | ops Filesystem.Read, Filesystem.Read, Filesystem.Read, Filesystem.Read, Filesystem.Read; callees observe_effective_user_wet, observe_fleet_converge_request_wet, observe_host_short_wet, run_shell_commands; other-demand Filesystem |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_local_plan_wet` | `net` | `Network` | callees observe_host_short_wet, fleet_converge_plan_scoped_bound_wet, observe_operator_local_run_binding |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_operator_cli_entry` | `net` | `Network` | ops Filesystem.Read, Filesystem.Write; callees observe_operator_local_run_binding, fleet_converge_operator_cli_dispatch; other-demand Filesystem |
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `fleet_converge_local_apply_wet` | `net` | `Network` | ops Filesystem.Read; callees fleet_converge_apply_bound_wet, observe_operator_local_run_binding; other-demand Filesystem |
...
| `dag/gunbc/fleet/fleet_converge_plan_cli.dag` | `observe_runner_slot_members_with_provenance_wet` | `net` | `Network` | callees observe_runner_slot_members_wet, observe_runner_slot_provenance_wet |
...
| `dag/gunbc/fleet/fleet_host_key_enrollment.dag` | `fleet_authorized_key_self_enroll_wet` | `net` | `Network` | ops Filesystem.Write, Filesystem.Write; callees run_shell_command_capture, verify_enrollment_outcome; other-demand Filesystem |
| `dag/gunbc/fleet/fleet_multi_principal_probe.dag` | `probe_agent_credential_verification` | `net` | `Network` | callees materialize_agent_public_selector, verify_fleet_ssh_agent_credential |
| `dag/gunbc/fleet/fleet_multi_principal_probe.dag` | `fleet_multi_principal_probe_with_attempt` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees run_with_materialized_fleet_ssh_binding, materialize_fleet_known_hosts_anchor; other-demand Clock,Filesystem |
| `dag/gunbc/fleet/fleet_multi_principal_probe.dag` | `spark_exact_grant_probe_wet` | `net` | `Network` | ops Filesystem.Write; callees run_with_materialized_fleet_ssh_binding, materialize_fleet_known_hosts_anchor; other-demand Filesystem |
| `dag/gunbc/fleet/fleet_multi_principal_probe.dag` | `spark_managed_access_standing_for_attempt` | `net` | `Network` | callees probe_agent_credential_verification, spark_managed_access_standing_with_verified_credential |
...
| `dag/gunbc/fleet/fleet_ssh_locus.dag` | `prepare_fleet_ssh_agent_context` | `net` | `Network` | callees fleet_ssh_context_from_verified_binding, materialize_agent_public_selector, verify_fleet_ssh_agent_credential |
...
| `dag/gunbc/host/host_reset_return_run.dag` | `host_reset_return_attempt` | `net` | `std.resources.Network` | callees observer_self_corroboration, subject_baseline, host_reset_return_issue_and_watch |
...
| `dag/gunbc/live_deploy/deployed_tree_report.dag` | `deployed_tree_report_ci_wet` | `net` | `Network` | callees prepare_fleet_ssh_agent_context, deployed_tree_report_for_context |
...
| `dag/gunbc/roadmap/roadmap_launch_deployment_cli.dag` | `rlm_launch_deployment_receipt_bound` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at_or_unknown; callees unit_standing_fact, rlm_run_provenance_fact, observe_host_short_wet, persist_receipt, window_snapshot; other-demand Clock,Filesystem |
...
| `dag/gunbc/runner/runner_host_file_converge.dag` | `run_runner_host_files` | `net` | `Network` | callees apply_runner_host_file, observe_runner_host_administrator_privilege, observe_runner_slot_population, plan_runner_host_file, runner_host_manager_reload_step |
...
| `dag/gunbc/runner/runner_microvm_boot_probe.dag` | `runner_microvm_boot_probe_wet` | `net` | `Network` | ops Filesystem.Write; callees observe_firecracker_host_standing_wet, run_shell_command_observe, run_shell_commands; other-demand Filesystem |
...
| `dag/gunbc/runner/runner_microvm_host_ready.dag` | `runner_microvm_host_observe_wet` | `net` | `Network` | ops Filesystem.Write; callees observe_firecracker_host_standing_wet, run_shell_commands; other-demand Filesystem |
| `dag/gunbc/runner/runner_microvm_host_ready.dag` | `runner_microvm_host_converge_wet` | `net` | `Network` | ops Filesystem.Write; callees observe_firecracker_host_standing_wet, run_shell_commands; other-demand Filesystem |
...
| `dag/gunbc/spark/glm_group_b_relaunch_cli.dag` | `observe_rank_report` | `net` | `Network` | callees rank_startup_facet, capture_rank_log, observe_rank_container |
...
| `dag/gunbc/spark/glm_group_b_relaunch_cli.dag` | `glm_group_b_relaunch_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees with_group_b_access, relaunch_arm; other-demand Clock,Filesystem |
...
| `dag/gunbc/spark/managed_access_apply.dag` | `spark_managed_access_apply_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees run_with_materialized_fleet_ssh_binding, resolve_spark_administrator_credential; other-demand Clock,Filesystem |
...
| `dag/gunbc/spark/managed_grant_install.dag` | `spark_grant_install_host` | `net` | `Network` | callees spark_grant_install_execute, spark_grant_probe_outcome |
...
| `dag/gunbc/spark/serving_relaunch_transaction.dag` | `capture_rank` | `net` | `Network` | callees preserved_name_is_free, observe_rank_container, observe_rank_transport |
...
| `dag/gunbc/spark/serving_relaunch_transaction.dag` | `rollback_arm` | `net` | `Network` | callees rollback_restore_names, rollback_start_restored |
| `dag/gunbc/spark/serving_relaunch_transaction.dag` | `await_rank_announcement` | `net` | `Network` | callees await_after_interval, observe_rank_container, observe_rank_transport |
...
| `dag/gunbc/spark/serving_relaunch_transaction.dag` | `relaunch_arm` | `net` | `Network` | callees stop_and_preserve_arm, rollback_arm, create_and_start_arm, capture_arm, verify_arm |
| `dag/gunbc/spark/v41_runtime_image_probe.dag` | `v41_published_image_probe_ci_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees materialize_fleet_known_hosts_anchor, v41_probe_published_image, observe_executor_reach; other-demand Clock,Filesystem |
| `dag/gunbc/spark/v41_source_patch_converge.dag` | `v41_observe_member` | `net` | `Network` | callees v41_place_declared_patch, v41_check_applicable |
...
| `dag/gunbc/spark/v41_source_patch_converge.dag` | `converge_vllm_source_with_patches` | `net` | `Network` | callees v41_apply_plan, converge_vllm_source_to_revision, v41_observe_tree |
| `dag/gunbc/spark/v41_source_patch_converge.dag` | `converge_vllm_runtime_image_with_patches` | `net` | `Network` | callees converge_vllm_source_with_patches, converge_vllm_image_keyed |
| `dag/gunbc/spark/v41_source_patch_converge_wet.dag` | `v41_patched_source_acquire_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees probe_agent_credential_verification, materialize_fleet_known_hosts_anchor, converge_vllm_source_with_patches; other-demand Clock,Filesystem |
...
| `dag/gunbc/spark/vllm_runtime_image_build.dag` | `converge_vllm_runtime_image` | `net` | `Network` | callees converge_vllm_source, converge_vllm_image |
| `dag/gunbc/spark/vllm_runtime_image_build.dag` | `vllm_runtime_image_build_ci_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees probe_agent_credential_verification, converge_vllm_runtime_image, observe_executor_reach, materialize_fleet_known_hosts_anchor; other-demand Clock,Filesystem |
| `dag/gunbc/spark/vllm_runtime_image_build.dag` | `vllm_source_acquire_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees probe_agent_credential_verification, materialize_fleet_known_hosts_anchor, converge_vllm_source; other-demand Clock,Filesystem |
| `dag/gunbc/spark/vllm_runtime_image_build.dag` | `spark_build_host_reachability_wet` | `net` | `Network` | ops Filesystem.Write, clock_now_probed_at; callees materialize_fleet_known_hosts_anchor, probe_agent_credential_verification, probe_spark_host_reachability; other-demand Clock,Filesystem |
