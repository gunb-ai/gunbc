...
**Status:** `PROPOSAL` — supersedes the ≤5-floor framing in [`docs/design-pure-bootstrap.md`](design-pure-bootstrap.md) and the 2-3 principled-floor framing in [PR #756](https://github.com/gunb-ai/gunbc/pull/756) on promotion. Until then, this doc is the proposed direction; `design-pure-bootstrap.md` remains the live authority.
...
This rewrite is a sibling PR to the design doc — same author (Director or PM), separate land cycle. Could bundle, but TESTING.md is a foundational doc commitment worth its own discussion.
...
- Existing parent: [`docs/design-pure-bootstrap.md`](design-pure-bootstrap.md) — supersedes the ≤5-floor framing on this doc's promotion.
...
- TESTING residual authority: `TESTING.md §"Post-R2 shape"` — sibling PR rewrites this section to 0-residual.
- ROADMAP T-PB-A row at `:53` — needs amendment when this proposal lands (acceptance target shifts from ≤5 to 0).
- R2 structure at `docs/r2-structure.md` — "Lanes deliberately absent" section's T-ShimFloor entry needs amendment if this program lands as R2 scope or as a separately-named program.
- Floor-target precedent: PR #756 introduced "2-3 principled floor" framing — gets superseded by 0 under this proposal.
