...
|---|---|---|---|---|---|---|
| `pr_digests` | 8 | `—` (non-consumer) | `false` | `true` · PR #2832 @ `5b2520a36d1595f6e9ff5f0b6d926bc28daf987c` (projection: `dsl/gunbc/digest_render.dag`; source facts: `dsl/extdeps/github/pulls.dag`; std render primitives: `dsl/std/render.dag`) | `false` | `false` |
