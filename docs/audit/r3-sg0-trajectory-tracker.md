...
| **2026-05-14 cadence** | **ac955d865** | **53** | **111** | **2** | **166** | **+23 (vs 2026-05-07 prior reading; +3 vs 2026-05-10 later)** | Gate/demonstration PRs added 3 SG-0 test entries after the 2026-05-10 later row; no SG-0 dissolutions landed in the scheduled 7-day window | **Velocity tripwire RED** for Cadence-2026-05-14. Window source: prior 2026-05-07 row total 143 → 166 at `origin/main` `ac955d865` = **+23 SG-0 introductions / 0 SG-0 dissolutions**. ROADMAP source: `scripts/r3-debt-velocity.sh 2026-05-07 2026-05-14 ROADMAP.md` reports **26 introduced / 0 retired** rows (the 2026-05-08 paired exploratory + reflective analyses section). Combined reading = **49 introductions / 0 dissolutions = ∞:1**, exceeding the 3:1 invariant. |

## §4. Velocity-to-zero math

**Current state** (Cadence-2026-05-14 reading at `origin/main` `ac955d865`): 166 entries (53 non_test + 111 test + 2 fragments). True 14-day average is **+3.3/day** (46 entries over 2026-04-30 → 2026-05-14 cadence window); scheduled 7-day delta vs the prior 2026-05-07 reading is **+23**. Earlier "+13 anomaly" framing was a baseline-comparison artifact corrected here.

**Velocity tripwire (Cadence-2026-05-14).** The scheduled 7-day window from 2026-05-07 to 2026-05-14 combines SG-0 census state delta with ROADMAP debt-row delta:

- SG-0 census: 143 → 166 total entries = **23 introductions**, **0 dissolutions**.
- ROADMAP rows: `scripts/r3-debt-velocity.sh 2026-05-07 2026-05-14 ROADMAP.md` = **26 introduced**, **0 retired**.
- Aggregate: **49 introductions**, **0 dissolutions**, ratio **∞:1**.
- Invariant comparison: **RED** — exceeds the 3:1 introduction:dissolution tripwire and has zero denominator shrinkage.
