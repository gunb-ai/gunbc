...
Substrate-owned **snapshot format**, **carrier shape**, or **first-hook** placement for facts that must not fork between Grounding, emit retirement, and PB bootstrap work is **not** something PB documentation may invent here. Route those decisions through **INVARIANTS.md § P1** (modeling faithfulness — *design commitments must name the substrate target*; *substrate-fact introduction procedure*) and **R2 Substrate Manager** / Grounding briefs as the owning intake. See [`INVARIANTS.md`](../../INVARIANTS.md) (§ P1, “Unnamed substrate target”, “Procedure: substrate-fact introduction”) and [`docs/briefs/r2-substrate-manager.md`](../briefs/r2-substrate-manager.md).
