...
| Drift recovery | Cheap. If Ubicloud changes their instance specification (kernel bump, vCPU model swap), recapture under Director approval. Recapture cost: one CI run. |
