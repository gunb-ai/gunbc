...
| `r3-novel-f6-derive-op-effect-string-parser-worker.md` | C | Substrate (#2068) + PB (#2074) coord | WORKING (heavy) | **(b) cross-Mgr** | Substrate-side: typed `HttpMethod`/`Path` carrier consumption replaces string parsing at structural boundary. | dep-clear (substrate-prereq audited 2026-05-09: `HttpMethod` carrier exists at `std/types.dag`) | gunbc#2068 c#4413712338 |
