...
| `r3-novel-f5-composedeffect-illegal-product-worker.md` | C | Substrate (#2068) + PB (#2074) coord | **SHIPPED** (PR #2491 / #2469) | **(b) cross-Mgr** | `dsl/std/effects.dag`: `CompositionVerdict = IdempotentComposition | BrokenBy { first_breaker: OperationEffect }`; `compose_effects` returns sum; v2 stage0 regenerated; cementing tests in `v2-compiler-tests` `effects::r3_f5_*`. | dep-clear (Option A); v2 coord | gunbc#2068 c#4413712338 |
