...
| `r3-novel-f6-derive-op-effect-string-parser-worker.md` | C | Substrate (#2068) + PB (#2074) coord | RECEIPT LANDED (tidy-ram-461) | **(b) cross-Mgr** | Substrate-side: `derive_op_effect` now consumes typed `HttpMethod` + `PathTemplate`; string parsing is isolated to the v2 compatibility re-export. Cementing Rust test pins the typed-input call. | dep-clear (substrate-prereq audited 2026-05-09: `HttpMethod` carrier exists at `std/types.dag`) | issue #2470 |
