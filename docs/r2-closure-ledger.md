...
| T-Ground-CrossTarget-Meta | lane | cross-target meta / L6 fold | `cross_target_meta_structural` | in-flight | #1224 brief + #1414 L6 coverage fold + closure-ledger gap ratchet | Walker + [`docs/r2-closure-ledger.md`](../r2-closure-ledger.md) L6 key block; structural gate **open** until `cross_target_meta_structural` fires. |
