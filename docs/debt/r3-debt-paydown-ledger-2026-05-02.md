...
|---|---:|---|
| Open implementation / retirement work | 53 | Needs a named retirement PR, executable gate, owner closure receipt, or disposition decision. |
| Partially closed | 8 | Has a landed partial receipt but still names remaining work. |
| Retired / stale receipt row | 8 | ROADMAP already records retirement or stale-finding resolution; next action is ledger cleanup, not code. |
