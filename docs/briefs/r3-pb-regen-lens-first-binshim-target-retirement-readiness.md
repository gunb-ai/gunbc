...
4. Substrate-owned `BinShim` carrier on `main` — **Substrate Manager**. **Mechanically verified** on `origin/main @ 2c7d82031` (`src/v3/std/bin_shim.dag`; warm-ant-877, 2026-05-06) — this criterion is **not** the active blocker for the retirement chain.
