...
| **R1C-F** | S | T-Demo user-authored-lens fixture: 1 TestClaim fixture for `demo_user_authored_lens_rejects_violating_program` (consumes `user_authored_lens_compiles` from T-LensAPI which is GREEN). | none | WORKER BRIEF AUTHORED — [`r1c-f-t-demo-user-lens-fixture-worker.md`](r1c-f-t-demo-user-lens-fixture-worker.md); dispatchable Day-1 |
