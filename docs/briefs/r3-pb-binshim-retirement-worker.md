...
**Status:** PROPOSAL (planning artifact, dispatch-gated). Authored 2026-04-29 by PB Manager continuation per the "NOT YET AUTHORED" cell at [`docs/briefs/r2-pure-bootstrap-manager.md`](r2-pure-bootstrap-manager.md) line 37 and the Item 5 ownership lock from [`docs/design-pb-runtime-interpreter.md`](../design-pb-runtime-interpreter.md) §5.4 (LANDED via #1176/#1186).
...
- Parent manager brief: [`docs/briefs/r2-pure-bootstrap-manager.md`](r2-pure-bootstrap-manager.md) — R3 continuation row "BinShim instances + emit pattern + retirement dispatch" (line 37) + Locked design decisions §"PB-Runtime interpreter-as-data + PB-1 bin-shim emit pattern (LANDED via #1176)" (line 62 onwards).
...
- Substrate-fact-introduction procedure (escalation path): `INVARIANTS.md:86` §"Procedure: substrate-fact introduction".
