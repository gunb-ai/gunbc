...
Per `r3-structure.md` §"Lane gating summary" and `r2-structure.md` §"R1 closure criteria" (the "`pb_self_compile_fixed_point` two-horizon semantics" paragraph), the predicate name `pb_self_compile_fixed_point` carries **two horizons**:
...
Per `r2-pure-bootstrap-manager.md` §"Acceptance" + `r3-structure.md` §"Lane gating summary":
...
- Two-horizon authority: [`docs/r2-structure.md`](../r2-structure.md) §"R1 closure criteria" + [`docs/r3-structure.md`](../r3-structure.md) §"Lane gating summary" two-horizon clarification
