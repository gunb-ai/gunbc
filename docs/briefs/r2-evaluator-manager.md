...
- ~~PR-D worker brief — L5 corpus type spec~~ — **slice 0 + slice 1 landed** in [`docs/briefs/r2-pr-d-cross-target-equivalence-harness-primitives.md`](r2-pr-d-cross-target-equivalence-harness-primitives.md); **Evaluator cadence:** [`r2-evaluator-cadence-verification-matrix.md`](r2-evaluator-cadence-verification-matrix.md) (strict L5 multi-target harness: follow §Next implementation slices in that brief)
