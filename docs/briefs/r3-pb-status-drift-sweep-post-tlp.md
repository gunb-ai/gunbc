...
| #64 | `lens_producer_retirement_executable_witness` | PR #2595 (`a085f6e9`, 15:52Z substrate-impl: TestRunner reports residual) | DECLARED → CONSUMER_LANDED (substrate-plumbing only); F3 deferral keeps PASSING gated on aggregate Row-4 evidence |
...
(G6 / G33 / G34 / G64 evidence already exists; G8 ratchet trip + #5/#7 PRs are gating events.)
