...
**Owner:** Verification Mgr session `warm-fox-650`.
...
This session dispatches the concrete slices below as dashboard work items under
`adhoc-b75b3d90-3d0`. Child sessions own implementation and verification for
their slice; this document is the reviewable decomposition artifact that keeps
the children aligned to one invariant and one authority surface.

## Child Work Items

### G87-D1 — Registry-Invariant Audit

Dashboard work item: `node://adhoc-cb4c988d-74b`.
...
Dashboard work item: `node://adhoc-c1cffa70-8c1`.
...
Dashboard work item: `node://adhoc-d5fa7b9d-599`.
...
Dashboard work item: `node://adhoc-b0df2525-7dd`.
...
Dashboard work item: `node://adhoc-c585495c-710`.
