...
**Owner:** Verification Mgr session `calm-crane-98`.

**Dashboard dispatch:** node `adhoc-b75b3d90-3d0` spawned child work items
`adhoc-0aed2137-224` (G87-D1), `adhoc-7fe5107b-eef` (G87-D2),
`adhoc-f7e39cf5-03b` (G87-D3), `adhoc-286bb4da-ff1` (G87-D4), and
`adhoc-fe559a63-8b8` (G87-D5).
