...
- [`## Active deferrals — follow-up work from merged PRs`](../../ROADMAP.md#active-deferrals--follow-up-work-from-merged-prs) (`DB-*` deferral ledger; one-line entries point at `docs/db-history/db-<N>.md`).
- [`## Scheduled deletions — scaffolds with named dissolution triggers`](../../ROADMAP.md#scheduled-deletions--scaffolds-with-named-dissolution-triggers) (pointer to external table at `docs/history/roadmap-scheduled-deletions.md`).
