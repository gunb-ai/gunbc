...
**PR #621 audit trail (archival):** Lettered reviews, blocking rebuttals, hashes, and receipts → **[`docs/review-findings/1e-3v-pr621-review-ingest.md`](../review-findings/1e-3v-pr621-review-ingest.md)** only — not duplicated here (**`INVARIANTS.md`** “Documentation Describes Live State” + **`docs/review-findings/`** archive split).
