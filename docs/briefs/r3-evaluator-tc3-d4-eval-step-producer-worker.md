...
Cross-Pattern-A consistency preserved across the family (TC1/TC2/TC3/TC4/#19) — strict-mirror discipline maintained; (α)/(β) novel-substrate-introduction was **formerly** carved to R4+ via Class P partition (Debt-Paydown PR #2437) + scope statement (**DISSOLVED** per carve-promotion-IN-R3 2026-05-09; R4 C1/C2/C3 carves reclassified R3-load-bearing within Cluster F per `docs/r4-carve-out-routing.md`).
