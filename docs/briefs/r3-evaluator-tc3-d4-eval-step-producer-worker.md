...
Cross-Pattern-A consistency preserved across the family (TC1/TC2/TC3/TC4/#19) — strict-mirror discipline maintained; (α)/(β) novel-substrate-introduction tracked under Class P partition (Debt-Paydown PR #2437) + scope statement (**prior** “carved to R4+” **framing DISSOLVED** per carve-promotion-IN-R3 2026-05-09 at gunbc#846 — gates now R3-load-bearing per `docs/r4-carve-out-routing.md`).
