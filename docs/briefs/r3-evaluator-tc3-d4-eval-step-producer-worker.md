...
Cross-Pattern-A consistency preserved across the family (TC1/TC2/TC3/TC4/#19) — strict-mirror discipline maintained; prior (α)/(β) novel-substrate-introduction R4+ carve language via Class P partition (Debt-Paydown PR #2437) is historical/superseded by the 2026-05-09 carve-promotion discipline; scope statement remains binding for this representative.
