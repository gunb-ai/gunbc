...
Cross-Pattern-A consistency preserved across the family (TC1/TC2/TC3/TC4/#19) — strict-mirror discipline maintained; (α)/(β) novel-substrate-introduction followed the prior R4+ carve framing via Class P partition (Debt-Paydown PR #2437) + scope statement; C1/C2/C3 carve status was later DISSOLVED / carve-promoted-IN-R3 on 2026-05-09.
