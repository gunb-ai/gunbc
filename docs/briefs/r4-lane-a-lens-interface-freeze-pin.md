...
| `structural_resolution` | `StructuralResolution` | `v4.lens.structural_resolution` | T-13 mirror — InferredTree + dependency projection; BindsTo via resolve bind-edge-0 label. |
