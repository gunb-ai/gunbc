...
- T-Ground-LanguageSpec brief + Phase 1 + Phase 2 partial — **LANDED** (#1168 + #1172 + #1174 + #1195 + #1196 + #1210 + #1213); Phase 1.5 (Rust higher-order; gated on Substrate `MethodEmitTemplate` sum) + B (`RealizationCost` per-primitive; gated on PR-I) outstanding
