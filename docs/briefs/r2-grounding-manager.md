...
- **Program scope source:** [`THESIS.md`](../../THESIS.md) §"Tier 1 — Structural correctness" (Grounding completeness sub-claim) + [`_internal/ROADMAP_OPS.md`](../../_internal/ROADMAP_OPS.md) §"Post-R1 Program — Grounding Completeness" + [`docs/design-emission-model.md`](../design-emission-model.md) (engine-reframe spec).
