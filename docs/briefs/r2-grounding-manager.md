...
- **Program scope source:** [`THESIS.md §"Tier 1 — Structural correctness — Grounding completeness"`](../../THESIS.md) + [`ROADMAP.md §"Post-R1 Program — Grounding Completeness"`](../../ROADMAP.md) + [`docs/design-emission-model.md`](../design-emission-model.md) (engine-reframe spec).
