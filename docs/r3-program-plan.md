...
| 99 | `emission_target_open_enum_landed` | substrate-shape | T-Workflow-As-Data | DECLARED (NEW 2026-05-12 per PR #2744 §1) | `EmissionTarget` sum-type (`YamlStatic \| BinaryShim \| PythonShim \| InlineGunbc \| ...`) declared in gunbc namespace as open enum; per (c-refined) shape ratified at PR #2749 §7 + Director msg_237bde05 / msg_f9fd669e. |
