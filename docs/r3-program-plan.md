...
| 11 | `tc1_eta_equivalence_executable` | DimensionReport-typed | T-V-L4-L7-Direct | DECLARED (NEW 2026-05-06; scaffold authored PR #2184 with NotYetImplemented sentinel per Director (C-modified) ratification at #828; assertion upgrades only when the non-vacuous lens-over-`Dag` producer path lands. 2026-05-09 Director (a)-disposition: E3.c #1970 closed superseded-by-deferral; remaining producer path is blocked on E4/G1.b #1972, currently HELD-CANVAS-DEFERRED past R3. R3-close evidence routes through the Pattern A second-mover audit slice; strict-fire flip moves to a fresh post-R3 issue after #1972.) | runtime prereq: G1.a static-rep OR G1.b generic + eta relation |
