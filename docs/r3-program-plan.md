...
| 80 | `cost_lens_behaviorally_complete` | structural-fold | T-Lens-Behavioral-Parity | SATISFIED-BY-CONSTRUCTION — #1951 | Dimension<SymbolicCost> wiring via `analyze_symbolic_cost_dimension`; `SizeVariable.source_port` value semantics; cementing test (`cost_lens_behavioral_completion`) |
