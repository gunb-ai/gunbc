...
| 19 | `numeric_aliases_align_to_refinements` | substrate-shape | T-Numeric-Construction | **CONSUMER_LANDED + PASSING** (2026-05-11, PR #2671) | `Int8`/`Int16`/`Int32`/`Int64`/`Int128` resolve to `Compose<Int, MachineWidth<Byte|Word16|Word32|Word64|Word128>>`; `UInt8`/`UInt16`/`UInt32`/`UInt64`/`UInt128` resolve to `Compose<UInt, MachineWidth<...>>`; `Float32`/`Float64` alias through `Real32`/`Real64` to `Compose<Real, MachineWidth<Word32|Word64>>`. Ratcheted by `bootstrap_numeric_aliases_align_to_refinements_per_gate_19`. |
