...
echo "module	source_commit	source_tree	survey_executable	source_roots_digest	probe_policy_revision	self_emit_ready	blocker_class	located_stage	located_reason	probe_error" > "$TSV"
failures=0
