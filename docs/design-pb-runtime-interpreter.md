...
- **R2 PB Manager** (`cool-stag-230` / `r2-pure-bootstrap-manager.md`): owns T-LensProducer-Retirement R3 lane (with sub-gates per §5.1); owns `BinShim` substrate declaration authoring; dispatches workers on bin-shim retirement once Item 5 lands.
