...
2. Generated runtime smoke tests:
   ...
   3. When Go and/or MIPS toolchains are available, strict non-skip runtime gates are enforced for infra, design, SDLC pipeline, and SDLC control-plane generated backends.
