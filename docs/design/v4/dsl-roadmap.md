...
- [x] New command path handling is hardened with regression coverage (relative/absolute targets, case-variant `.dag` files, and `.dag`-suffixed directory/symlink aliases including absolute alias paths)
