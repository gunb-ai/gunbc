...
pub fn expected_dsl_files_sorted() -> Vec<&'static str> {
    vec![
        ...
        "tools/review.dag",
        "tools/testgen.dag",
        "understanding/clippy.dag",
        "understanding/git2.dag",
        "understanding/http_clients.dag",
        "understanding/secret_apis.dag",
        "understanding/std_fs.dag",
        "understanding/std_process.dag",
