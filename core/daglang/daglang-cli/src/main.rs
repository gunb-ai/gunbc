...
mod tests {
    ...
    #[test]
    fn parse_run_args_supports_output_and_check_mode_flags_before_input_path() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--output".to_string(),
            "out/check_mode_before_input.mk".to_string(),
        ...
        assert_eq!(
            ...
            RunArgs {
                file: "dsl/tools/makegen.dag".to_string(),
                output_path: "out/check_mode_before_input.mk".to_string(),
                dry_run: false,
                check_mode: true,
            }
        );
    ...
    #[test]
    fn parse_run_args_supports_check_mode_and_equals_output_with_double_dash_input() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--check-mode".to_string(),
            "--output=out/check_mode_double_dash_input.mk".to_string(),
            "--".to_string(),
            "--fixture.DAG".to_string(),
        ];
        let parsed = parse_run_args(&args).expect("parse should succeed");
        assert_eq!(
            ...
            RunArgs {
                ...
                output_path: "out/check_mode_double_dash_input.mk".to_string(),
                dry_run: false,
                check_mode: true,
            }
        );
    ...
    #[test]
    fn parse_run_args_supports_real_mode_equals_output_with_double_dash_input() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--output=out/real_mode_double_dash_input.mk".to_string(),
            "--".to_string(),
            "--fixture.DAG".to_string(),
        ];
        let parsed = parse_run_args(&args).expect("parse should succeed");
        assert_eq!(
            ...
            RunArgs {
                file: "--fixture.DAG".to_string(),
                output_path: "out/real_mode_double_dash_input.mk".to_string(),
                dry_run: false,
                check_mode: false,
            }
        );
    ...
    #[test]
    fn parse_run_args_supports_dry_run_split_output_with_double_dash_input() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--dry-run".to_string(),
            "--output".to_string(),
            "out/dry_run_split_double_dash_input.mk".to_string(),
            "--".to_string(),
            "--fixture.DAG".to_string(),
        ];
        let parsed = parse_run_args(&args).expect("parse should succeed");
        assert_eq!(
            ...
            RunArgs {
                file: "--fixture.DAG".to_string(),
                output_path: "out/dry_run_split_double_dash_input.mk".to_string(),
                dry_run: true,
                check_mode: false,
            }
        );
    ...
    #[test]
    fn parse_run_args_supports_real_mode_split_output_with_double_dash_input() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--output".to_string(),
            "out/real_mode_split_double_dash_input.mk".to_string(),
            "--".to_string(),
            "--fixture.DAG".to_string(),
        ];
        let parsed = parse_run_args(&args).expect("parse should succeed");
        assert_eq!(
            ...
            RunArgs {
                file: "--fixture.DAG".to_string(),
                output_path: "out/real_mode_split_double_dash_input.mk".to_string(),
                dry_run: false,
                check_mode: false,
            }
        );
    ...
    #[test]
    fn parse_run_args_rejects_output_equals_token_as_second_input_after_double_dash() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--".to_string(),
            "dsl/tools/makegen.dag".to_string(),
            "--output=alt.mk".to_string(),
        ];
        let error = parse_run_args(&args).expect_err("parse should fail");
        assert!(
            error.contains("run takes exactly one <file.dag> input"),
            "expected single-input constraint for output-looking second positional token, got: {error}"
        );
    }

    #[test]
    fn parse_run_args_rejects_output_equals_first_token_plus_second_input_after_double_dash() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--".to_string(),
        ...
        assert!(
            error.contains("run takes exactly one <file.dag> input"),
            "expected single-input constraint when output-like token is first positional after --, got: {error}"
        );
    }
    ...
    #[test]
    fn parse_run_args_rejects_duplicate_split_output_flags_after_input_path() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "dsl/tools/makegen.dag".to_string(),
        ...
        assert!(
            error.contains("run accepts at most one --output path"),
            "expected duplicate output-flag error after input path for split syntax, got: {error}"
        );
    }

    #[test]
    fn parse_run_args_rejects_duplicate_equals_output_flags_after_input_path() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "dsl/tools/makegen.dag".to_string(),
        ...
        assert!(
            error.contains("run accepts at most one --output path"),
            "expected duplicate output-flag error after input path for equals syntax, got: {error}"
        );
    }

    #[test]
    fn parse_run_args_rejects_duplicate_mixed_output_flags_after_input_path() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "dsl/tools/makegen.dag".to_string(),
        ...
        assert!(
            error.contains("run accepts at most one --output path"),
            "expected duplicate output-flag error after input path for mixed syntax, got: {error}"
        );
    }
    ...
    #[test]
    fn parse_run_args_supports_split_output_separator_with_mode_flag_after_escaped_path() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--output".to_string(),
    ...
    #[test]
    fn parse_run_args_rejects_duplicate_equals_output_flag_after_split_output_separator_escape() {
        let args = vec![
            "daglang".to_string(),
            "run".to_string(),
            "--output".to_string(),
        ...
        assert!(
            error.contains("run accepts at most one --output path"),
            "expected duplicate equals output flag error after split-output separator escape, got: {error}"
        );
    }
