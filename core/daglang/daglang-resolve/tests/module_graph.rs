...
fn real_corpus_dependency_counts_match_expected_snapshot() {
    ...
    let expected: BTreeMap<String, usize> = BTreeMap::from([
        ...
        ("exemplars.ml_investigation".into(), 3),
        ...
        ("extdeps.github.comments".into(), 1),
        ...
        ("extdeps.sdlc.providers.file_feedback_store".into(), 3),
        ...
        ("extdeps.sdlc.providers.gcs_feedback_store".into(), 3),
        ...
        ("extdeps.sdlc.providers.stub_feedback_store".into(), 3),
        ...
        ("funcs.feedback_ingestion".into(), 5),
        ("funcs.feedback_response".into(), 3),
        ("funcs.intent_expansion".into(), 4),
        ("funcs.retry_budget".into(), 2),
        ("funcs.review_pipeline".into(), 4),
        ("funcs.sdlc_kernel_mapping".into(), 2),
        ("funcs.sdlc_stages".into(), 11),
        ...
        ("infra.sdlc.managed_units".into(), 2),
        ("infra.spec".into(), 1),
        ...
        ("std.inquiry".into(), 1),
        ("std.kernel_artifacts".into(), 1),
        ("std.languages".into(), 1),
        ("std.lifecycle".into(), 1),
        ("std.lint".into(), 0),
        ("std.markdown".into(), 0),
