...
fn real_corpus_dependency_counts_match_expected_snapshot() {
    ...
    let expected: BTreeMap<String, usize> = BTreeMap::from([
        ...
        ("extdeps.cloud.azure.core".into(), 1),
        ...
        ("extdeps.cloud.gcp.core".into(), 1),
        ("extdeps.cloud.gcp.iam".into(), 2),
        ("extdeps.cloud.gcp.pubsub".into(), 2),
        ("extdeps.cloud.gcp.secret_manager".into(), 2),
        ("extdeps.cloud.gcp.storage".into(), 1),
        ("extdeps.cloud.gcp.sts".into(), 2),
        ...
        ("extdeps.git".into(), 1),
        ("extdeps.github.core".into(), 0),
        ("extdeps.github.gists".into(), 2),
        ("extdeps.github.issues".into(), 2),
        ("extdeps.github.pull_requests".into(), 2),
        ("extdeps.github_actions".into(), 0),
        ("extdeps.gitlab_ci".into(), 0),
        ("extdeps.gunbc".into(), 0),
        ("extdeps.llm.anthropic".into(), 2),
        ("extdeps.llm.core".into(), 0),
        ("extdeps.llm.openai".into(), 2),
        ("extdeps.llm.pricing".into(), 1),
        ("extdeps.make".into(), 0),
        ("extdeps.secrets.core".into(), 1),
        ...
        ("extdeps.tools.rust_toolchain".into(), 1),
        ("extdeps.yaml".into(), 2),
        ...
        ("profiles.cloud_run".into(), 7),
        ("profiles.gist".into(), 1),
        ("profiles.local".into(), 7),
        ("profiles.sdlc".into(), 7),
        ("profiles.unit_test".into(), 7),
        ("services.cargo".into(), 2),
        ("services.gcp.iam".into(), 3),
        ("services.gcp.secret_manager".into(), 3),
        ("services.gcp.sts".into(), 3),
        ("services.git".into(), 2),
        ("services.github.gist".into(), 3),
        ("services.github.issues".into(), 5),
        ("services.github.pull_request".into(), 3),
        ("services.llm.anthropic".into(), 4),
        ("services.llm.openai".into(), 4),
        ("services.review.dimension".into(), 0),
        ...
        ("services.sdlc.providers.gcp_credential_provider".into(), 3),
        ("services.sdlc.providers.gcs_artifact_store".into(), 2),
        ...
        ("std.languages".into(), 0),
        ("std.lint".into(), 0),
        ("std.markdown".into(), 0),
        ("std.markdown_render".into(), 1),
        ("std.patterns".into(), 7),
        ("std.rate_limit".into(), 0),
        ("std.render".into(), 4),
