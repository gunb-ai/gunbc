...
fn real_corpus_dependency_counts_match_expected_snapshot() {
    ...
    let expected: BTreeMap<String, usize> = BTreeMap::from([
        ...
        ("interfaces.credential_provider".into(), 1),
        ...
        ("tools.gist".into(), 6),
        ("tools.infra".into(), 0),
        ("tools.makegen".into(), 1),
        ("tools.pragma".into(), 3),
        ("tools.review".into(), 0),
        ("tools.testgen".into(), 2),
        ("understanding.clippy".into(), 1),
        ("understanding.git2".into(), 1),
        ("understanding.http_clients".into(), 1),
        ("understanding.secret_apis".into(), 1),
        ("understanding.std_fs".into(), 1),
        ("understanding.std_process".into(), 1),
