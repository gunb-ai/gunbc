...
//!
//! The `#[tool_target]` proc macro has been replaced by DSL `@binary`
//! annotations. See `gunbc-dag/src/dsl_registry.rs`.
//!
...
/// Deprecated: no-op. Use `@binary` annotation in DSL `.dag` files instead.
